import require$$0, { GPU as GPU$1, Input as Input$1, Texture } from 'gpu.js';
...
var GPU = require$$0.GPU,
    alias = require$$0.alias,
    gpuUtils = require$$0.utils;
