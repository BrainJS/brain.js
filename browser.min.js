...
"use strict";function _toConsumableArray(t){if(Array.isArray(t)){for(var e=0,i=Array(t.length);e<t.length;e++)i[e]=t[e];return i}return Array.from(t)}function toSVG(t,e){var i={line:{width:"0.5",color:"black"},inputs:{color:"rgba(0, 128, 0, 0.5)",label:!1},outputs:{color:"rgba(100, 149, 237, 0.5)"},hidden:{color:"rgba(255, 127, 80, 0.5)"},fontSize:"14px",radius:"8",width:"400",height:"250"},r="number"==typeof t.inputSize&&"number"==typeof t.outputSize&&t.inputSize>0&&t.outputSize>0&&[t.inputSize].concat(_toConsumableArray(t.hiddenLayers),[t.outputSize]);if(r||(r=t.sizes),e=Object.assign(i,e),e.inputs.label=e.inputs.label.length==t.inputSize&&e.inputs.label,r){var o='<svg  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="'+e.width+'" height="'+e.height+'">',l=e.width/r.length;return r.forEach(function(t,i){var n=e.height/t;[].concat(_toConsumableArray(Array(t))).forEach(function(t,s){if(0==i)o+='<rect x="'+(l/2-e.radius)+'" y="'+(n/2+s*n-e.radius)+'" width="'+2*e.radius+'" height="'+2*e.radius+'" stroke="black" stroke-width="1" fill="'+e.inputs.color+'" />',o+='<line x1="'+l/4+'" y1="'+(n/2+s*n)+'" x2="'+(l/2-e.radius)+'" y2="'+(n/2+s*n)+'" style="stroke:'+e.line.color+";stroke-width:"+e.line.width+'" />',e.inputs.label&&(o+='<text x="'+l/8+'" y="'+(n/2+s*n-5)+'" fill="black" font-size= "'+e.fontSize+'">'+e.inputs.label[s]+"</text>");else{var a=e.height/r[i-1];i==r.length-1?(o+='<circle cx="'+(l/2+i*l)+'" cy="'+(n/2+s*n)+'" r="'+e.radius+'" stroke="black" stroke-width="1" fill="'+e.outputs.color+'" />',o+='<line x1="'+(l/2+i*l+e.radius)+'" y1="'+(n/2+s*n)+'" x2="'+(l/2+i*l+l/4)+'" y2="'+(n/2+s*n)+'" style="stroke:'+e.line.color+";stroke-width:"+e.line.width+'" />'):o+='<circle cx="'+(l/2+i*l)+'" cy="'+(n/2+s*n)+'" r="'+e.radius+'" stroke="black" stroke-width="1" fill="'+e.hidden.color+'" />';for(var u=0;u<r[i-1];u++)o+='<line x1="'+(l/2+(i-1)*l+e.radius)+'" y1="'+(a/2+u*a)+'" x2="'+(l/2+i*l-e.radius)+'" y2="'+(n/2+s*n)+'" style="stroke:'+e.line.color+";stroke-width:"+e.line.width+'" />'}})}),o+="</svg>"}return!1}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=toSVG;
