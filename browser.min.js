...
"use strict";function _classCallCheck(r,e){if(!(r instanceof e))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function r(r,e){for(var n=0;n<e.length;n++){var t=e[n];t.enumerable=t.enumerable||!1,t.configurable=!0,"value"in t&&(t.writable=!0),Object.defineProperty(r,t.key,t)}}return function(e,n,t){return n&&r(e.prototype,n),t&&r(e,t),e}}(),lookup=function(){function r(){_classCallCheck(this,r)}return _createClass(r,null,[{key:"toTable",value:function(e){var n=e.reduce(function(r,e){return Object.assign(r,e)},{});return r.toHash(n)}},{key:"toInputTable",value:function(r){for(var e={},n=0,t=0;t<r.length;t++)for(var a in r[t].input)e.hasOwnProperty(a)||(e[a]=n++);return e}},{key:"toOutputTable",value:function(r){for(var e={},n=0,t=0;t<r.length;t++)for(var a in r[t].output)e.hasOwnProperty(a)||(e[a]=n++);return e}},{key:"toHash",value:function(r){var e={},n=0;for(var t in r)e[t]=n++;return e}},{key:"toArray",value:function(r,e,n){var t=new Float32Array(n);for(var a in r)t[r[a]]=e[a]||0;return t}},{key:"toObject",value:function(r,e){var n={};for(var t in r)n[t]=e[r[t]];return n}},{key:"lookupFromArray",value:function(r){for(var e={},n=0,t=r.length;t-- >0;)e[r[t]]=n++;return e}}]),r}();exports.default=lookup;
...
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}function _inherits(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function t(t,e){for(var r=0;r<e.length;r++){var n=e[r];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(t,n.key,n)}}return function(e,r,n){return r&&t(e.prototype,r),n&&t(e,n),e}}(),_matrix=require("./matrix"),_matrix2=_interopRequireDefault(_matrix),_randomMatrix=require("./matrix/random-matrix"),_randomMatrix2=_interopRequireDefault(_randomMatrix),_equation=require("./matrix/equation"),_equation2=_interopRequireDefault(_equation),_rnn=require("./rnn"),_rnn2=_interopRequireDefault(_rnn),_zeros=require("../utilities/zeros"),_zeros2=_interopRequireDefault(_zeros),_softmax=require("./matrix/softmax"),_softmax2=_interopRequireDefault(_softmax),_random=require("../utilities/random"),_sampleI=require("./matrix/sample-i"),_sampleI2=_interopRequireDefault(_sampleI),_maxI=require("./matrix/max-i"),_maxI2=_interopRequireDefault(_maxI),_lookup=require("../lookup"),_lookup2=_interopRequireDefault(_lookup),_lookupTable=require("../utilities/lookup-table"),_lookupTable2=_interopRequireDefault(_lookupTable),_arrayLookupTable=require("../utilities/array-lookup-table"),_arrayLookupTable2=_interopRequireDefault(_arrayLookupTable),_cast=require("../utilities/cast"),RNNTimeStep=function(t){function e(t){_classCallCheck(this,e);var r=_possibleConstructorReturn(this,(e.__proto__||Object.getPrototypeOf(e)).call(this,t));return r.inputLookup=null,r.inputLookupLength=null,r.outputLookup=null,r.outputLookupLength=null,r}return _inherits(e,t),_createClass(e,[{key:"createOutputMatrix",value:function(){var t=this.model,e=this.outputSize,r=this.hiddenLayers[this.hiddenLayers.length-1];t.outputConnector=new _randomMatrix2.default(e,r,.08),t.output=new _randomMatrix2.default(e,1,.08)}},{key:"bindEquation",value:function(){var t=this.model,e=this.hiddenLayers,r=t.hiddenLayers,n=new _equation2.default,u=[],o=t.equationConnections.length>0?t.equationConnections[t.equationConnections.length-1]:this.initialLayerInputs,i=this.getEquation(n,n.input(new _matrix2.default(this.inputSize,1)),o[0],r[0]);u.push(i);for(var a=1,s=e.length;a<s;a++)i=this.getEquation(n,i,o[a],r[a]),u.push(i);t.equationConnections.push(u),n.add(n.multiply(t.outputConnector,i),t.output),t.equations.push(n)}},{key:"mapModel",value:function(){var t=this.model,e=t.hiddenLayers,r=t.allMatrices;if(this.initialLayerInputs=this.hiddenLayers.map(function(t){return new _matrix2.default(t,1)}),this.createHiddenLayers(),!t.hiddenLayers.length)throw new Error("net.hiddenLayers not set");for(var n=0,u=e.length;n<u;n++){var o=e[n];for(var i in o)o.hasOwnProperty(i)&&r.push(o[i])}if(this.createOutputMatrix(),!t.outputConnector)throw new Error("net.model.outputConnector not set");if(!t.output)throw new Error("net.model.output not set");r.push(t.outputConnector),r.push(t.output)}},{key:"backpropagate",value:function(){for(var t=this.model.equations.length-1;t>-1;t--)this.model.equations[t].backpropagate()}},{key:"run",value:function(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:[];return 1===this.inputSize?this.outputLookup?(this.run=this.runObject,this.runObject(t)):(this.run=this.runNumbers,this.runNumbers(t)):(this.run=this.runArrays,this.runArrays(t))}},{key:"forecast",value:function(t,e){return 1===this.inputSize?(this.forecast=this.forecastNumbers,this.forecastNumbers(t,e)):(this.forecast=this.forecastArrays,this.forecastArrays(t,e))}},{key:"train",value:function(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};e=Object.assign({},this.constructor.trainDefaults,e);var r=e.iterations,n=e.errorThresh,u=!0===e.log?console.log:e.log,o=e.logPeriod,i=e.learningRate||this.learningRate,a=e.callback,s=e.callbackPeriod;t=this.formatData(t),t[0].input?this.trainInput=this.trainInputOutput:t[0].length>0&&(t[0][0].length>0?this.trainInput=this.trainArrays:this.inputSize>1?(t=[t],this.trainInput=this.trainArrays):this.trainInput=this.trainNumbers);var l=1/0,p=void 0;for(this.model||this.initialize(),p=0;p<r&&l>n;p++){for(var h=0,f=0;f<t.length;f++){h+=this.trainPattern(t[f],i)}if(l=h/t.length,isNaN(l))throw new Error("network error rate is unexpected NaN, check network configurations and try again");u&&p%o==0&&u("iterations: "+p+", training error: "+l),a&&p%s==0&&a({error:l,iterations:p})}return{error:l,iterations:p}}},{key:"trainNumbers",value:function(t){for(var e=this.model,r=e.equations;r.length<t.length;)this.bindEquation();for(var n=0,u=0,o=t.length-1;u<o;u++)n+=r[u].predictTarget(t[u],t[u+1]);return this.end(),n/t.length}},{key:"runNumbers",value:function(t){if(!this.isRunnable)return null;for(var e=this.model,r=e.equations;r.length<=t.length;)this.bindEquation();for(var n=void 0,u=0;u<t.length;u++)n=r[u].runInput([t[u]]);return this.end(),n.weights.slice(0)}},{key:"forecastNumbers",value:function(t,e){if(!this.isRunnable)return null;for(var r=this.model,n=r.equations,u=t.length+e;n.length<=u;)this.bindEquation();for(var o=void 0,i=0,a=0;a<t.length;a++)o=n[i++].runInput([t[a]]);for(var s=[o.weights[0]],l=0,p=e-1;l<p;l++)o=n[i++].runInput(o.weights),s.push(o.weights[0]);return this.end(),s}},{key:"runObject",value:function(t){return _lookup2.default.toObject(this.outputLookup,this.forecastNumbers(_lookup2.default.toArray(this.inputLookup,t,this.inputLookupLength),this.outputLookupLength))}},{key:"trainInputOutput",value:function(t){for(var e=this.model,r=t.input,n=t.output,u=r.length+n.length,o=e.equations;o.length<u;)this.bindEquation();for(var i=0,a=0,s=0,l=r.length-1;s<l;s++)i+=o[a++].predictTarget(r[s],r[s+1]);i+=o[a++].predictTarget(r[r.length-1],n[0]);for(var p=0,h=n.length-1;p<h;p++)i+=o[a++].predictTarget(n[p],n[p+1]);return this.end(),i/u}},{key:"trainArrays",value:function(t){for(var e=this.model,r=e.equations;r.length<t.length;)this.bindEquation();for(var n=0,u=0,o=t.length-1;u<o;u++)n+=r[u].predictTarget(t[u],t[u+1]);return this.end(),n/t.length}},{key:"runArrays",value:function(t){if(!this.isRunnable)return null;for(var e=this.model,r=e.equations;r.length<=t.length;)this.bindEquation();for(var n=void 0,u=0;u<t.length;u++){n=r[u].runInput(t[u]).weights}return this.end(),this.outputLookup?_lookup2.default.toObject(this.outputLookup,n):n}},{key:"forecastArrays",value:function(t,e){if(!this.isRunnable)return null;for(var r=this.model,n=r.equations,u=t.length+e;n.length<=u;)this.bindEquation();for(var o=void 0,i=0,a=0;a<t.length;a++)o=n[i++].runInput(t[a]);for(var s=[o.weights],l=0,p=e-1;l<p;l++)o=n[i++].runInput(o.weights),s.push(o.weights);return this.end(),s}},{key:"end",value:function(){this.model.equations[this.model.equations.length-1].runInput(new Float32Array(this.outputSize))}},{key:"formatData",value:function(t){if(t[0].input){if(Array.isArray(t[0].input[0])){if(this.inputSize>1){for(var e=[],r=0;r<t.length;r++){var n=t[r];e.push({input:(0,_cast.arraysToFloat32Arrays)(n.input),output:(0,_cast.arraysToFloat32Arrays)(n.output)})}return e}for(var u=[],o=0;o<t.length;o++){var i=t[o];u.push({input:Float32Array.from(i.input),output:Float32Array.from(i.output)})}return u}if(Array.isArray(t[0].input)){if("number"==typeof t[0].input[0]){if(1===this.inputSize){for(var a=[],s=0;s<t.length;s++){var l=t[s];a.push({input:(0,_cast.arrayToFloat32Arrays)(l.input),output:(0,_cast.arrayToFloat32Arrays)(l.output)})}return a}throw new Error("data size too small for brain."+this.constructor.name+", try brain.NeuralNetwork")}for(var p=new _arrayLookupTable2.default(t,"input"),h=new _arrayLookupTable2.default(t,"output"),f=[],c=0;c<t.length;c++){var d=t[c];f.push({input:(0,_cast.objectsToFloat32Arrays)(d.input,p),output:(0,_cast.objectsToFloat32Arrays)(d.output,h)})}return this.inputLookup=p.table,this.inputLookupLength=p.length,this.outputLookup=h.table,this.outputLookupLength=h.length,f}if(1===this.inputSize){for(var g=new _lookupTable2.default(t,"input"),v=new _lookupTable2.default(t,"output"),y=[],m=0;m<t.length;m++){var _=t[m];y.push({input:(0,_cast.objectToFloat32Arrays)(_.input),output:(0,_cast.objectToFloat32Arrays)(_.output)}),this.inputLookup=g.table,this.inputLookupLength=g.length,this.outputLookup=v.table,this.outputLookupLength=v.length}return y}for(var b=new _lookupTable2.default(t,"input"),k=new _lookupTable2.default(t,"output"),w=[],L=0;L<t.length;L++){var q=t[L];w.push({input:(0,_cast.objectToFloat32Array)(q.input,b),output:(0,_cast.objectToFloat32Array)(q.output,k)})}return this.inputLookup=b.table,this.inputLookupLength=b.length,this.outputLookup=k.table,this.outputLookupLength=k.length,w}if(Array.isArray(t))if(Array.isArray(t[0])){if(this.inputSize>1){if(Array.isArray(t[0][0])){for(var x=[],S=0;S<t.length;S++)x.push((0,_cast.arraysToFloat32Arrays)(t[S]));return x}for(var A=[],O=0;O<t.length;O++)A.push(Float32Array.from(t[O]));return A}if(1===this.inputSize){for(var N=[],I=0;I<t.length;I++)N.push((0,_cast.arrayToFloat32Arrays)(t[I]));return N}}else if(1===this.inputSize){for(var T=[],j=0;j<t.length;j++)T.push(Float32Array.from([t[j]]));return T}throw new Error("unhandled data type")}},{key:"toJSON",value:function(){var t=this.constructor.defaults;this.model||this.initialize();var e=this.model,r={};for(var n in t)t.hasOwnProperty(n)&&(r[n]=this[n]);return{type:this.constructor.name,options:r,hiddenLayers:e.hiddenLayers.map(function(t){var e={};for(var r in t)e[r]=t[r].toJSON();return e}),outputConnector:this.model.outputConnector.toJSON(),output:this.model.output.toJSON()}}},{key:"fromJSON",value:function(t){var e=this.constructor.defaults,r=t.options;this.model=null,this.hiddenLayers=null;var n=[],u=[];(t.hiddenLayers||t.hiddenSizes).forEach(function(t){var e={};for(var r in t)e[r]=_matrix2.default.fromJSON(t[r]),n.push(e[r]);u.push(e)});var o=_matrix2.default.fromJSON(t.outputConnector);n.push(o);var i=_matrix2.default.fromJSON(t.output);n.push(i),Object.assign(this,e,r),r.hiddenSizes&&(this.hiddenLayers=r.hiddenSizes),this.model={hiddenLayers:u,output:i,allMatrices:n,outputConnector:o,equations:[],equationConnections:[]},this.initialLayerInputs=this.hiddenLayers.map(function(t){return new _matrix2.default(t,1)}),this.bindEquation()}},{key:"toFunction",value:function(){function t(t,r){for(var n=0,u=h.length;n<u;n++){var o=h[n];if(n===r){var i=e(t);switch(t){case o.left:if(i>-1)return"typeof prevStates["+i+"] === 'object' ? prevStates["+i+"].product : new Matrix("+t.rows+", "+t.columns+")";case o.right:if(i>-1)return"typeof prevStates["+i+"] === 'object' ? prevStates["+i+"].product : new Matrix("+t.rows+", "+t.columns+")";case o.product:return"new Matrix("+t.rows+", "+t.columns+")";default:throw Error("unknown state")}}if(t===o.product)return"states["+n+"].product";if(t===o.right)return"states["+n+"].right";if(t===o.left)return"states["+n+"].left"}}function e(t){for(var e=n.equationConnections[0],r=u[0].states,o=0,i=r.length;o<i;o++)if(r[o].product===t)return o;return e.indexOf(t)}function r(e,r){if(!e||!e.rows||!e.columns)return"null";if(e===n.outputConnector)return"json.outputConnector";if(e===n.output)return"json.output";for(var u=0,o=n.hiddenLayers.length;u<o;u++){var i=n.hiddenLayers[u];for(var a in i)if(i.hasOwnProperty(a)&&i[a]===e)return"json.hiddenLayers["+u+"]."+a}return t(e,r)}for(var n=this.model,u=this.model.equations,o=this.inputSize,i=this.inputLookup,a=this.inputLookupLength,s=this.outputLookup,l=this.outputLookupLength,p=u[1],h=p.states,f=JSON.stringify(this.toJSON()),c=[],d={},g=[],v=0,y=h.length;v<y;v++){var m=h[v];c.push("states["+v+"] = {\n      name: '"+m.forwardFn.name+"',\n      left: "+r(m.left,v)+",\n      right: "+r(m.right,v)+",\n      product: "+r(m.product,v)+"\n    }");var _=m.forwardFn.name;d[_]||(d[_]=!0,g.push("        case '"+_+"':"+("forwardFn"!==_?" //compiled from "+function(t){return"src/recurrent/matrix/"+t.replace(/[A-Z]/g,function(t){return"-"+t.toLowerCase()})+".js"}(_):"")+"\n          "+function(t){return t=t.toString().split("{"),t.shift(),t=t.join("{"),t=t.split("}"),t.pop(),t.join("}").split("\n").join("\n        ").replace("product.weights = _input.weights = _this.inputValue;",i&&1===o?"product.weights = _i < input.length ? input[_i] : prevStates[prevStates.length - 1].product.weights":"debugger;product.weights = input[_i];").replace("product.deltas[i] = 0;","").replace("product.deltas[column] = 0;","").replace("left.deltas[leftIndex] = 0;","").replace("right.deltas[rightIndex] = 0;","").replace("product.deltas = left.deltas.slice(0);","")}(m.forwardFn.toString())+"\n          break;"))}var b=1===this.inputSize&&this.outputLookup,k="\n  var input = "+(this.inputLookup?"lookupInput(rawInput)":"rawInput")+";\n  var json = "+f+";\n  var output = [];\n  var states = [];\n  var prevStates;\n  var state;\n  var max = "+(b?"input.length + "+(l-1):"input.length")+";\n  for (var _i = 0; _i < max; _i++) {\n    prevStates = states;\n    states = [];\n    "+c.join(";\n    ")+";\n    for (var stateIndex = 0, stateMax = "+c.length+"; stateIndex < stateMax; stateIndex++) {\n      state = states[stateIndex];\n      var product = state.product;\n      var left = state.left;\n      var right = state.right;\n      \n      switch (state.name) {\n"+g.join("\n")+"\n      }\n    }\n    "+(o&&i?"if (_i >= input.length - 1) { output.push(state.product.weights); }":"")+"\n  }\n  "+(this.inputLookup?"return lookupOutput(output)":"return state.product.weights")+";\n  "+function(){return i?1===o?"function lookupInput(input) {\n          var table = "+JSON.stringify(i)+";\n          var result = [];\n          for (var p in table) {\n            result.push(Float32Array.from([input[p]]));\n          }\n          return result;\n        }":"function lookupInput(input) {\n          var table = "+JSON.stringify(i)+";\n          var result = new Float32Array("+a+");\n          for (var p in table) {\n            result[table[p]] = input[p];\n          }\n          return result;\n        }":""}()+"\n  "+function(){return s?1===o?"function lookupOutput(output) {\n          var table = "+JSON.stringify(s)+";\n          var result = {};\n          for (var p in table) {\n            result[p] = output[table[p]][0];\n          }\n          return result;\n        }":void(s&&JSON.stringify(s)):""}()+"\n  \n  function Matrix(rows, columns) {\n    this.rows = rows;\n    this.columns = columns;\n    this.weights = zeros(rows * columns);\n  }\n  "+_zeros2.default.toString()+"\n  "+_softmax2.default.toString().replace("_2.default","Matrix")+"\n  "+_random.randomF.toString()+"\n  "+_sampleI2.default.toString()+"\n  "+_maxI2.default.toString();return new Function("rawInput",k)}}]),e}(_rnn2.default);exports.default=RNNTimeStep,RNNTimeStep.defaults={inputSize:1,hiddenLayers:[20],outputSize:1,learningRate:.01,decayRate:.999,smoothEps:1e-8,regc:1e-6,clipval:5},RNNTimeStep.trainDefaults=_rnn2.default.trainDefaults;
...
"use strict";function LookupTable(e,t){this.length=0,this.prop=t;for(var o=this.table={},r=0;r<e.length;r++){var s=e[r],a=s[t];for(var l in a)o.hasOwnProperty(l)||(o[l]=this.length++)}}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=LookupTable;
