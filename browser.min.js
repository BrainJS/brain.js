...
"use strict";function _classCallCheck(e,r){if(!(e instanceof r))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,r){for(var t=0;t<r.length;t++){var a=r[t];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(e,a.key,a)}}return function(r,t,a){return t&&e(r.prototype,t),a&&e(r,a),r}}(),Vocab=function(){function e(r,t){_classCallCheck(this,e),t=t||0,this.values=r,this.indexTable={},this.characterTable={},this.characters=[];for(var a={},n=0,c=r.length;n<c;n++)for(var s=r[n].toString(),i=0,l=s.length;i<l;i++){var h=s[i];h in a||(a[h]=!0,this.characters.push(h))}for(var o=this.characters.length,u=0;u<o;u++){var f=this.characters[u];u>=t&&(this.indexTable[f]=u,this.characterTable[u]=f)}}return _createClass(e,[{key:"toIndexes",value:function(e){for(var r=arguments.length<=1||void 0===arguments[1]?0:arguments[1],t=[],a=this.indexTable,n=0,c=e.length;n<c;n++){var s=e[n],i=a[s];i<r||t.push(i)}return t}},{key:"toCharacters",value:function(e){for(var r=arguments.length<=1||void 0===arguments[1]?0:arguments[1],t=[],a=this.characterTable,n=0,c=e.length;n<c;n++){var s=e[n];if(!(s<r)){var i=a[s];t.push(i)}}return t}}]),e}();exports.default=Vocab;
