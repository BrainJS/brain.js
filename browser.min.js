...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var i=t[r];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(t,r,i){return r&&e(t.prototype,r),i&&e(t,i),t}}(),_matrix=require("./matrix"),_matrix2=_interopRequireDefault(_matrix),_onesMatrix=require("./matrix/ones-matrix"),_onesMatrix2=_interopRequireDefault(_onesMatrix),_copy2=require("./matrix/copy"),_copy3=_interopRequireDefault(_copy2),_cloneNegative2=require("./matrix/clone-negative"),_cloneNegative3=_interopRequireDefault(_cloneNegative2),_add2=require("./matrix/add"),_add3=_interopRequireDefault(_add2),_addB2=require("./matrix/add-b"),_addB3=_interopRequireDefault(_addB2),_allOnes2=require("./matrix/all-ones"),_allOnes3=_interopRequireDefault(_allOnes2),_multiply2=require("./matrix/multiply"),_multiply3=_interopRequireDefault(_multiply2),_multiplyB2=require("./matrix/multiply-b"),_multiplyB3=_interopRequireDefault(_multiplyB2),_multiplyElement2=require("./matrix/multiply-element"),_multiplyElement3=_interopRequireDefault(_multiplyElement2),_multiplyElementB2=require("./matrix/multiply-element-b"),_multiplyElementB3=_interopRequireDefault(_multiplyElementB2),_relu2=require("./matrix/relu"),_relu3=_interopRequireDefault(_relu2),_reluB2=require("./matrix/relu-b"),_reluB3=_interopRequireDefault(_reluB2),_rowPluck2=require("./matrix/row-pluck"),_rowPluck3=_interopRequireDefault(_rowPluck2),_rowPluckB2=require("./matrix/row-pluck-b"),_rowPluckB3=_interopRequireDefault(_rowPluckB2),_sigmoid2=require("./matrix/sigmoid"),_sigmoid3=_interopRequireDefault(_sigmoid2),_sigmoidB2=require("./matrix/sigmoid-b"),_sigmoidB3=_interopRequireDefault(_sigmoidB2),_tanh2=require("./matrix/tanh"),_tanh3=_interopRequireDefault(_tanh2),_tanhB2=require("./matrix/tanh-b"),_tanhB3=_interopRequireDefault(_tanhB2),Equation=function(){function e(){_classCallCheck(this,e),this.inputRow=0,this.states=[],this.previousResults=[],this.previousResultInputs=[]}return _createClass(e,[{key:"previousResult",value:function(e){var t=new _matrix2.default(e,1);return this.previousResultInputs.push(t),t}},{key:"add",value:function(e,t){if(e.weights.length!==t.weights.length)throw new Error("misaligned matrices");var r=new _matrix2.default(e.rows,e.columns);return this.states.push({left:e,right:t,into:r,forwardFn:_add3.default,backpropagationFn:_addB3.default}),r}},{key:"allOnes",value:function(e,t){var r=new _matrix2.default(e,t);return this.states.push({left:r,into:r,forwardFn:_allOnes3.default}),r}},{key:"cloneNegative",value:function(e){var t=new _matrix2.default(e.rows,e.columns);return this.states.push({left:e,into:t,forwardFn:_cloneNegative3.default}),t}},{key:"subtract",value:function(e,t){if(e.weights.length!==t.weights.length)throw new Error("misaligned matrices");return this.add(this.add(this.allOnes(e.rows,e.columns),this.cloneNegative(e)),t)}},{key:"multiply",value:function(e,t){if(e.columns!==t.rows)throw new Error("misaligned matrices");var r=new _matrix2.default(e.rows,t.columns);return this.states.push({left:e,right:t,into:r,forwardFn:_multiply3.default,backpropagationFn:_multiplyB3.default}),r}},{key:"multiplyElement",value:function(e,t){if(e.weights.length!==t.weights.length)throw new Error("misaligned matrices");var r=new _matrix2.default(e.rows,e.columns);return this.states.push({left:e,right:t,into:r,forwardFn:_multiplyElement3.default,backpropagationFn:_multiplyElementB3.default}),r}},{key:"relu",value:function(e){var t=new _matrix2.default(e.rows,e.columns);return this.states.push({left:e,into:t,forwardFn:_relu3.default,backpropagationFn:_reluB3.default}),t}},{key:"inputMatrixToRow",value:function(e){var t=this,r=new _matrix2.default(e.columns,1);return this.states.push({left:e,get right(){return t.inputRow},into:r,forwardFn:_rowPluck3.default,backpropagationFn:_rowPluckB3.default}),r}},{key:"sigmoid",value:function(e){var t=new _matrix2.default(e.rows,e.columns);return this.states.push({left:e,into:t,forwardFn:_sigmoid3.default,backpropagationFn:_sigmoidB3.default}),t}},{key:"tanh",value:function(e){var t=new _matrix2.default(e.rows,e.columns);return this.states.push({left:e,into:t,forwardFn:_tanh3.default,backpropagationFn:_tanhB3.default}),t}},{key:"observe",value:function(e){var t=0,r=0;return this.states.push({forwardFn:function(){t++,console.log(e)},backpropagationFn:function(){r++,console.log(e)}}),e}},{key:"run",value:function(e){this.inputRow=e||0;for(var t=void 0,r=0,i=this.states.length;r<i;r++)t=this.states[r],t.hasOwnProperty("forwardFn")&&t.forwardFn(t.into,t.left,t.right);return t.into}},{key:"runBackpropagate",value:function(){for(var e=this.states.length;e-- >0;){var t=this.states[e];t.hasOwnProperty("backpropagationFn")&&t.backpropagationFn(t.into,t.left,t.right)}}},{key:"updatePreviousResults",value:function(){for(var e=0,t=this.previousResults.length;e<t;e++)(0,_copy3.default)(this.previousResultInputs[e],this.previousResults[e])}},{key:"copyPreviousResultsTo",value:function(e){for(var t=0,r=this.previousResults.length;t<r;t++)(0,_copy3.default)(e.previousResultInputs[t],this.previousResults[t])}},{key:"resetPreviousResults",value:function(){for(var e=0,t=this.previousResults.length;e<t;e++){var r=this.previousResultInputs[e];(0,_copy3.default)(r,new _matrix2.default(r.rows,1))}}},{key:"addPreviousResult",value:function(e){this.previousResults.push(e)}},{key:"toFunction",value:function(){throw new Error("not yet implemented")}},{key:"toFunctionStates",value:function(){}}]),e}();exports.default=Equation;
...
"use strict";function add(e,t,r){for(var s=0,d=t.weights.length;s<d;s++)e.weights[s]=t.weights[s]+r.weights[s],e.recurrence[s]=0}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=add;
...
"use strict";function multiplyElement(e,t,l){for(var r=0,i=t.weights.length;r<i;r++)e.weights[r]=t.weights[r]*l.weights[r],e.recurrence[r]=0}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=multiplyElement;

},{}],18:[function(require,module,exports){
"use strict";function multiply(e,r,t){for(var o=r.rows,s=r.columns,u=t.columns,l=0;l<o;l++)for(var i=0;i<u;i++){for(var c=0,a=0;a<s;a++)c+=r.weights[s*l+a]*t.weights[u*a+i];var f=u*l+i;e.weights[f]=c,e.recurrence[f]=0}}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=multiply;
...
"use strict";function relu(e,t){for(var r=0,s=t.weights.length;r<s;r++)e.weights[r]=Math.max(0,t.weights[r]),e.recurrence[r]=0}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=relu;
...
"use strict";function rowPluck(e,r,t){for(var o=0,u=r.columns;o<u;o++)e.weights[o]=r.weights[u*t+o],e.recurrence[o]=0}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=rowPluck;
...
"use strict";function sigmoid(e,t){for(var i=0,r=t.weights.length;i<r;i++)e.weights[i]=1/(1+Math.exp(-t.weights[i])),e.recurrence[i]=0}function sig(e){return 1/(1+Math.exp(-e))}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=sigmoid;
...
"use strict";function tanh(e,t){for(var r=0,h=t.weights.length;r<h;r++)e.weights[r]=Math.tanh(t.weights[r]),e.recurrence[r]=0}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=tanh;

},{}],31:[function(require,module,exports){
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function t(t,e){for(var i=0;i<e.length;i++){var r=e[i];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(t,r.key,r)}}return function(e,i,r){return i&&t(e.prototype,i),r&&t(e,r),e}}(),_sampleI2=require("./matrix/sample-i"),_sampleI3=_interopRequireDefault(_sampleI2),_maxI=require("./matrix/max-i"),_maxI2=_interopRequireDefault(_maxI),_matrix=require("./matrix"),_matrix2=_interopRequireDefault(_matrix),_randomMatrix=require("./matrix/random-matrix"),_randomMatrix2=_interopRequireDefault(_randomMatrix),_softmax=require("./matrix/softmax"),_softmax2=_interopRequireDefault(_softmax),_equation=require("./equation"),_equation2=_interopRequireDefault(_equation),defaults={isBackPropagate:!0,inputSize:20,inputRange:20,hiddenSizes:[20,20],outputSize:20,learningRate:.01,decayRate:.999,smoothEps:1e-8,regc:1e-6,clipval:5,json:null},RNN=function(){function t(e){_classCallCheck(this,t),e=e||{};for(var i in defaults)defaults.hasOwnProperty(i)&&"isBackPropagate"!==i&&(this[i]=e.hasOwnProperty(i)?e[i]:defaults[i]);this.stepCache={},this.runs=0,this.logProbabilities=null,this.totalPerplexity=null,this.totalCost=null,this.model={input:[],inputRows:[],equations:[],hidden:[],output:null,allMatrices:[],hiddenLayers:[]},this.json?this.fromJSON(this.json):(this.createModel(),this.mapModel())}return _createClass(t,[{key:"createModel",value:function(){var t=this.hiddenSizes,e=this.model,i=e.hiddenLayers;i.push(this.getModel(t[0],this.inputSize));for(var r=t[0],n=1;n<t.length;n++){var o=t[n];i.push(this.getModel(o,r)),r=o}}},{key:"getModel",value:function(t,e){return{weight:new _randomMatrix2.default(t,e,.08),transition:new _randomMatrix2.default(t,t,.08),bias:new _matrix2.default(t,1)}}},{key:"getEquation",value:function(t,e,i,r){var n=t.relu.bind(t),o=t.add.bind(t),a=t.multiply.bind(t),u=t.previousResult.bind(t);return n(o(o(a(r.weight,e),a(r.transition,u(i))),r.bias))}},{key:"createInputMatrix",value:function(){this.model.input=new _randomMatrix2.default(this.inputRange+1,this.inputSize,.08)}},{key:"createOutputMatrix",value:function(){var t=this.model,e=this.outputSize,i=this.hiddenSizes[this.hiddenSizes.length-1];t.outputConnector=new _randomMatrix2.default(e+1,i,.08),t.output=new _matrix2.default(e+1,1)}},{key:"bindEquations",value:function(){var t=this.model,e=this.hiddenSizes,i=t.hiddenLayers,r=new _equation2.default;t.equations.push(r);var n=this.getEquation(r,r.inputMatrixToRow(t.input),e[0],i[0]);r.addPreviousResult(n);for(var o=1,a=e.length;o<a;o++)n=this.getEquation(r,n,e[o],i[o]),r.addPreviousResult(n);r.add(r.multiply(t.outputConnector,n),t.output)}},{key:"mapModel",value:function(){var t=this.model,e=t.hiddenLayers,i=t.allMatrices;if(this.createInputMatrix(),!t.input)throw new Error("net.model.input not set");if(this.createOutputMatrix(),!t.outputConnector)throw new Error("net.model.outputConnector not set");if(!t.output)throw new Error("net.model.output not set");if(this.bindEquations(),!t.equations.length>0)throw new Error("net.equations not set");i.push(t.input);for(var r=0,n=e.length;r<n;r++){var o=e[r];for(var a in o)o.hasOwnProperty(a)&&i.push(o[a])}i.push(t.outputConnector),i.push(t.output)}},{key:"run",value:function(t){this.runs++,t=t||this.model.input;for(var e=this.model.equations,i=t.length,r=0,n=0,o=0,a=e.length;o<a;o++)e[o].resetPreviousResults();for(;e.length<=i;)this.bindEquations();var u=void 0,s=void 0;for(u=-1;u<i;u++){var l=e[u+1],h=u===-1?0:t[u],d=u===i-1?0:t[u+1];s=l.run(h),e[u+2]&&l.copyPreviousResultsTo(e[u+2]),this.logProbabilities=s;var p=(0,_softmax2.default)(s);r+=-Math.log2(p.weights[d]),n+=-Math.log(p.weights[d]),this.logProbabilities.recurrence=p.weights.slice(0),this.logProbabilities.recurrence[d]-=1}for(;u>-1;)e[u--].runBackpropagate();return this.step(),this.totalPerplexity=Math.pow(2,r/(i-1)),this.totalCost=n,s}},{key:"step",value:function(){for(var t=this.learningRate,e=this.regc,i=this.clipval,r=this.model,n=0,o=0,a=r.allMatrices,u=a.length,s=0;s<u;s++){var l=a[s];s in this.stepCache||(this.stepCache[s]=new _matrix2.default(l.rows,l.columns));for(var h=this.stepCache[s],d=0,p=l.weights.length;d<p;d++){var f=l.recurrence[d];h.weights[d]=h.weights[d]*this.decayRate+(1-this.decayRate)*f*f,f>i&&(f=i,n++),f<-i&&(f=-i,n++),o++,l.weights[d]+=-t*f/Math.sqrt(h.weights[d]+this.smoothEps)-e*l.weights[d],l.recurrence[d]=0}}this.ratioClipped=n/o}},{key:"predict",value:function(t,e,i){"undefined"==typeof t&&(t=!0),"undefined"==typeof e&&(e=1),"undefined"==typeof i&&(i=100);var r=[],n=void 0,o=this.model.equations[0];for(o.resetPreviousResults();;){n=0===r.length?0:r[r.length-1];var a=o.run(n);if(o.updatePreviousResults(),this.logProbabilities=a,1!==e&&t)for(var u=0,s=this.logProbabilities.weights.length;u<s;u++)this.logProbabilities.weights[u]/=e;var l=(0,_softmax2.default)(this.logProbabilities);if(n=t?(0,_sampleI3.default)(l):(0,_maxI2.default)(l),0===n)break;if(r.length>i)break;r.push(n)}return r}},{key:"runInput",value:function(t){throw new Error("not yet implemented")}},{key:"train",value:function(t,e){throw new Error("not yet implemented")}},{key:"trainPattern",value:function(t,e,i){throw new Error("not yet implemented")}},{key:"calculateDeltas",value:function(t){throw new Error("not yet implemented")}},{key:"adjustWeights",value:function(t){throw new Error("not yet implemented")}},{key:"formatData",value:function(t){throw new Error("not yet implemented")}},{key:"test",value:function(t){throw new Error("not yet implemented")}},{key:"toJSON",value:function(){var t=this.model,e={};for(var i in defaults)e[i]=this[i];return{type:this.constructor.name,options:e,input:t.input.toJSON(),hiddenLayers:t.hiddenLayers.map(function(t){var e={};for(var i in t)e[i]=t[i].toJSON();return e}),outputConnector:this.model.outputConnector.toJSON(),output:this.model.output.toJSON()}}},{key:"fromJSON",value:function(t){this.json=t;var e=this.model,i=t.options,r=e.allMatrices;e.input=_matrix2.default.fromJSON(t.input),r.push(e.input),e.hiddenLayers=t.hiddenLayers.map(function(t){var e={};for(var i in t)e[i]=_matrix2.default.fromJSON(t[i]),r.push(e[i]);return e}),e.outputConnector=_matrix2.default.fromJSON(t.outputConnector),e.output=_matrix2.default.fromJSON(t.output),r.push(e.outputConnector,e.output);for(var n in defaults)defaults.hasOwnProperty(n)&&"isBackPropagate"!==n&&(this[n]=i.hasOwnProperty(n)?i[n]:defaults[n]);this.bindEquations()}},{key:"toFunction",value:function(){throw new Error("not yet implemented")}}]),t}();exports.default=RNN;
...
var crossValidate=require("./dist/cross-validate"),likely=require("./dist/likely"),lookup=require("./dist/lookup"),NeuralNetwork=require("./dist/neural-network"),TrainStream=require("./dist/train-stream"),RNN=require("./dist/recurrent/rnn"),LSTM=require("./dist/recurrent/lstm"),GRU=require("./dist/recurrent/gru");module.exports={crossValidate:crossValidate,likely:likely,lookup:lookup,NeuralNetwork:NeuralNetwork,TrainStream:TrainStream,RNN:RNN,LSTM:LSTM,GRU:GRU};
...
},{"./_stream_duplex":56,"./internal/streams/BufferList":61,"_process":54,"buffer":46,"buffer-shims":45,"core-util-is":47,"events":48,"inherits":50,"isarray":52,"process-nextick-args":53,"stream":66,"string_decoder/":67,"util":44}],59:[function(require,module,exports){
...
},{"./_stream_duplex":56,"_process":54,"buffer":46,"buffer-shims":45,"core-util-is":47,"events":48,"inherits":50,"process-nextick-args":53,"stream":66,"util-deprecate":68}],61:[function(require,module,exports){
...
},{"./lib/_stream_duplex.js":56,"./lib/_stream_passthrough.js":57,"./lib/_stream_readable.js":58,"./lib/_stream_transform.js":59,"./lib/_stream_writable.js":60,"_process":54,"stream":66}],64:[function(require,module,exports){
