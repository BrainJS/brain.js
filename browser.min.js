...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function softmax(e){var t=new Matrix(e.rows,e.columns),r=-999999,i=void 0,o=e.weights.length;for(i=0;i<o;i++)e.weights[i]>r&&(r=e.weights[i]);var s=0;for(i=0;i<o;i++)t.weights[i]=Math.exp(e.weights[i]-r),s+=t.weights[i];for(i=0;i<o;i++)t.weights[i]/=s;return t}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=softmax;var _=require("./"),_2=_interopRequireDefault(_),Matrix=_2.default;
...
"use strict";function _toConsumableArray(r){if(Array.isArray(r)){for(var e=0,t=Array(r.length);e<r.length;e++)t[e]=r[e];return t}return Array.from(r)}function _classCallCheck(r,e){if(!(r instanceof e))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function r(r,e){for(var t=0;t<e.length;t++){var a=e[t];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(r,a.key,a)}}return function(e,t,a){return t&&r(e.prototype,t),a&&r(e,a),e}}(),Vocab=function(){function r(e){var t=arguments.length<=1||void 0===arguments[1]?0:arguments[1];_classCallCheck(this,r),this.values=e,this.indexTable={},this.characterTable={},this.characters=[];for(var a={},n=0,o=e.length;n<o;n++)for(var i=e[n].toString(),l=0,c=i.length;l<c;l++){var s=i[l];s in a||(a[s]=!0,this.characters.push(s))}for(var u=this.characters.length,h=0;h<u;h++){var f=this.characters[h];h>=t&&(this.indexTable[f]=h,this.characterTable[h]=f)}}return _createClass(r,[{key:"toIndexes",value:function(r){for(var e=arguments.length<=1||void 0===arguments[1]?0:arguments[1],t=[],a=this.indexTable,n=0,o=r.length;n<o;n++){var i=r[n],l=a[i];l<e||t.push(l)}return t}},{key:"toCharacters",value:function(r){for(var e=arguments.length<=1||void 0===arguments[1]?0:arguments[1],t=[],a=this.characterTable,n=0,o=r.length;n<o;n++){var i=r[n];if(!(i<e)){var l=a[i];t.push(l)}}return t}},{key:"toString",value:function(r,e){return this.toCharacters(r,e).join("")}}],[{key:"allPrintable",value:function(e){for(var t=[],a=32;a<=126;a++)t.push(String.fromCharCode(a));return new r(t,e)}},{key:"fromString",value:function(e,t){var a,n=(a=String.prototype).concat.apply(a,_toConsumableArray(new Set(e)));return new r(n,t)}}]),r}();exports.default=Vocab;
