...
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _classCallCheck(t,r){if(!(t instanceof r))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(t,r){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!r||"object"!=typeof r&&"function"!=typeof r?t:r}function _inherits(t,r){if("function"!=typeof r&&null!==r)throw new TypeError("Super expression must either be null or a function, not "+typeof r);t.prototype=Object.create(r&&r.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),r&&(Object.setPrototypeOf?Object.setPrototypeOf(t,r):t.__proto__=r)}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function t(t,r){for(var e=0;e<r.length;e++){var n=r[e];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(t,n.key,n)}}return function(r,e,n){return e&&t(r.prototype,e),n&&t(r,n),r}}(),_matrix=require("./matrix"),_matrix2=_interopRequireDefault(_matrix),_randomMatrix=require("./matrix/random-matrix"),_randomMatrix2=_interopRequireDefault(_randomMatrix),_equation=require("./matrix/equation"),_equation2=_interopRequireDefault(_equation),_rnn=require("./rnn"),_rnn2=_interopRequireDefault(_rnn),_zeros=require("../utilities/zeros"),_zeros2=_interopRequireDefault(_zeros),_softmax=require("./matrix/softmax"),_softmax2=_interopRequireDefault(_softmax),_random=require("../utilities/random"),_sampleI=require("./matrix/sample-i"),_sampleI2=_interopRequireDefault(_sampleI),_maxI=require("./matrix/max-i"),_maxI2=_interopRequireDefault(_maxI),_lookup=require("../lookup"),_lookup2=_interopRequireDefault(_lookup),_lookupTable=require("../utilities/lookup-table"),_lookupTable2=_interopRequireDefault(_lookupTable),_arrayLookupTable=require("../utilities/array-lookup-table"),_arrayLookupTable2=_interopRequireDefault(_arrayLookupTable),_cast=require("../utilities/cast"),RNNTimeStep=function(t){function r(t){_classCallCheck(this,r);var e=_possibleConstructorReturn(this,(r.__proto__||Object.getPrototypeOf(r)).call(this,t));return e.inputLookup=null,e.inputLookupLength=null,e.outputLookup=null,e.outputLookupLength=null,e}return _inherits(r,t),_createClass(r,[{key:"createOutputMatrix",value:function(){var t=this.model,r=this.outputSize,e=this.hiddenLayers[this.hiddenLayers.length-1];t.outputConnector=new _randomMatrix2.default(r,e,.08),t.output=new _randomMatrix2.default(r,1,.08)}},{key:"bindEquation",value:function(){var t=this.model,r=this.hiddenLayers,e=t.hiddenLayers,n=new _equation2.default,u=[],o=t.equationConnections.length>0?t.equationConnections[t.equationConnections.length-1]:this.initialLayerInputs,i=this.getEquation(n,n.input(new _matrix2.default(this.inputSize,1)),o[0],e[0]);u.push(i);for(var a=1,s=r.length;a<s;a++)i=this.getEquation(n,i,o[a],e[a]),u.push(i);t.equationConnections.push(u),n.add(n.multiply(t.outputConnector,i),t.output),t.equations.push(n)}},{key:"mapModel",value:function(){var t=this.model,r=t.hiddenLayers,e=t.allMatrices;if(this.initialLayerInputs=this.hiddenLayers.map(function(t){return new _matrix2.default(t,1)}),this.createHiddenLayers(),!t.hiddenLayers.length)throw new Error("net.hiddenLayers not set");for(var n=0,u=r.length;n<u;n++){var o=r[n];for(var i in o)o.hasOwnProperty(i)&&e.push(o[i])}if(this.createOutputMatrix(),!t.outputConnector)throw new Error("net.model.outputConnector not set");if(!t.output)throw new Error("net.model.output not set");e.push(t.outputConnector),e.push(t.output)}},{key:"backpropagate",value:function(){for(var t=this.model.equations.length-1;t>-1;t--)this.model.equations[t].backpropagate()}},{key:"run",value:function(t){return 1===this.inputSize?this.outputLookup?(this.run=this.runObject,this.runObject(t)):(this.run=this.runNumbers,this.runNumbers(t)):(this.run=this.runArrays,this.runArrays(t))}},{key:"forecast",value:function(t,r){return 1===this.inputSize?(this.forecast=this.forecastNumbers,this.forecastNumbers(t,r)):(this.forecast=this.forecastArrays,this.forecastArrays(t,r))}},{key:"train",value:function(t){var r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};r=Object.assign({},this.constructor.trainDefaults,r);var e=r.iterations,n=r.errorThresh,u=!0===r.log?console.log:r.log,o=r.logPeriod,i=r.learningRate||this.learningRate,a=r.callback,s=r.callbackPeriod;t=this.formatData(t),t[0].input?this.trainInput=this.trainInputOutput:t[0].length>0&&(t[0][0].length>0?this.trainInput=this.trainArrays:this.inputSize>1?(t=[t],this.trainInput=this.trainArrays):this.trainInput=this.trainNumbers);var p=1/0,l=void 0;for(this.model||this.initialize(),l=0;l<e&&p>n;l++){for(var h=0,f=0;f<t.length;f++){h+=this.trainPattern(t[f],i)}if(p=h/t.length,isNaN(p))throw new Error("network error rate is unexpected NaN, check network configurations and try again");u&&l%o==0&&u("iterations: "+l+", training error: "+p),a&&l%s==0&&a({error:p,iterations:l})}return{error:p,iterations:l}}},{key:"trainNumbers",value:function(t){for(var r=this.model,e=r.equations;e.length<t.length;)this.bindEquation();for(var n=0,u=0,o=t.length-1;u<o;u++)n+=e[u].predictTarget(t[u],t[u+1]);return this.end(),n/t.length}},{key:"runNumbers",value:function(t){if(!this.isRunnable)return null;var r=this.model,e=r.equations;for(this.inputLookup&&(t=_lookup2.default.toArray(this.inputLookup,t,this.inputLookupLength));e.length<=t.length;)this.bindEquation();for(var n=void 0,u=0;u<t.length;u++)n=e[u].runInput([t[u]]);return this.end(),n.weights[0]}},{key:"forecastNumbers",value:function(t,r){if(!this.isRunnable)return null;for(var e=this.model,n=e.equations,u=t.length+r;n.length<=u;)this.bindEquation();for(var o=void 0,i=0,a=0;a<t.length;a++)o=n[i++].runInput([t[a]]);for(var s=[o.weights[0]],p=0,l=r-1;p<l;p++)o=n[i++].runInput(o.weights),s.push(o.weights[0]);return this.end(),s}},{key:"runObject",value:function(t){if(this.inputLookup===this.outputLookup){var r=_lookup2.default.toArrayShort(this.inputLookup,t);return _lookup2.default.toObjectPartial(this.outputLookup,this.forecastNumbers(r,this.outputLookupLength-r.length),r.length)}return _lookup2.default.toObject(this.outputLookup,this.forecastNumbers(_lookup2.default.toArray(this.inputLookup,t,this.inputLookupLength),this.outputLookupLength))}},{key:"trainInputOutput",value:function(t){for(var r=this.model,e=t.input,n=t.output,u=e.length+n.length,o=r.equations;o.length<u;)this.bindEquation();for(var i=0,a=0,s=0,p=e.length-1;s<p;s++)i+=o[a++].predictTarget(e[s],e[s+1]);i+=o[a++].predictTarget(e[e.length-1],n[0]);for(var l=0,h=n.length-1;l<h;l++)i+=o[a++].predictTarget(n[l],n[l+1]);return this.end(),i/u}},{key:"trainArrays",value:function(t){for(var r=this.model,e=r.equations;e.length<t.length;)this.bindEquation();for(var n=0,u=0,o=t.length-1;u<o;u++)n+=e[u].predictTarget(t[u],t[u+1]);return this.end(),n/t.length}},{key:"runArrays",value:function(t){if(!this.isRunnable)return null;for(var r=this.model,e=r.equations;e.length<=t.length;)this.bindEquation();this.inputLookup&&(t=_lookup2.default.toArrays(this.inputLookup,t,this.inputLookupLength));for(var n=void 0,u=0;u<t.length;u++){n=e[u].runInput(t[u]).weights}return this.end(),this.outputLookup?_lookup2.default.toObject(this.outputLookup,n):n}},{key:"forecastArrays",value:function(t,r){if(!this.isRunnable)return null;for(var e=this.model,n=e.equations,u=t.length+r;n.length<=u;)this.bindEquation();for(var o=void 0,i=0,a=0;a<t.length;a++)o=n[i++].runInput(t[a]);for(var s=[o.weights],p=0,l=r-1;p<l;p++)o=n[i++].runInput(o.weights),s.push(o.weights.slice(0));return this.end(),s}},{key:"end",value:function(){this.model.equations[this.model.equations.length-1].runInput(new Float32Array(this.outputSize))}},{key:"formatData",value:function(t){if(t[0].input){if(Array.isArray(t[0].input[0])){if(this.inputSize>1){for(var r=[],e=0;e<t.length;e++){var n=t[e];r.push({input:(0,_cast.arraysToFloat32Arrays)(n.input),output:(0,_cast.arraysToFloat32Arrays)(n.output)})}return r}for(var u=[],o=0;o<t.length;o++){var i=t[o];u.push({input:Float32Array.from(i.input),output:Float32Array.from(i.output)})}return u}if(Array.isArray(t[0].input)){if("number"==typeof t[0].input[0]){if(1===this.inputSize){for(var a=[],s=0;s<t.length;s++){var p=t[s];a.push({input:(0,_cast.arrayToFloat32Arrays)(p.input),output:(0,_cast.arrayToFloat32Arrays)(p.output)})}return a}throw new Error("data is not recurrent")}for(var l=new _arrayLookupTable2.default(t,"input"),h=new _arrayLookupTable2.default(t,"output"),f=[],c=0;c<t.length;c++){var d=t[c];f.push({input:(0,_cast.objectsToFloat32Arrays)(d.input,l),output:(0,_cast.objectsToFloat32Arrays)(d.output,h)})}return this.inputLookup=l.table,this.inputLookupLength=l.length,this.outputLookup=h.table,this.outputLookupLength=h.length,f}if(1===this.inputSize){for(var g=new _lookupTable2.default(t,"input"),v=new _lookupTable2.default(t,"output"),y=[],m=0;m<t.length;m++){var _=t[m];y.push({input:(0,_cast.objectToFloat32Arrays)(_.input),output:(0,_cast.objectToFloat32Arrays)(_.output)}),this.inputLookup=g.table,this.inputLookupLength=g.length,this.outputLookup=v.table,this.outputLookupLength=v.length}return y}}else if(Array.isArray(t))if(Array.isArray(t[0])){if(this.inputSize>1){if(Array.isArray(t[0][0])){for(var k=[],b=0;b<t.length;b++)k.push((0,_cast.arraysToFloat32Arrays)(t[b]));return k}for(var w=[],L=0;L<t.length;L++)w.push(Float32Array.from(t[L]));return w}if(1===this.inputSize){for(var q=[],S=0;S<t.length;S++)q.push((0,_cast.arrayToFloat32Arrays)(t[S]));return q}}else if(1===this.inputSize){if(Array.isArray(t)&&"number"==typeof t[0]){for(var x=[],O=0;O<t.length;O++)x.push(Float32Array.from([t[O]]));return x}if(!t[0].hasOwnProperty(0)){for(var A=[],I=new _lookupTable2.default(t),N=0;N<t.length;N++)A.push((0,_cast.objectToFloat32Arrays)(t[N]));return this.inputLookup=I.table,this.inputLookupLength=I.length,this.outputLookup=I.table,this.outputLookupLength=I.length,A}}throw new Error("unknown data shape or configuration")}},{key:"toJSON",value:function(){var t=this.constructor.defaults;this.model||this.initialize();var r=this.model,e={};for(var n in t)t.hasOwnProperty(n)&&(e[n]=this[n]);return{type:this.constructor.name,options:e,hiddenLayers:r.hiddenLayers.map(function(t){var r={};for(var e in t)r[e]=t[e].toJSON();return r}),outputConnector:this.model.outputConnector.toJSON(),output:this.model.output.toJSON()}}},{key:"fromJSON",value:function(t){var r=this.constructor.defaults,e=t.options;this.model=null,this.hiddenLayers=null;var n=[],u=[];(t.hiddenLayers||t.hiddenSizes).forEach(function(t){var r={};for(var e in t)r[e]=_matrix2.default.fromJSON(t[e]),n.push(r[e]);u.push(r)});var o=_matrix2.default.fromJSON(t.outputConnector);n.push(o);var i=_matrix2.default.fromJSON(t.output);n.push(i),Object.assign(this,r,e),e.hiddenSizes&&(this.hiddenLayers=e.hiddenSizes),this.model={hiddenLayers:u,output:i,allMatrices:n,outputConnector:o,equations:[],equationConnections:[]},this.initialLayerInputs=this.hiddenLayers.map(function(t){return new _matrix2.default(t,1)}),this.bindEquation()}},{key:"toFunction",value:function(){function t(t,e){for(var n=0,u=h.length;n<u;n++){var o=h[n];if(n===e){var i=r(t);switch(t){case o.left:if(i>-1)return"typeof prevStates["+i+"] === 'object' ? prevStates["+i+"].product : new Matrix("+t.rows+", "+t.columns+")";case o.right:if(i>-1)return"typeof prevStates["+i+"] === 'object' ? prevStates["+i+"].product : new Matrix("+t.rows+", "+t.columns+")";case o.product:return"new Matrix("+t.rows+", "+t.columns+")";default:throw Error("unknown state")}}if(t===o.product)return"states["+n+"].product";if(t===o.right)return"states["+n+"].right";if(t===o.left)return"states["+n+"].left"}}function r(t){for(var r=n.equationConnections[0],e=u[0].states,o=0,i=e.length;o<i;o++)if(e[o].product===t)return o;return r.indexOf(t)}function e(r,e){if(!r||!r.rows||!r.columns)return"null";if(r===n.outputConnector)return"json.outputConnector";if(r===n.output)return"json.output";for(var u=0,o=n.hiddenLayers.length;u<o;u++){var i=n.hiddenLayers[u];for(var a in i)if(i.hasOwnProperty(a)&&i[a]===r)return"json.hiddenLayers["+u+"]."+a}return t(r,e)}for(var n=this.model,u=this.model.equations,o=this.inputSize,i=this.inputLookup,a=this.inputLookupLength,s=this.outputLookup,p=this.outputLookupLength,l=u[1],h=l.states,f=JSON.stringify(this.toJSON()),c=[],d={},g=[],v=0,y=h.length;v<y;v++){var m=h[v];c.push("states["+v+"] = {\n      name: '"+m.forwardFn.name+"',\n      left: "+e(m.left,v)+",\n      right: "+e(m.right,v)+",\n      product: "+e(m.product,v)+"\n    }");var _=m.forwardFn.name;d[_]||(d[_]=!0,g.push("        case '"+_+"':"+("forwardFn"!==_?" //compiled from "+function(t){return"src/recurrent/matrix/"+t.replace(/[A-Z]/g,function(t){return"-"+t.toLowerCase()})+".js"}(_):"")+"\n          "+function(t){return t=t.toString().split("{"),t.shift(),t=t.join("{"),t=t.split("}"),t.pop(),t.join("}").split("\n").join("\n        ").replace("product.weights = _input.weights = _this.inputValue;",i&&1===o?"product.weights = _i < input.length ? input[_i]: prevStates[prevStates.length - 1].product.weights;":1===o?"product.weights = [input[_i]];":"product.weights = input[_i];").replace("product.deltas[i] = 0;","").replace("product.deltas[column] = 0;","").replace("left.deltas[leftIndex] = 0;","").replace("right.deltas[rightIndex] = 0;","").replace("product.deltas = left.deltas.slice(0);","")}(m.forwardFn.toString())+"\n          break;"))}var k=1===this.inputSize&&this.outputLookup,b="\n  var input = "+(this.inputLookup?"lookupInput(rawInput)":"rawInput")+";\n  var json = "+f+";\n  var output = [];\n  var states = [];\n  var prevStates;\n  var state;\n  var max = "+(k?i===s?a:"input.length + "+(p-1):"input.length")+";\n  for (var _i = 0; _i < max; _i++) {\n    prevStates = states;\n    states = [];\n    "+c.join(";\n    ")+";\n    for (var stateIndex = 0, stateMax = "+c.length+"; stateIndex < stateMax; stateIndex++) {\n      state = states[stateIndex];\n      var product = state.product;\n      var left = state.left;\n      var right = state.right;\n      \n      switch (state.name) {\n"+g.join("\n")+"\n      }\n    }\n    "+(1===o&&i?"if (_i >= input.length - 1) { output.push(state.product.weights); }":"output = state.product.weights;")+"\n  }\n  "+(s?s===i?"return lookupOutputPartial(output, input)":"return lookupOutput(output)":1===o?"return output[0]":"return output")+";\n  "+function(){return i?1===o?i===s?"function lookupInput(input) {\n            var table = "+JSON.stringify(i)+";\n            var result = [];\n            for (var p in table) {\n              if (!input.hasOwnProperty(p)) break;\n              result.push(Float32Array.from([input[p]]));\n            }\n            return result;\n          }":"function lookupInput(input) {\n          var table = "+JSON.stringify(i)+";\n          var result = [];\n          for (var p in table) {\n            result.push(Float32Array.from([input[p]]));\n          }\n          return result;\n        }":"function lookupInput(rawInputs) {\n        var table = "+JSON.stringify(i)+";\n        var result = [];\n        for (var i = 0; i < rawInputs.length; i++) {\n          var rawInput = rawInputs[i];\n          var input = new Float32Array("+a+");\n          for (var p in table) {\n            input[table[p]] = rawInput.hasOwnProperty(p) ? rawInput[p] : 0;\n          }\n          result.push(input);\n        }\n        return result;\n      }":""}()+"\n  "+function(){return s?1===o?i===s?"function lookupOutputPartial(output, input) {\n            var table = "+JSON.stringify(s)+";\n            var offset = input.length;\n            var result = {};\n            var i = 0;\n            for (var p in table) {\n              if (i++ < offset) continue;\n              result[p] = output[table[p] - offset][0];\n            }\n            return result;\n          }":"function lookupOutput(output) {\n          var table = "+JSON.stringify(s)+";\n          var result = {};\n          for (var p in table) {\n            result[p] = output[table[p]][0];\n          }\n          return result;\n        }":"function lookupOutput(output) {\n        var table = "+JSON.stringify(s)+";\n        var result = {};\n        for (var p in table) {\n          result[p] = output[table[p]];\n        }\n        return result;\n      }":""}()+"\n  \n  function Matrix(rows, columns) {\n    this.rows = rows;\n    this.columns = columns;\n    this.weights = zeros(rows * columns);\n  }\n  "+_zeros2.default.toString()+"\n  "+_softmax2.default.toString().replace("_2.default","Matrix")+"\n  "+_random.randomF.toString()+"\n  "+_sampleI2.default.toString()+"\n  "+_maxI2.default.toString();return new Function("rawInput",b)}}]),r}(_rnn2.default);exports.default=RNNTimeStep,RNNTimeStep.defaults={inputSize:1,hiddenLayers:[20],outputSize:1,learningRate:.01,decayRate:.999,smoothEps:1e-8,regc:1e-6,clipval:5},RNNTimeStep.trainDefaults=_rnn2.default.trainDefaults;
...
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function t(t,e){for(var r=0;r<e.length;r++){var a=e[r];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(t,a.key,a)}}return function(e,r,a){return r&&t(e.prototype,r),a&&t(e,a),e}}(),_matrix=require("./matrix"),_matrix2=_interopRequireDefault(_matrix),_randomMatrix=require("./matrix/random-matrix"),_randomMatrix2=_interopRequireDefault(_randomMatrix),_equation=require("./matrix/equation"),_equation2=_interopRequireDefault(_equation),_sampleI=require("./matrix/sample-i"),_sampleI2=_interopRequireDefault(_sampleI),_maxI=require("./matrix/max-i"),_maxI2=_interopRequireDefault(_maxI),_softmax=require("./matrix/softmax"),_softmax2=_interopRequireDefault(_softmax),_copy=require("./matrix/copy"),_copy2=_interopRequireDefault(_copy),_random=require("../utilities/random"),_zeros=require("../utilities/zeros"),_zeros2=_interopRequireDefault(_zeros),_dataFormatter=require("../utilities/data-formatter"),_dataFormatter2=_interopRequireDefault(_dataFormatter),RNN=function(){function t(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};_classCallCheck(this,t);var r=this.constructor.defaults;Object.assign(this,r,e),this.stepCache={},this.runs=0,this.ratioClipped=null,this.model=null,this.inputLookup=null,this.outputLookup=null,e.json&&this.fromJSON(e.json)}return _createClass(t,[{key:"initialize",value:function(){this.model={input:null,hiddenLayers:[],output:null,equations:[],allMatrices:[],equationConnections:[],outputConnector:null},this.dataFormatter&&(this.inputSize=this.inputRange=this.outputSize=this.dataFormatter.characters.length),this.mapModel()}},{key:"createHiddenLayers",value:function(){this.model.hiddenLayers.push(this.getModel(this.hiddenLayers[0],this.inputSize));for(var t=this.hiddenLayers[0],e=1;e<this.hiddenLayers.length;e++){var r=this.hiddenLayers[e];this.model.hiddenLayers.push(this.getModel(r,t)),t=r}}},{key:"getModel",value:function(t,e){return{weight:new _randomMatrix2.default(t,e,.08),transition:new _randomMatrix2.default(t,t,.08),bias:new _matrix2.default(t,1)}}},{key:"getEquation",value:function(t,e,r,a){var n=t.relu.bind(t),i=t.add.bind(t),o=t.multiply.bind(t);return n(i(i(o(a.weight,e),o(a.transition,r)),a.bias))}},{key:"createInputMatrix",value:function(){this.model.input=new _randomMatrix2.default(this.inputRange+1,this.inputSize,.08)}},{key:"createOutputMatrix",value:function(){var t=this.model,e=this.outputSize,r=this.hiddenLayers[this.hiddenLayers.length-1];t.outputConnector=new _randomMatrix2.default(e+1,r,.08),t.output=new _matrix2.default(e+1,1)}},{key:"bindEquation",value:function(){var t=this.model,e=new _equation2.default,r=[],a=t.equationConnections.length>0?t.equationConnections[t.equationConnections.length-1]:this.initialLayerInputs,n=this.getEquation(e,e.inputMatrixToRow(t.input),a[0],t.hiddenLayers[0]);r.push(n);for(var i=1,o=this.hiddenLayers.length;i<o;i++)n=this.getEquation(e,n,a[i],t.hiddenLayers[i]),r.push(n);t.equationConnections.push(r),e.add(e.multiply(t.outputConnector,n),t.output),t.equations.push(e)}},{key:"mapModel",value:function(){var t=this.model,e=t.hiddenLayers,r=t.allMatrices;if(this.initialLayerInputs=this.hiddenLayers.map(function(t){return new _matrix2.default(t,1)}),this.createInputMatrix(),!t.input)throw new Error("net.model.input not set");if(r.push(t.input),this.createHiddenLayers(),!t.hiddenLayers.length)throw new Error("net.hiddenLayers not set");for(var a=0,n=e.length;a<n;a++){var i=e[a];for(var o in i)i.hasOwnProperty(o)&&r.push(i[o])}if(this.createOutputMatrix(),!t.outputConnector)throw new Error("net.model.outputConnector not set");if(!t.output)throw new Error("net.model.output not set");r.push(t.outputConnector),r.push(t.output)}},{key:"trainPattern",value:function(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,r=this.trainInput(t);return this.backpropagate(t),this.adjustWeights(e),r}},{key:"trainInput",value:function(t){this.runs++;for(var e=this.model,r=t.length,a=0,n=void 0;e.equations.length<=t.length+1;)this.bindEquation();for(var i=-1,o=t.length;i<o;i++){var u=i+1;n=e.equations[u];var s=-1===i?0:t[i]+1,l=i===r-1?0:t[i+1]+1;a+=n.predictTargetIndex(s,l)}return Math.pow(2,a/(r-1))/100}},{key:"backpropagate",value:function(t){for(var e=t.length,r=this.model,a=r.equations;e>0;)a[e].backpropagateIndex(t[e-1]+1),e--;a[0].backpropagateIndex(0)}},{key:"adjustWeights",value:function(){for(var t=(arguments.length>0&&void 0!==arguments[0]&&arguments[0],this.learningRate),e=this.regc,r=this.clipval,a=this.model,n=0,i=0,o=a.allMatrices,u=0;u<o.length;u++){var s=o[u],l=s.weights,h=s.deltas;u in this.stepCache||(this.stepCache[u]=(0,_zeros2.default)(s.rows*s.columns));for(var d=this.stepCache[u],p=0;p<l.length;p++){var f=h[p],c=l[p];d[p]=d[p]*this.decayRate+(1-this.decayRate)*f*f,f>r&&(f=r,n++),f<-r&&(f=-r,n++),i++,l[p]=c+-t*f/Math.sqrt(d[p]+this.smoothEps)-e*c}}this.ratioClipped=n/i}},{key:"run",value:function(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:[],e=arguments.length>1&&void 0!==arguments[1]&&arguments[1],r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:1,a=this.maxPredictionLength+t.length+(this.dataFormatter?this.dataFormatter.specialIndexes.length:0);if(!this.isRunnable)return null;for(var n=this.formatDataIn(t),i=this.model,o=[],u=0;;){for(var s=0===u?0:u<n.length?n[u-1]+1:o[u-1];i.equations.length<=u;)this.bindEquation();var l=i.equations[u],h=l.runIndex(s),d=new _matrix2.default(i.output.rows,i.output.columns);if((0,_copy2.default)(d,h),1!==r&&e)for(var p=0,f=d.weights.length;p<f;p++)d.weights[p]/=r;var c=(0,_softmax2.default)(d),m=e?(0,_sampleI2.default)(c):(0,_maxI2.default)(c);if(u++,0===m)break;if(u>=a)break;o.push(m)}return this.formatDataOut(n,o.slice(n.length).map(function(t){return t-1}))}},{key:"train",value:function(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};e=Object.assign({},this.constructor.trainDefaults,e);var r=e.iterations,a=e.errorThresh,n=!0===e.log?console.log:e.log,i=e.logPeriod,o=e.learningRate||this.learningRate,u=e.callback,s=e.callbackPeriod,l=1/0,h=void 0;for(this.hasOwnProperty("setupData")&&(t=this.setupData(t)),this.model||this.initialize(),h=0;h<r&&l>a;h++){for(var d=0,p=0;p<t.length;p++){d+=this.trainPattern(t[p],o)}if(l=d/t.length,isNaN(l))throw new Error("network error rate is unexpected NaN, check network configurations and try again");n&&h%i==0&&n("iterations: "+h+", training error: "+l),u&&h%s==0&&u({error:l,iterations:h})}return{error:l,iterations:h}}},{key:"toJSON",value:function(){var t=this.constructor.defaults;this.model||this.initialize();var e=this.model,r={};for(var a in t)t.hasOwnProperty(a)&&(r[a]=this[a]);return{type:this.constructor.name,options:r,input:e.input.toJSON(),hiddenLayers:e.hiddenLayers.map(function(t){var e={};for(var r in t)e[r]=t[r].toJSON();return e}),outputConnector:this.model.outputConnector.toJSON(),output:this.model.output.toJSON()}}},{key:"fromJSON",value:function(t){var e=this.constructor.defaults,r=t.options;this.model=null,this.hiddenLayers=null;var a=[],n=_matrix2.default.fromJSON(t.input);a.push(n);var i=[];(t.hiddenLayers||t.hiddenSizes).forEach(function(t){var e={};for(var r in t)e[r]=_matrix2.default.fromJSON(t[r]),a.push(e[r]);i.push(e)});var o=_matrix2.default.fromJSON(t.outputConnector);a.push(o);var u=_matrix2.default.fromJSON(t.output);a.push(u),Object.assign(this,e,r),r.hiddenSizes&&(this.hiddenLayers=r.hiddenSizes),r.dataFormatter&&(this.dataFormatter=_dataFormatter2.default.fromJSON(r.dataFormatter)),this.model={input:n,hiddenLayers:i,output:u,allMatrices:a,outputConnector:o,equations:[],equationConnections:[]},this.initialLayerInputs=this.hiddenLayers.map(function(t){return new _matrix2.default(t,1)}),this.bindEquation()}},{key:"toFunction",value:function(){function t(t,r){for(var a=0,n=u.length;a<n;a++){var i=u[a];if(a===r){var o=e(t);switch(t){case i.left:if(o>-1)return"typeof prevStates["+o+"] === 'object' ? prevStates["+o+"].product : new Matrix("+t.rows+", "+t.columns+")";case i.right:if(o>-1)return"typeof prevStates["+o+"] === 'object' ? prevStates["+o+"].product : new Matrix("+t.rows+", "+t.columns+")";case i.product:return"new Matrix("+t.rows+", "+t.columns+")";default:throw Error("unknown state")}}if(t===i.product)return"states["+a+"].product";if(t===i.right)return"states["+a+"].right";if(t===i.left)return"states["+a+"].left"}}function e(t){for(var e=n.equationConnections[0],r=i[0].states,a=0,o=r.length;a<o;a++)if(r[a].product===t)return a;return e.indexOf(t)}function r(e,r){if(!e||!e.rows||!e.columns)return"null";if(e===n.input)return"json.input";if(e===n.outputConnector)return"json.outputConnector";if(e===n.output)return"json.output";for(var a=0,i=n.hiddenLayers.length;a<i;a++){var o=n.hiddenLayers[a];for(var u in o)if(o.hasOwnProperty(u)&&o[u]===e)return"json.hiddenLayers["+a+"]."+u}return t(e,r)}function a(t){return t=t.toString().split("{"),t.shift(),t=t.join("{"),t=t.split("}"),t.pop(),t.join("}").split("\n").join("\n        ").replace("product.deltas[i] = 0;","").replace("product.deltas[column] = 0;","").replace("left.deltas[leftIndex] = 0;","").replace("right.deltas[rightIndex] = 0;","").replace("product.deltas = left.deltas.slice(0);","")}for(var n=this.model,i=this.model.equations,o=i[1],u=o.states,s=JSON.stringify(this.toJSON()),l=[],h={},d=[],p=0,f=u.length;p<f;p++){var c=u[p];l.push("states["+p+"] = {\n      name: '"+c.forwardFn.name+"',\n      left: "+r(c.left,p)+",\n      right: "+r(c.right,p)+",\n      product: "+r(c.product,p)+"\n    }");var m=c.forwardFn.name;h[m]||(h[m]=!0,d.push("        case '"+m+"': //compiled from "+function(t){return"src/recurrent/matrix/"+t.replace(/[A-Z]/g,function(t){return"-"+t.toLowerCase()})+".js"}(m)+"\n          "+a(c.forwardFn.toString())+"\n          break;"))}var g="\n  if (typeof rawInput === 'undefined') rawInput = [];\n  if (typeof isSampleI === 'undefined') isSampleI = false;\n  if (typeof temperature === 'undefined') temperature = 1;\n  "+(this.dataFormatter?this.dataFormatter.toFunctionString():"")+"\n  \n  var input = "+(this.dataFormatter&&"function"==typeof this.formatDataIn?"formatDataIn(rawInput)":"rawInput")+";\n  var json = "+s+";\n  var maxPredictionLength = input.length + "+this.maxPredictionLength+";\n  var _i = 0;\n  var output = [];\n  var states = [];\n  var prevStates;\n  while (true) {\n    var previousIndex = (_i === 0\n        ? 0\n        : _i < input.length\n          ? input[_i - 1] + 1\n          : output[_i - 1])\n          ;\n    var rowPluckIndex = previousIndex;\n    var state;\n    prevStates = states;\n    states = [];\n    "+l.join(";\n    ")+";\n    for (var stateIndex = 0, stateMax = "+l.length+"; stateIndex < stateMax; stateIndex++) {\n      state = states[stateIndex];\n      var product = state.product;\n      var left = state.left;\n      var right = state.right;\n      \n      switch (state.name) {\n"+d.join("\n")+"\n      }\n    }\n    \n    var logProbabilities = state.product;\n    if (temperature !== 1 && isSampleI) {\n      for (var q = 0, nq = logProbabilities.weights.length; q < nq; q++) {\n        logProbabilities.weights[q] /= temperature;\n      }\n    }\n\n    var probs = softmax(logProbabilities);\n    var nextIndex = isSampleI ? sampleI(probs) : maxI(probs);\n    \n    _i++;\n    if (nextIndex === 0) {\n      break;\n    }\n    if (_i >= maxPredictionLength) {\n      break;\n    }\n\n    output.push(nextIndex);\n  }\n  "+(this.dataFormatter&&"function"==typeof this.formatDataOut?"return formatDataOut(input, output.slice(input.length).map(function(value) { return value - 1; }))":"return output.slice(input.length).map(function(value) { return value - 1; })")+";\n  function Matrix(rows, columns) {\n    this.rows = rows;\n    this.columns = columns;\n    this.weights = zeros(rows * columns);\n  }\n  "+(this.dataFormatter&&"function"==typeof this.formatDataIn?"function formatDataIn(input, output) { "+a(this.formatDataIn.toString()).replace(/this[.]dataFormatter[\n\s]+[.]/g,"").replace(/this[.]dataFormatter[.]/g,"").replace(/this[.]dataFormatter/g,"true")+" }":"")+"\n  "+(null!==this.dataFormatter&&"function"==typeof this.formatDataOut?"function formatDataOut(input, output) { "+a(this.formatDataOut.toString()).replace(/this[.]dataFormatter[\n\s]+[.]/g,"").replace(/this[.]dataFormatter[.]/g,"").replace(/this[.]dataFormatter/g,"true")+" }":"")+"\n  "+_zeros2.default.toString()+"\n  "+_softmax2.default.toString().replace("_2.default","Matrix")+"\n  "+_random.randomF.toString()+"\n  "+_sampleI2.default.toString()+"\n  "+_maxI2.default.toString();return new Function("rawInput","isSampleI","temperature",g)}},{key:"isRunnable",get:function(){return 0!==this.model.equations.length||(console.error("No equations bound, did you run train()?"),!1)}}]),t}();exports.default=RNN,RNN.defaults={inputSize:20,inputRange:20,hiddenLayers:[20,20],outputSize:20,learningRate:.01,decayRate:.999,smoothEps:1e-8,regc:1e-6,clipval:5,maxPredictionLength:100,setupData:function(t){if(!("string"==typeof t[0]||Array.isArray(t[0])||t[0].hasOwnProperty("input")&&t[0].hasOwnProperty("output")))return t;var e=[],r=[];if("string"==typeof t[0]||Array.isArray(t[0])){if(!this.dataFormatter){for(var a=0;a<t.length;a++)e.push(t[a]);this.dataFormatter=new _dataFormatter2.default(e)}for(var n=0,i=t.length;n<i;n++)r.push(this.formatDataIn(t[n]))}else{if(!this.dataFormatter){for(var o=0;o<t.length;o++)e.push(t[o].input),e.push(t[o].output);this.dataFormatter=_dataFormatter2.default.fromArrayInputOutput(e),this.dataFormatter.addUnrecognized()}for(var u=0,s=t.length;u<s;u++)r.push(this.formatDataIn(t[u].input,t[u].output))}return r},formatDataIn:function(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;return this.dataFormatter?this.dataFormatter.indexTable.hasOwnProperty("stop-input")?this.dataFormatter.toIndexesInputOutput(t,e):this.dataFormatter.toIndexes(t):t},formatDataOut:function(t,e){return this.dataFormatter?this.dataFormatter.toCharacters(e).join(""):e},dataFormatter:null},RNN.trainDefaults={iterations:2e4,errorThresh:.005,log:!1,logPeriod:10,learningRate:.3,callback:null,callbackPeriod:10,keepNetworkIntact:!1};
