...
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _toConsumableArray(t){if(Array.isArray(t)){for(var e=0,r=Array(t.length);e<t.length;e++)r[e]=t[e];return r}return Array.from(t)}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}function _inherits(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}function weightedSumSigmoid(t,e,r){for(var a=e[this.thread.x],u=0;u<this.constants.size;u++)a+=t[this.thread.x][u]*r[u];return 1/(1+Math.exp(-a))}function weightedSumRelu(t,e,r){for(var a=e[this.thread.x],u=0;u<this.constants.size;u++)a+=t[this.thread.x][u]*r[u];return a<0?0:a}function weightedSumLeakyRelu(t,e,r){for(var a=e[this.thread.x],u=0;u<this.constants.size;u++)a+=t[this.thread.x][u]*r[u];return a<0?0:.01*a}function weightedSumTanh(t,e,r){for(var a=e[this.thread.x],u=0;u<this.constants.size;u++)a+=t[this.thread.x][u]*r[u];return Math.tanh(a)}function calcErrorOutput(t,e){return e[this.thread.x]-t}function calcDeltasSigmoid(t,e){return t*e*(1-e)}function calcDeltasRelu(t,e){return e>0?t:0}function calcDeltasLeakyRelu(t,e){return e>0?t:.01*t}function calcDeltasTanh(t,e){return(1-e*e)*t}function calcError(t,e){for(var r=0,a=0;a<this.constants.size;a++)r+=e[a]*t[a][this.thread.x];return r}function calcChanges(t,e,r,a,u){return a*e[this.thread.y]*r[this.thread.x]+u*t[this.thread.y][this.thread.x]}function addWeights(t,e){return t+e[this.thread.y][this.thread.x]}function addBiases(t,e,r){return t[this.thread.x]+e[this.thread.x]*r}function mse(t){for(var e=0,r=0;r<this.constants.size;r++)e+=Math.pow(t[r],2);return e/this.constants.size}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function t(t,e){for(var r=0;r<e.length;r++){var a=e[r];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(t,a.key,a)}}return function(e,r,a){return r&&t(e.prototype,r),a&&t(e,a),e}}(),_get=function t(e,r,a){null===e&&(e=Function.prototype);var u=Object.getOwnPropertyDescriptor(e,r);if(void 0===u){var i=Object.getPrototypeOf(e);return null===i?void 0:t(i,r,a)}if("value"in u)return u.value;var o=u.get;if(void 0!==o)return o.call(a)},_neuralNetwork=require("./neural-network"),_neuralNetwork2=_interopRequireDefault(_neuralNetwork),_lookup=require("./lookup"),_lookup2=_interopRequireDefault(_lookup),_gpu=require("gpu.js"),_gpu2=_interopRequireDefault(_gpu),NeuralNetworkGPU=function(t){function e(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};_classCallCheck(this,e);var r=_possibleConstructorReturn(this,(e.__proto__||Object.getPrototypeOf(e)).call(this,t));return r.forwardPropagate=[],r.backwardPropagate=[],r.changesPropagate=[],r.biasesPropagate=[],r.gpu=new _gpu2.default({mode:t.mode}),r}return _inherits(e,t),_createClass(e,[{key:"initialize",value:function(t){_get(e.prototype.__proto__||Object.getPrototypeOf(e.prototype),"initialize",this).call(this,t),this.buildRunInput(),this.buildCalculateDeltas(),this.buildGetChanges(),this.buildChangeBiases(),this.buildGetMSE()}},{key:"setActivation",value:function(){}},{key:"trainPattern",value:function(t,e,r){return r=r||this.learningRate,this.runInput(t),this.calculateDeltas(e),this.getChanges(r),this.changeBiases(r),this.getMSE(this.errors[this.outputLayer])[0]}},{key:"buildRunInput",value:function(){var t=null;switch(this.activation){case"sigmoid":t=weightedSumSigmoid;break;case"relu":t=weightedSumRelu;break;case"leaky-relu":t=weightedSumLeakyRelu;break;case"tanh":t=weightedSumTanh;break;default:throw new Error("unknown activation "+this.activation)}for(var e=1;e<=this.outputLayer;e++)this.forwardPropagate[e]=this.gpu.createKernel(t,{output:[this.sizes[e]],outputToTexture:!0,constants:{size:this.sizes[e-1]}})}},{key:"runInput",value:function(t){var e=void 0;this.outputs[0]=t;for(var r=1;r<=this.outputLayer;r++)this.outputs[r]=this.forwardPropagate[r](this.weights[r],this.biases[r],t),e=t=this.outputs[r];return e}},{key:"buildCalculateDeltas",value:function(){var t=null;switch(this.activation){case"sigmoid":t=calcDeltasSigmoid;break;case"relu":t=calcDeltasRelu;break;case"leaky-relu":t=calcDeltasLeakyRelu;break;case"tanh":t=calcDeltasTanh;break;default:throw new Error("unknown activation "+this.activation)}for(var e=this.outputLayer;e>0;e--)e===this.outputLayer?this.backwardPropagate[e]=this.gpu.createKernelMap({error:_gpu2.default.alias("calcErrorOutput",calcErrorOutput),deltas:_gpu2.default.alias("calcDeltas",t)},function(e,r){var a=e[this.thread.x];return t(calcErrorOutput(a,r),a)},{output:[this.sizes[e]],outputToTexture:!0}):this.backwardPropagate[e]=this.gpu.createKernelMap({error:_gpu2.default.alias("calcError",calcError),deltas:_gpu2.default.alias("calcDeltas",t)},function(e,r,a){var u=r[this.thread.x];return t(calcError(e,a),u)},{output:[this.sizes[e]],outputToTexture:!0,constants:{size:this.deltas[e+1].length}})}},{key:"calculateDeltas",value:function(t,e){for(var r=this.outputLayer;r>0;r--){var a=void 0;a=r===this.outputLayer?this.backwardPropagate[r](this.outputs[r],t):this.backwardPropagate[r](this.weights[r+1],this.outputs[r],this.deltas[r+1]),this.deltas[r]=a.deltas,this.errors[r]=a.error}}},{key:"buildGetChanges",value:function(){for(var t=1;t<=this.outputLayer;t++)this.changesPropagate[t]=this.gpu.createKernelMap({weights:_gpu2.default.alias("addWeights",addWeights),changes:_gpu2.default.alias("calcChanges",calcChanges)},function(t,e,r,a,u,i){return addWeights(calcChanges(a,e,t,u,i),r)},{output:[this.sizes[t-1],this.sizes[t]],outputToTexture:!0,constants:{size:this.outputs[t-1].length}})}},{key:"getChanges",value:function(t){for(var e=1;e<=this.outputLayer;e++){var r=this.changesPropagate[e](this.outputs[e-1],this.deltas[e],this.weights[e],this.changes[e],t,this.momentum);this.changes[e]=r.changes,this.weights[e]=r.weights}}},{key:"buildChangeBiases",value:function(){for(var t=1;t<=this.outputLayer;t++)this.biasesPropagate[t]=this.gpu.createKernel(addBiases,{output:[this.sizes[t]],outputToTexture:!0})}},{key:"changeBiases",value:function(t){for(var e=1;e<=this.outputLayer;e++)this.biases[e]=this.biasesPropagate[e](this.biases[e],this.deltas[e],t)}},{key:"buildGetMSE",value:function(){this.getMSE=this.gpu.createKernel(mse,{output:[1],constants:{size:this.outputLayer}})}},{key:"run",value:function(t){this.inputLookup&&(t=_lookup2.default.toArray(this.inputLookup,t));var e=[].concat(_toConsumableArray(this.runInput(t).toArray(this.gpu)));return this.outputLookup&&(e=_lookup2.default.toHash(this.outputLookup,e)),e}},{key:"formatData",value:function(t){var e=this;if(!Array.isArray(t)){var r=[];r.push(t),t=r}var a=t[0].input;return Array.isArray(a)||a instanceof Float32Array||(this.inputLookup||(this.inputLookup=_lookup2.default.buildLookup(t.map(function(t){return t.input}))),t=t.map(function(t){var r=_lookup2.default.toArray(e.inputLookup,t.input);return Object.assign({},t,{input:r})},this)),Array.isArray(t[0].output)||(this.outputLookup||(this.outputLookup=_lookup2.default.buildLookup(t.map(function(t){return t.output}))),t=t.map(function(t){var r=_lookup2.default.toArray(e.outputLookup,t.output);return Object.assign({},t,{output:r})},this)),t}},{key:"toFunction",value:function(){throw new Error("not implemented on NeuralNetworkGPU")}}]),e}(_neuralNetwork2.default);exports.default=NeuralNetworkGPU;

},{"./lookup":3,"./neural-network":5,"gpu.js":76}],5:[function(require,module,exports){
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _toConsumableArray(t){if(Array.isArray(t)){for(var e=0,i=Array(t.length);e<t.length;e++)i[e]=t[e];return i}return Array.from(t)}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function t(t,e){for(var i=0;i<e.length;i++){var r=e[i];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(t,r.key,r)}}return function(e,i,r){return i&&t(e.prototype,i),r&&t(e,r),e}}(),_lookup=require("./lookup"),_lookup2=_interopRequireDefault(_lookup),_trainStream=require("./train-stream"),_trainStream2=_interopRequireDefault(_trainStream),_max=require("./utilities/max"),_max2=_interopRequireDefault(_max),_mse=require("./utilities/mse"),_mse2=_interopRequireDefault(_mse),_randos=require("./utilities/randos"),_randos2=_interopRequireDefault(_randos),_range=require("./utilities/range"),_range2=_interopRequireDefault(_range),_toArray=require("./utilities/to-array"),_toArray2=_interopRequireDefault(_toArray),_zeros=require("./utilities/zeros"),_zeros2=_interopRequireDefault(_zeros),_thaw=require("thaw.js"),_thaw2=_interopRequireDefault(_thaw),NeuralNetwork=function(){function t(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};_classCallCheck(this,t),Object.assign(this,this.constructor.defaults,e),this.hiddenSizes=e.hiddenLayers,this.sizes=null,this.outputLayer=null,this.biases=null,this.weights=null,this.outputs=null,this.deltas=null,this.changes=null,this.errors=null,this.constructor.prototype.hasOwnProperty("runInput")||(this.runInput=null),this.constructor.prototype.hasOwnProperty("calculateDeltas")||(this.calculateDeltas=null)}return _createClass(t,null,[{key:"trainDefaults",get:function(){return{iterations:2e4,errorThresh:.005,log:!1,logPeriod:10,learningRate:.3,callback:null,callbackPeriod:10,trainTimeMs:-1/0}}},{key:"defaults",get:function(){return{learningRate:.3,momentum:.1,binaryThresh:.5,hiddenLayers:null,activation:"sigmoid"}}}]),_createClass(t,[{key:"initialize",value:function(t){this.sizes=t,this.outputLayer=this.sizes.length-1,this.biases=[],this.weights=[],this.outputs=[],this.deltas=[],this.changes=[],this.errors=[];for(var e=0;e<=this.outputLayer;e++){var i=this.sizes[e];if(this.deltas[e]=(0,_zeros2.default)(i),this.errors[e]=(0,_zeros2.default)(i),this.outputs[e]=(0,_zeros2.default)(i),e>0){this.biases[e]=(0,_randos2.default)(i),this.weights[e]=new Array(i),this.changes[e]=new Array(i);for(var r=0;r<i;r++){var a=this.sizes[e-1];this.weights[e][r]=(0,_randos2.default)(a),this.changes[e][r]=(0,_zeros2.default)(a)}}}this.setActivation()}},{key:"setActivation",value:function(){switch(this.activation){case"sigmoid":this.runInput=this.runInput||this.runInputSigmoid,this.calculateDeltas=this.calculateDeltas||this.calculateDeltasSigmoid;break;case"relu":this.runInput=this.runInput||this.runInputRelu,this.calculateDeltas=this.calculateDeltas||this.calculateDeltasRelu;break;case"leaky-relu":this.runInput=this.runInput||this.runInputLeakyRelu,this.calculateDeltas=this.calculateDeltas||this.calculateDeltasLeakyRelu;break;case"tanh":this.runInput=this.runInput||this.runInputTanh,this.calculateDeltas=this.calculateDeltas||this.calculateDeltasTanh;break;default:throw new Error("unknown activation "+this.activation)}}},{key:"run",value:function(t){this.inputLookup&&(t=_lookup2.default.toArray(this.inputLookup,t));var e=[].concat(_toConsumableArray(this.runInput(t)));return this.outputLookup&&(e=_lookup2.default.toHash(this.outputLookup,e)),e}},{key:"runInputSigmoid",value:function(t){this.outputs[0]=t;for(var e=null,i=1;i<=this.outputLayer;i++){for(var r=0;r<this.sizes[i];r++){for(var a=this.weights[i][r],s=this.biases[i][r],u=0;u<a.length;u++)s+=a[u]*t[u];this.outputs[i][r]=1/(1+Math.exp(-s))}e=t=this.outputs[i]}return e}},{key:"runInputRelu",value:function(t){this.outputs[0]=t;for(var e=null,i=1;i<=this.outputLayer;i++){for(var r=0;r<this.sizes[i];r++){for(var a=this.weights[i][r],s=this.biases[i][r],u=0;u<a.length;u++)s+=a[u]*t[u];this.outputs[i][r]=s<0?0:s}e=t=this.outputs[i]}return e}},{key:"runInputLeakyRelu",value:function(t){this.outputs[0]=t;for(var e=null,i=1;i<=this.outputLayer;i++){for(var r=0;r<this.sizes[i];r++){for(var a=this.weights[i][r],s=this.biases[i][r],u=0;u<a.length;u++)s+=a[u]*t[u];this.outputs[i][r]=s<0?0:.01*s}e=t=this.outputs[i]}return e}},{key:"runInputTanh",value:function(t){this.outputs[0]=t;for(var e=null,i=1;i<=this.outputLayer;i++){for(var r=0;r<this.sizes[i];r++){for(var a=this.weights[i][r],s=this.biases[i][r],u=0;u<a.length;u++)s+=a[u]*t[u];this.outputs[i][r]=Math.tanh(s)}e=t=this.outputs[i]}return e}},{key:"_getSizesFromData",value:function(t){var e=[],i=t[0].input.length,r=t[0].output.length,a=this.hiddenSizes;return a?a.forEach(function(t){e.push(t)}):e.push(Math.max(3,Math.floor(i/2))),e.unshift(i),e.push(r),e}},{key:"_calculateTrainingError",value:function(t,e){for(var i=0,r=0;r<t.length;++r)i+=this.trainPattern(t[r].input,t[r].output,e);return i/t.length}},{key:"_checkTrainingTick",value:function(t,e,i){e.iterations++,e.error=this._calculateTrainingError(t,i.learningRate),i.log&&e.iterations%i.logPeriod==0&&console.log("iterations: "+e.iterations+", training error: "+e.error),i.callback&&e.iterations%i.callbackPeriod==0&&i.callback(Object.assign(e))}},{key:"train",value:function(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},i=Object.assign({},this.constructor.trainDefaults,e);t=this.formatData(t),i.learningRate=e.learningRate||this.learningRate||i.learningRate;var r=Date.now()+i.trainTimeMs,a={error:1,iterations:0};if(null===this.sizes){var s=this._getSizesFromData(t);this.initialize(s)}for(;a.iterations<i.iterations&&a.error>i.errorThresh&&Date.now()>r;)this._checkTrainingTick(t,a,i);return a}},{key:"trainAsync",value:function(t){var e=this,i=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:function(){};"function"==typeof i&&(r=i,i={});var a=Object.assign({},this.constructor.trainDefaults,i);t=this.formatData(t),a.learningRate=i.learningRate||this.learningRate||a.learningRate;var s=Date.now()+a.trainTimeMs,u={error:1,iterations:0};if(null===this.sizes){var n=this._getSizesFromData(t);this.initialize(n)}var o=new Array(a.iterations),h=new _thaw2.default(o,{delay:!0,each:function(){e._checkTrainingTick(t,u,a),(u.error<a.errorThresh||Date.now()<s)&&h.stop()},done:function(){r&&"function"==typeof r&&r(u)}});h.tick()}},{key:"trainPattern",value:function(t,e,i){return i=i||this.learningRate,this.runInput(t),this.calculateDeltas(e),this.adjustWeights(i),(0,_mse2.default)(this.errors[this.outputLayer])}},{key:"calculateDeltasSigmoid",value:function(t){for(var e=this.outputLayer;e>=0;e--)for(var i=0;i<this.sizes[e];i++){var r=this.outputs[e][i],a=0;if(e===this.outputLayer)a=t[i]-r;else for(var s=this.deltas[e+1],u=0;u<s.length;u++)a+=s[u]*this.weights[e+1][u][i];this.errors[e][i]=a,this.deltas[e][i]=a*r*(1-r)}}},{key:"calculateDeltasRelu",value:function(t){for(var e=this.outputLayer;e>=0;e--)for(var i=0;i<this.sizes[e];i++){var r=this.outputs[e][i],a=0;if(e===this.outputLayer)a=t[i]-r;else for(var s=this.deltas[e+1],u=0;u<s.length;u++)a+=s[u]*this.weights[e+1][u][i];this.errors[e][i]=a,this.deltas[e][i]=r>0?a:0}}},{key:"calculateDeltasLeakyRelu",value:function(t){for(var e=this.outputLayer;e>=0;e--)for(var i=0;i<this.sizes[e];i++){var r=this.outputs[e][i],a=0;if(e===this.outputLayer)a=t[i]-r;else for(var s=this.deltas[e+1],u=0;u<s.length;u++)a+=s[u]*this.weights[e+1][u][i];this.errors[e][i]=a,this.deltas[e][i]=r>0?a:.01*a}}},{key:"calculateDeltasTanh",value:function(t){for(var e=this.outputLayer;e>=0;e--)for(var i=0;i<this.sizes[e];i++){var r=this.outputs[e][i],a=0;if(e===this.outputLayer)a=t[i]-r;else for(var s=this.deltas[e+1],u=0;u<s.length;u++)a+=s[u]*this.weights[e+1][u][i];this.errors[e][i]=a,this.deltas[e][i]=(1-r*r)*a}}},{key:"adjustWeights",value:function(t){for(var e=1;e<=this.outputLayer;e++)for(var i=this.outputs[e-1],r=0;r<this.sizes[e];r++){for(var a=this.deltas[e][r],s=0;s<i.length;s++){var u=this.changes[e][r][s];u=t*a*i[s]+this.momentum*u,this.changes[e][r][s]=u,this.weights[e][r][s]+=u}this.biases[e][r]+=t*a}}},{key:"formatData",value:function(t){var e=this;if(!Array.isArray(t)){var i=[];i.push(t),t=i}var r=t[0].input;return Array.isArray(r)||r instanceof Float32Array||(this.inputLookup||(this.inputLookup=_lookup2.default.buildLookup(t.map(function(t){return t.input}))),t=t.map(function(t){var i=_lookup2.default.toArray(e.inputLookup,t.input);return Object.assign({},t,{input:i})},this)),Array.isArray(t[0].output)||(this.outputLookup||(this.outputLookup=_lookup2.default.buildLookup(t.map(function(t){return t.output}))),t=t.map(function(t){var i=_lookup2.default.toArray(e.outputLookup,t.output);return Object.assign({},t,{output:i})},this)),t}},{key:"test",value:function(t){var e=this;t=this.formatData(t);for(var i=1===t[0].output.length,r=0,a=0,s=0,u=0,n=[],o=0,h=0;h<t.length;h++)!function(h){var l=e.runInput(t[h].input),p=t[h].output,c=void 0,f=void 0;if(i?(c=l[0]>e.binaryThresh?1:0,f=p[0]):(c=l.indexOf((0,_max2.default)(l)),f=p.indexOf((0,_max2.default)(p))),c!==f){var v=t[h];Object.assign(v,{actual:c,expected:f}),n.push(v)}i&&(0===c&&0===f?u++:1===c&&1===f?s++:0===c&&1===f?a++:1===c&&0===f&&r++);var g=l.map(function(t,e){return p[e]-t});o+=(0,_mse2.default)(g)}(h);var l=o/t.length,p={error:l,misclasses:n};return i&&Object.assign(p,{trueNeg:u,truePos:s,falseNeg:a,falsePos:r,total:t.length,precision:s/(s+r),recall:s/(s+a),accuracy:(u+s)/t.length}),p}},{key:"toJSON",value:function(){for(var t=[],e=0;e<=this.outputLayer;e++){t[e]={};var i=void 0;i=0===e&&this.inputLookup?Object.keys(this.inputLookup):e===this.outputLayer&&this.outputLookup?Object.keys(this.outputLookup):(0,_range2.default)(0,this.sizes[e]);for(var r=0;r<i.length;r++){var a=i[r];if(t[e][a]={},e>0){t[e][a].bias=this.biases[e][r],t[e][a].weights={};for(var s in t[e-1]){var u=s;1===e&&this.inputLookup&&(u=this.inputLookup[s]),t[e][a].weights[s]=this.weights[e][r][u]}}}}return{sizes:this.sizes,layers:t,outputLookup:!!this.outputLookup,inputLookup:!!this.inputLookup,activation:this.activation}}},{key:"fromJSON",value:function(t){this.initialize(t.sizes);for(var e=0;e<=this.outputLayer;e++){var i=t.layers[e];if(0!==e||i[0]&&!t.inputLookup?e!==this.outputLayer||i[0]&&!t.outputLookup||(this.outputLookup=_lookup2.default.lookupFromHash(i)):this.inputLookup=_lookup2.default.lookupFromHash(i),i>0){var r=Object.keys(i);this.sizes[e]=r.length;for(var a in r){var s=r[a];this.biases[e]=i[s].bias,this.weights[e][a]=(0,_toArray2.default)(i[s].weights)}}}return this.setActivation(),this}},{key:"toFunction",value:function(){function t(i,r,a){if(0===r)return"string"==typeof a?"input['"+a+"']":"input["+a+"]";var s=i[r],u=s[a],n=[u.bias];for(var o in u.weights)u.weights[o]<0?n.push(u.weights[o]+"*("+t(i,r-1,o)+")"):n.push("+"+u.weights[o]+"*("+t(i,r-1,o)+")");switch(e){case"sigmoid":return"1/(1+1/Math.exp("+n.join("")+"))";case"relu":return"var sum = "+n.join("")+";(sum < 0 ? 0 : sum);";case"leaky-relu":return"var sum = "+n.join("")+";(sum < 0 ? 0 : 0.01 * sum);";case"tanh":return"Math.tanh("+n.join("")+");";default:throw new Error("unknown activation type "+e)}}var e=this.activation,i=this.toJSON().layers,r=[],a=void 0;for(var s in i[i.length-1])r.push(t(i,i.length-1,s));return a=this.outputLookup?"{"+Object.keys(this.outputLookup).map(function(t,e){return"'"+t+"':"+r[e]})+"}":"["+r.join(",")+"]",new Function("input","return "+a)}},{key:"createTrainStream",value:function(t){return t=t||{},t.neuralNetwork=this,this.setActivation(),this.trainStream=new _trainStream2.default(t),this.trainStream}}]),t}();exports.default=NeuralNetwork;
