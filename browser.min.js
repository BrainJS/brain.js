...
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}function _inherits(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}function weightedSumSigmoid(t,e,a,r){for(var u=e[a],i=0;i<this.constants.size;i++)u+=t[a][i]*r[i];return 1/(1+Math.exp(-u))}function weightedSumRelu(t,e,a,r){for(var u=e[a],i=0;i<this.constants.size;i++)u+=t[a][i]*r[i];return u<0?0:u}function weightedSumLeakyRelu(t,e,a,r){for(var u=e[a],i=0;i<this.constants.size;i++)u+=t[a][i]*r[i];return u<0?0:.01*u}function weightedSumTanh(t,e,a,r){for(var u=e[a],i=0;i<this.constants.size;i++)u+=t[a][i]*r[i];return Math.tanh(u)}function calcError(t,e){return e[this.thread.x]-t}function calcDeltasSigmoid(t,e){return t*e*(1-e)}function calcDeltasRelu(t,e){return e>0?t:0}function calcDeltasLeakyRelu(t,e){return e>0?t:.01*t}function calcDeltasTanh(t,e){return(1-e*e)*t}function calcErrorOutput(t,e){for(var a=0,r=0;r<this.constants.size;r++)a+=e[r]*t[r][this.thread.x];return a}function calcChanges(t,e,a,r,u,i,s){for(var o=0,n=0;n<this.constants.size;n++)o+=r*e*a[i]+u*t[s][n];return o}function addWeights(t,e,a,r){return t+e[r][a]}function addBiases(t,e,a,r){return t[r]+e[r]*a}function mse(t){for(var e=0,a=0;a<this.constants.size;a++)e+=Math.pow(t[a],2);return e/this.constants.size}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function t(t,e){for(var a=0;a<e.length;a++){var r=e[a];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(t,r.key,r)}}return function(e,a,r){return a&&t(e.prototype,a),r&&t(e,r),e}}(),_get=function t(e,a,r){null===e&&(e=Function.prototype);var u=Object.getOwnPropertyDescriptor(e,a);if(void 0===u){var i=Object.getPrototypeOf(e);return null===i?void 0:t(i,a,r)}if("value"in u)return u.value;var s=u.get;if(void 0!==s)return s.call(r)},_neuralNetwork=require("./neural-network"),_neuralNetwork2=_interopRequireDefault(_neuralNetwork),_lookup=require("./lookup"),_lookup2=_interopRequireDefault(_lookup),_gpu=require("gpu.js"),_gpu2=_interopRequireDefault(_gpu),NeuralNetworkGPU=function(t){function e(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};_classCallCheck(this,e);var a=_possibleConstructorReturn(this,(e.__proto__||Object.getPrototypeOf(e)).call(this,t));return a.forwardPropagate=[],a.backwardPropagate=[],a.changesPropagate=[],a.biasesPropagate=[],a.gpu=new _gpu2.default({mode:t.mode}),a}return _inherits(e,t),_createClass(e,[{key:"initialize",value:function(t,a){_get(e.prototype.__proto__||Object.getPrototypeOf(e.prototype),"initialize",this).call(this,t,a),this.buildRunInput(),this.buildCalculateDeltas(),this.buildGetChanges(),this.buildChangeBiases(),this.buildGetMSE()}},{key:"setActivation",value:function(){}},{key:"trainPattern",value:function(t,e,a){return a=a||this.learningRate,this.runInput(t),this.calculateDeltas(e),this.getChanges(a),this.changeBiases(a),this.getMSE(this.errors[this.outputLayer])[0]}},{key:"buildRunInput",value:function(){var t=null;switch(this.activation){case"sigmoid":t=weightedSumSigmoid;break;case"relu":t=weightedSumRelu;break;case"leaky-relu":t=weightedSumLeakyRelu;break;case"tanh":t=weightedSumTanh;break;default:throw new Error("unknown activation "+this.activation)}for(var e=1;e<=this.outputLayer;e++){var a=this.gpu.createKernelMap({weightedSum:_gpu2.default.alias("weightedSum",t)},function(e,a,r){return t(e,a,this.thread.x,r)},{constants:{size:this.sizes[e-1]}}).setOutput([this.sizes[e]]).setOutputToTexture(!0);this.forwardPropagate[e]=a}}},{key:"runInput",value:function(t){var e=void 0;this.outputs[0]=t;for(var a=1;a<=this.outputLayer;a++)this.outputs[a]=this.forwardPropagate[a](this.weights[a],this.biases[a],t).result,e=t=this.outputs[a];return e}},{key:"buildCalculateDeltas",value:function(){var t=null;switch(this.activation){case"sigmoid":t=calcDeltasSigmoid;break;case"relu":t=calcDeltasRelu;break;case"leaky-relu":t=calcDeltasLeakyRelu;break;case"tanh":t=calcDeltasTanh;break;default:throw new Error("unknown activation "+this.activation)}for(var e=this.outputLayer;e>0;e--)if(e===this.outputLayer){var a=this.gpu.createKernelMap({error:_gpu2.default.alias("calcError",calcError),deltas:_gpu2.default.alias("calcDeltas",t)},function(e,a){var r=e[this.thread.x];return t(calcError(r,a),r)}).setOutput([this.sizes[e]]).setOutputToTexture(!0);this.backwardPropagate[e]=a}else{var r=this.gpu.createKernelMap({error:_gpu2.default.alias("calcErrorOutput",calcErrorOutput),deltas:_gpu2.default.alias("calcDeltas",t)},function(e,a,r){var u=a[this.thread.x];return t(calcErrorOutput(e,r),u)},{constants:{size:this.deltas[e+1].length}}).setOutput([this.sizes[e]]).setOutputToTexture(!0);this.backwardPropagate[e]=r}}},{key:"calculateDeltas",value:function(t,e){for(var a=this.outputLayer;a>0;a--){var r=void 0;r=a===this.outputLayer?this.backwardPropagate[a](this.outputs[a],t):this.backwardPropagate[a](this.weights[a+1],this.outputs[a],this.deltas[a+1]),this.deltas[a]=r.result,this.errors[a]=r.error}}},{key:"buildGetChanges",value:function(){for(var t=1;t<=this.outputLayer;t++){var e=this.gpu.createKernelMap({addWeights:addWeights,calcChanges:calcChanges},function(t,e,a,r,u,i){return addWeights(calcChanges(r,e[this.thread.y],t,u,i,this.thread.x,this.thread.y),a,this.thread.x,this.thread.y)},{constants:{size:this.outputs[t-1].length}}).setOutput([this.sizes[t-1],this.sizes[t]]).setOutputToTexture(!0);this.changesPropagate[t]=e}}},{key:"getChanges",value:function(t){for(var e=1;e<=this.outputLayer;e++){var a=this.changesPropagate[e](this.outputs[e-1],this.deltas[e],this.weights[e],this.changes[e],t,this.momentum);this.changes[e]=a.calcChanges,this.weights[e]=a.result}}},{key:"buildChangeBiases",value:function(){for(var t=1;t<=this.outputLayer;t++){var e=this.gpu.createKernelMap({addBiases:addBiases},function(t,e,a){return addBiases(t,e,a,this.thread.x)}).setOutput([this.sizes[t]]).setOutputToTexture(!0);this.biasesPropagate[t]=e}}},{key:"changeBiases",value:function(t){for(var e=1;e<=this.outputLayer;e++){var a=this.biasesPropagate[e](this.biases[e],this.deltas[e],t);this.biases[e]=a.result}}},{key:"buildGetMSE",value:function(){var t=this.gpu.createKernel(mse,{output:[1],constants:{size:this.outputLayer}});this.getMSE=t}},{key:"run",value:function(t){this.inputLookup&&(t=_lookup2.default.toArray(this.inputLookup,t));var e=this.runInput(t);return this.outputLookup&&(e=_lookup2.default.toHash(this.outputLookup,e)),e}},{key:"formatData",value:function(t){var e=this;if(!Array.isArray(t)){var a=[];a.push(t),t=a}var r=t[0].input;return Array.isArray(r)||r instanceof Float32Array||(this.inputLookup||(this.inputLookup=_lookup2.default.buildLookup(t.map(function(t){return t.input}))),t=t.map(function(t){var a=_lookup2.default.toArray(e.inputLookup,t.input);return Object.assign({},t,{input:a})},this)),Array.isArray(t[0].output)||(this.outputLookup||(this.outputLookup=_lookup2.default.buildLookup(t.map(function(t){return t.output}))),t=t.map(function(t){var a=_lookup2.default.toArray(e.outputLookup,t.output);return Object.assign({},t,{output:a})},this)),t}},{key:"toFunction",value:function(){throw new Error("not implemented on NeuralNetworkGPU")}}]),e}(_neuralNetwork2.default);exports.default=NeuralNetworkGPU;

},{"./lookup":3,"./neural-network":5,"gpu.js":75}],5:[function(require,module,exports){
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function t(t,e){for(var i=0;i<e.length;i++){var s=e[i];s.enumerable=s.enumerable||!1,s.configurable=!0,"value"in s&&(s.writable=!0),Object.defineProperty(t,s.key,s)}}return function(e,i,s){return i&&t(e.prototype,i),s&&t(e,s),e}}(),_lookup=require("./lookup"),_lookup2=_interopRequireDefault(_lookup),_trainStream=require("./train-stream"),_trainStream2=_interopRequireDefault(_trainStream),_max=require("./utilities/max"),_max2=_interopRequireDefault(_max),_mse=require("./utilities/mse"),_mse2=_interopRequireDefault(_mse),_randos=require("./utilities/randos"),_randos2=_interopRequireDefault(_randos),_range=require("./utilities/range"),_range2=_interopRequireDefault(_range),_toArray=require("./utilities/to-array"),_toArray2=_interopRequireDefault(_toArray),_zeros=require("./utilities/zeros"),_zeros2=_interopRequireDefault(_zeros),NeuralNetwork=function(){function t(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};_classCallCheck(this,t),Object.assign(this,this.constructor.defaults,e),this.hiddenSizes=e.hiddenLayers,this.sizes=null,this.outputLayer=null,this.biases=null,this.weights=null,this.outputs=null,this.deltas=null,this.changes=null,this.errors=null,this.constructor.prototype.hasOwnProperty("runInput")||(this.runInput=null),this.constructor.prototype.hasOwnProperty("calculateDeltas")||(this.calculateDeltas=null)}return _createClass(t,null,[{key:"trainDefaults",get:function(){return{iterations:2e4,errorThresh:.005,log:!1,logPeriod:10,learningRate:.3,callback:null,callbackPeriod:10,reinforce:!1}}},{key:"defaults",get:function(){return{learningRate:.3,momentum:.1,binaryThresh:.5,hiddenLayers:null,activation:"sigmoid"}}}]),_createClass(t,[{key:"initialize",value:function(t){this.sizes=t,this.outputLayer=this.sizes.length-1,this.biases=[],this.weights=[],this.outputs=[],this.deltas=[],this.changes=[],this.errors=[];for(var e=0;e<=this.outputLayer;e++){var i=this.sizes[e];if(this.deltas[e]=(0,_zeros2.default)(i),this.errors[e]=(0,_zeros2.default)(i),this.outputs[e]=(0,_zeros2.default)(i),e>0){this.biases[e]=(0,_randos2.default)(i),this.weights[e]=new Array(i),this.changes[e]=new Array(i);for(var s=0;s<i;s++){var r=this.sizes[e-1];this.weights[e][s]=(0,_randos2.default)(r),this.changes[e][s]=(0,_zeros2.default)(r)}}}this.setActivation()}},{key:"setActivation",value:function(){switch(this.activation){case"sigmoid":this.runInput=this.runInput||this.runInputSigmoid,this.calculateDeltas=this.calculateDeltas||this.calculateDeltasSigmoid;break;case"relu":this.runInput=this.runInput||this.runInputRelu,this.calculateDeltas=this.calculateDeltas||this.calculateDeltasRelu;break;case"leaky-relu":this.runInput=this.runInput||this.runInputLeakyRelu,this.calculateDeltas=this.calculateDeltas||this.calculateDeltasLeakyRelu;break;case"tanh":this.runInput=this.runInput||this.runInputTanh,this.calculateDeltas=this.calculateDeltas||this.calculateDeltasTanh;break;default:throw new Error("unknown activation "+this.activation)}}},{key:"run",value:function(t){this.inputLookup&&(t=_lookup2.default.toArray(this.inputLookup,t));var e=this.runInput(t);return this.outputLookup&&(e=_lookup2.default.toHash(this.outputLookup,e)),e}},{key:"runInputSigmoid",value:function(t){this.outputs[0]=t;for(var e=null,i=1;i<=this.outputLayer;i++){for(var s=0;s<this.sizes[i];s++){for(var r=this.weights[i][s],u=this.biases[i][s],a=0;a<r.length;a++)u+=r[a]*t[a];this.outputs[i][s]=1/(1+Math.exp(-u))}e=t=this.outputs[i]}return e}},{key:"runInputRelu",value:function(t){this.outputs[0]=t;for(var e=null,i=1;i<=this.outputLayer;i++){for(var s=0;s<this.sizes[i];s++){for(var r=this.weights[i][s],u=this.biases[i][s],a=0;a<r.length;a++)u+=r[a]*t[a];this.outputs[i][s]=u<0?0:u}e=t=this.outputs[i]}return e}},{key:"runInputLeakyRelu",value:function(t){this.outputs[0]=t;for(var e=null,i=1;i<=this.outputLayer;i++){for(var s=0;s<this.sizes[i];s++){for(var r=this.weights[i][s],u=this.biases[i][s],a=0;a<r.length;a++)u+=r[a]*t[a];this.outputs[i][s]=u<0?0:.01*u}e=t=this.outputs[i]}return e}},{key:"runInputTanh",value:function(t){this.outputs[0]=t;for(var e=null,i=1;i<=this.outputLayer;i++){for(var s=0;s<this.sizes[i];s++){for(var r=this.weights[i][s],u=this.biases[i][s],a=0;a<r.length;a++)u+=r[a]*t[a];this.outputs[i][s]=Math.tanh(u)}e=t=this.outputs[i]}return e}},{key:"train",value:function(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},i=Object.assign({},this.constructor.trainDefaults,e);t=this.formatData(t);var s=i.iterations,r=i.errorThresh,u=!0===i.log?console.log:i.log,a=i.logPeriod,o=e.learningRate||this.learningRate||i.learningRate,n=i.callback,h=i.callbackPeriod;if(!i.reinforce){var l=[],p=t[0].input.length,c=t[0].output.length,f=this.hiddenSizes;f?f.forEach(function(t){l.push(t)}):l.push(Math.max(3,Math.floor(p/2))),l.unshift(p),l.push(c),this.initialize(l)}var v=1,g=void 0;for(g=0;g<s&&v>r;g++){for(var y=0,k=0;k<t.length;k++){y+=this.trainPattern(t[k].input,t[k].output,o)}v=y/t.length,u&&g%a==0&&u("iterations:",g,"training error:",v),n&&g%h==0&&n({error:v,iterations:g})}return{error:v,iterations:g}}},{key:"trainPattern",value:function(t,e,i){return i=i||this.learningRate,this.runInput(t),this.calculateDeltas(e),this.adjustWeights(i),(0,_mse2.default)(this.errors[this.outputLayer])}},{key:"calculateDeltasSigmoid",value:function(t){for(var e=this.outputLayer;e>=0;e--)for(var i=0;i<this.sizes[e];i++){var s=this.outputs[e][i],r=0;if(e===this.outputLayer)r=t[i]-s;else for(var u=this.deltas[e+1],a=0;a<u.length;a++)r+=u[a]*this.weights[e+1][a][i];this.errors[e][i]=r,this.deltas[e][i]=r*s*(1-s)}}},{key:"calculateDeltasRelu",value:function(t){for(var e=this.outputLayer;e>=0;e--)for(var i=0;i<this.sizes[e];i++){var s=this.outputs[e][i],r=0;if(e===this.outputLayer)r=t[i]-s;else for(var u=this.deltas[e+1],a=0;a<u.length;a++)r+=u[a]*this.weights[e+1][a][i];this.errors[e][i]=r,this.deltas[e][i]=s>0?r:0}}},{key:"calculateDeltasLeakyRelu",value:function(t){for(var e=this.outputLayer;e>=0;e--)for(var i=0;i<this.sizes[e];i++){var s=this.outputs[e][i],r=0;if(e===this.outputLayer)r=t[i]-s;else for(var u=this.deltas[e+1],a=0;a<u.length;a++)r+=u[a]*this.weights[e+1][a][i];this.errors[e][i]=r,this.deltas[e][i]=s>0?r:.01*r}}},{key:"calculateDeltasTanh",value:function(t){for(var e=this.outputLayer;e>=0;e--)for(var i=0;i<this.sizes[e];i++){var s=this.outputs[e][i],r=0;if(e===this.outputLayer)r=t[i]-s;else for(var u=this.deltas[e+1],a=0;a<u.length;a++)r+=u[a]*this.weights[e+1][a][i];this.errors[e][i]=r,this.deltas[e][i]=(1-s*s)*r}}},{key:"adjustWeights",value:function(t){for(var e=1;e<=this.outputLayer;e++)for(var i=this.outputs[e-1],s=0;s<this.sizes[e];s++){for(var r=this.deltas[e][s],u=0;u<i.length;u++){var a=this.changes[e][s][u];a=t*r*i[u]+this.momentum*a,this.changes[e][s][u]=a,this.weights[e][s][u]+=a}this.biases[e][s]+=t*r}}},{key:"formatData",value:function(t){var e=this;if(!Array.isArray(t)){var i=[];i.push(t),t=i}var s=t[0].input;return Array.isArray(s)||s instanceof Float32Array||(this.inputLookup||(this.inputLookup=_lookup2.default.buildLookup(t.map(function(t){return t.input}))),t=t.map(function(t){var i=_lookup2.default.toArray(e.inputLookup,t.input);return Object.assign({},t,{input:i})},this)),Array.isArray(t[0].output)||(this.outputLookup||(this.outputLookup=_lookup2.default.buildLookup(t.map(function(t){return t.output}))),t=t.map(function(t){var i=_lookup2.default.toArray(e.outputLookup,t.output);return Object.assign({},t,{output:i})},this)),t}},{key:"test",value:function(t){var e=this;t=this.formatData(t);for(var i=1===t[0].output.length,s=0,r=0,u=0,a=0,o=[],n=0,h=0;h<t.length;h++)!function(h){var l=e.runInput(t[h].input),p=t[h].output,c=void 0,f=void 0;if(i?(c=l[0]>e.binaryThresh?1:0,f=p[0]):(c=l.indexOf((0,_max2.default)(l)),f=p.indexOf((0,_max2.default)(p))),c!==f){var v=t[h];Object.assign(v,{actual:c,expected:f}),o.push(v)}i&&(0===c&&0===f?a++:1===c&&1===f?u++:0===c&&1===f?r++:1===c&&0===f&&s++);var g=l.map(function(t,e){return p[e]-t});n+=(0,_mse2.default)(g)}(h);var l=n/t.length,p={error:l,misclasses:o};return i&&Object.assign(p,{trueNeg:a,truePos:u,falseNeg:r,falsePos:s,total:t.length,precision:u/(u+s),recall:u/(u+r),accuracy:(a+u)/t.length}),p}},{key:"toJSON",value:function(){for(var t=[],e=0;e<=this.outputLayer;e++){t[e]={};var i=void 0;i=0===e&&this.inputLookup?Object.keys(this.inputLookup):e===this.outputLayer&&this.outputLookup?Object.keys(this.outputLookup):(0,_range2.default)(0,this.sizes[e]);for(var s=0;s<i.length;s++){var r=i[s];if(t[e][r]={},e>0){t[e][r].bias=this.biases[e][s],t[e][r].weights={};for(var u in t[e-1]){var a=u;1===e&&this.inputLookup&&(a=this.inputLookup[u]),t[e][r].weights[u]=this.weights[e][s][a]}}}}return{layers:t,outputLookup:!!this.outputLookup,inputLookup:!!this.inputLookup,activation:this.activation}}},{key:"fromJSON",value:function(t){var e=t.layers.length;this.outputLayer=e-1,this.sizes=new Array(e),this.weights=new Array(e),this.biases=new Array(e),this.outputs=new Array(e);for(var i=0;i<=this.outputLayer;i++){var s=t.layers[i];0!==i||s[0]&&!t.inputLookup?i!==this.outputLayer||s[0]&&!t.outputLookup||(this.outputLookup=_lookup2.default.lookupFromHash(s)):this.inputLookup=_lookup2.default.lookupFromHash(s);var r=Object.keys(s);this.sizes[i]=r.length,this.weights[i]=[],this.biases[i]=[],this.outputs[i]=[];for(var u in r){var a=r[u];this.biases[i][u]=s[a].bias,this.weights[i][u]=(0,_toArray2.default)(s[a].weights)}}return this.setActivation(),this}},{key:"toFunction",value:function(){function t(i,s,r){if(0===s)return"string"==typeof r?"input['"+r+"']":"input["+r+"]";var u=i[s],a=u[r],o=[a.bias];for(var n in a.weights)a.weights[n]<0?o.push(a.weights[n]+"*("+t(i,s-1,n)+")"):o.push("+"+a.weights[n]+"*("+t(i,s-1,n)+")");switch(e){case"sigmoid":return"1/(1+1/Math.exp("+o.join("")+"))";case"relu":return"var sum = "+o.join("")+";(sum < 0 ? 0 : sum);";case"leaky-relu":return"var sum = "+o.join("")+";(sum < 0 ? 0 : 0.01 * sum);";case"tanh":return"Math.tanh("+o.join("")+");";default:throw new Error("unknown activation type "+e)}}var e=this.activation,i=this.toJSON().layers,s=[],r=void 0;for(var u in i[i.length-1])s.push(t(i,i.length-1,u));return r=this.outputLookup?"{"+Object.keys(this.outputLookup).map(function(t,e){return"'"+t+"':"+s[e]})+"}":"["+s.join(",")+"]",new Function("input","return "+r)}},{key:"createTrainStream",value:function(t){return t=t||{},t.neuralNetwork=this,this.setActivation(),this.trainStream=new _trainStream2.default(t),this.trainStream}}]),t}();exports.default=NeuralNetwork;
...
"use strict";function zeros(e){if("undefined"!=typeof Float32Array)return new Float32Array(e);for(var r=new Array(e),t=0;t<e;t++)r[t]=0;return r}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=zeros;
