...
"use strict";var isPlainObject=require("is-plain-object");module.exports=function(i){return isPlainObject(i)||"function"==typeof i||Array.isArray(i)};
...
"use strict";function copy(e,r){isObject(r)&&forIn(r,function(r,t){e[t]=r})}var isObject=require("is-extendable"),forIn=require("for-in");module.exports=function(e,r){if(!isObject(e))throw new TypeError("expected the first argument to be an object");for(var t=arguments.length,n=0;++n<t;)copy(e,arguments[n]);return e};
...
"use strict";function clone(e){var n=typeOf(e);return clone.hasOwnProperty(n)?clone[n](e):e}var isObject=require("is-extendable"),mixin=require("mixin-object"),typeOf=require("kind-of");clone.array=function(e){return e.slice()},clone.date=function(e){return new Date(+e)},clone.object=function(e){return isObject(e)?mixin({},e):e},clone.map=function(e){return new Map(e)},clone.regexp=function(e){var n="";return n+=e.multiline?"m":"",n+=e.global?"g":"",n+=e.ignoreCase?"i":"",new RegExp(e.source,n)},clone.set=function(e){return new Set(e)},module.exports=clone;
