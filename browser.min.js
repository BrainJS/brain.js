...
"use strict";function addB(e,r,c){for(var t=0,u=r.weights.length;t<u;t++)r.recurrence[t]+=e.recurrence[t],c.recurrence[t]+=e.recurrence[t]}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=addB;

},{}],5:[function(require,module,exports){
"use strict";function add(e,r,t){for(var c=0,s=r.weights.length;c<s;c++)e.weights[c]=r.weights[c]+t.weights[c],e.recurrence[c]=0,r.recurrence[c]=0,t.recurrence[c]=0}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=add;

},{}],6:[function(require,module,exports){
"use strict";function allOnes(e){for(var t=0,r=e.weights.length;t<r;t++)e.weights[t]=1,e.recurrence[t]=0}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=allOnes;

},{}],7:[function(require,module,exports){
"use strict";function cloneNegative(e,r){e.rows=parseInt(r.rows),e.columns=parseInt(r.columns),e.weights=r.weights.slice(0),e.recurrence=r.recurrence.slice(0);for(var s=0,t=r.weights.length;s<t;s++)e.weights[s]=-r.weights[s],e.recurrence[s]=0}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=cloneNegative;

},{}],8:[function(require,module,exports){
"use strict";function copy(e,r){e.rows=parseInt(r.rows),e.columns=parseInt(r.columns),e.weights=r.weights.slice(0),e.recurrence=r.recurrence.slice(0)}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=copy;

},{}],9:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var s=t[r];s.enumerable=s.enumerable||!1,s.configurable=!0,"value"in s&&(s.writable=!0),Object.defineProperty(e,s.key,s)}}return function(t,r,s){return r&&e(t.prototype,r),s&&e(t,s),t}}(),_zeros=require("../utilities/zeros"),_zeros2=_interopRequireDefault(_zeros),Matrix=function(){function e(t,r){_classCallCheck(this,e),"undefined"!=typeof t&&"undefined"!=typeof r&&(this.rows=t,this.columns=r,this.weights=(0,_zeros2.default)(t*r),this.recurrence=(0,_zeros2.default)(t*r))}return _createClass(e,[{key:"getWeights",value:function(e,t){var r=this.columns*e+t;if(r<0&&r>=this.weights.length)throw new Error("get accessor is skewed");return this.weights[r]}},{key:"setWeights",value:function(e,t,r){var s=this.columns*e+t;if(s<0&&s>=this.weights.length)throw new Error("set accessor is skewed");return this.weights[s]=r,this}},{key:"toJSON",value:function(){return{rows:this.rows,columns:this.columns,weights:this.weights.slice(0)}}}],[{key:"fromJSON",value:function(t){for(var r=new e(t.rows,t.columns),s=0,i=t.rows*t.columns;s<i;s++)r.weights[s]=t.weights[s];return r}}]),e}();exports.default=Matrix;

},{"../utilities/zeros":42}],10:[function(require,module,exports){
"use strict";function maxI(e){for(var t=e.weights,r=t[0],a=0,o=1,s=t.length;o<s;o++){var u=t[o];u<r||(a=o,r=u)}return a}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=maxI;

},{}],11:[function(require,module,exports){
"use strict";function multiplyB(e,r,t){for(var u=r.rows,c=r.columns,o=t.columns,s=0;s<u;s++)for(var l=0;l<o;l++)for(var n=0;n<c;n++){var i=e.recurrence[o*s+l];r.recurrence[c*s+n]+=t.weights[o*n+l]*i,t.recurrence[o*n+l]+=r.weights[c*s+n]*i}}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=multiplyB;

},{}],12:[function(require,module,exports){
"use strict";function multiplyElementB(e,r,t){for(var c=0,u=r.weights.length;c<u;c++)r.recurrence[c]+=t.weights[c]*e.recurrence[c],t.recurrence[c]+=r.weights[c]*e.recurrence[c]}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=multiplyElementB;

},{}],13:[function(require,module,exports){
"use strict";function multiplyElement(e,t,r){for(var l=0,u=t.weights.length;l<u;l++)e.weights[l]=t.weights[l]*r.weights[l],e.recurrence[l]=0,t.recurrence[l]=0,r.recurrence[l]=0}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=multiplyElement;

},{}],14:[function(require,module,exports){
"use strict";function multiply(e,r,t){for(var u=r.rows,c=r.columns,o=t.columns,s=0;s<u;s++)for(var l=0;l<o;l++){for(var i=0,n=0;n<c;n++)i+=r.weights[c*s+n]*t.weights[o*n+l];var a=o*s+l;e.weights[a]=i,e.recurrence[a]=0,r.recurrence[a]=0,t.recurrence[a]=0}}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=multiply;

},{}],15:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}Object.defineProperty(exports,"__esModule",{value:!0});var _ones=require("../utilities/ones"),_ones2=_interopRequireDefault(_ones),_=require("./"),_2=_interopRequireDefault(_),OnesMatrix=function(e){function t(e,r){_classCallCheck(this,t);var o=_possibleConstructorReturn(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,e,r));return o.rows=e,o.columns=r,o.weights=(0,_ones2.default)(e*r),o.recurrence=(0,_ones2.default)(e*r),o}return _inherits(t,e),t}(_2.default);exports.default=OnesMatrix;
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var n=t[r];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,r,n){return r&&e(t.prototype,r),n&&e(t,n),t}}(),_matrix=require("../matrix"),_matrix2=_interopRequireDefault(_matrix),_rnn=require("./rnn"),_rnn2=_interopRequireDefault(_rnn),_randomMatrix=require("../matrix/random-matrix"),_randomMatrix2=_interopRequireDefault(_randomMatrix),GRU=function(e){function t(){return _classCallCheck(this,t),_possibleConstructorReturn(this,(t.__proto__||Object.getPrototypeOf(t)).apply(this,arguments))}return _inherits(t,e),_createClass(t,[{key:"getModel",value:function(e,t){return{updateGateInputMatrix:new _randomMatrix2.default(e,t,.08),updateGateHiddenMatrix:new _randomMatrix2.default(e,e,.08),updateGateBias:new _matrix2.default(e,1),resetGateInputMatrix:new _randomMatrix2.default(e,t,.08),resetGateHiddenMatrix:new _randomMatrix2.default(e,e,.08),resetGateBias:new _matrix2.default(e,1),cellWriteInputMatrix:new _randomMatrix2.default(e,t,.08),cellWriteHiddenMatrix:new _randomMatrix2.default(e,e,.08),cellWriteBias:new _matrix2.default(e,1)}}},{key:"getEquation",value:function(e,t,r,n){var a=e.sigmoid.bind(e),i=e.add.bind(e),u=e.multiply.bind(e),o=e.multiplyElement.bind(e),l=e.previousResult.bind(e),d=e.tanh.bind(e),s=e.allOnes.bind(e),c=e.cloneNegative.bind(e),f=a(i(i(u(n.updateGateInputMatrix,t),u(n.updateGateHiddenMatrix,l(r))),n.updateGateBias)),p=a(i(i(u(n.resetGateInputMatrix,t),u(n.resetGateHiddenMatrix,l(r))),n.resetGateBias)),_=d(i(i(u(n.cellWriteInputMatrix,t),u(n.cellWriteHiddenMatrix,o(p,l(r)))),n.cellWriteBias));return i(o(i(s(f.rows,f.columns),c(f)),_),o(l(r),f))}}]),t}(_rnn2.default);exports.default=GRU;

},{"../matrix":9,"../matrix/random-matrix":16,"./rnn":30}],29:[function(require,module,exports){
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}function _inherits(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function t(t,e){for(var r=0;r<e.length;r++){var n=e[r];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(t,n.key,n)}}return function(e,r,n){return r&&t(e.prototype,r),n&&t(e,n),e}}(),_matrix=require("../matrix"),_matrix2=_interopRequireDefault(_matrix),_rnn=require("./rnn"),_rnn2=_interopRequireDefault(_rnn),_randomMatrix=require("../matrix/random-matrix"),_randomMatrix2=_interopRequireDefault(_randomMatrix),LSTM=function(t){function e(){return _classCallCheck(this,e),_possibleConstructorReturn(this,(e.__proto__||Object.getPrototypeOf(e)).apply(this,arguments))}return _inherits(e,t),_createClass(e,[{key:"getModel",value:function(t,e){return{inputMatrix:new _randomMatrix2.default(t,e,.08),inputHidden:new _randomMatrix2.default(t,t,.08),inputBias:new _matrix2.default(t,1),forgetMatrix:new _randomMatrix2.default(t,e,.08),forgetHidden:new _randomMatrix2.default(t,t,.08),forgetBias:new _matrix2.default(t,1),outputMatrix:new _randomMatrix2.default(t,e,.08),outputHidden:new _randomMatrix2.default(t,t,.08),outputBias:new _matrix2.default(t,1),cellActivationMatrix:new _randomMatrix2.default(t,e,.08),cellActivationHidden:new _randomMatrix2.default(t,t,.08),cellActivationBias:new _matrix2.default(t,1)}}},{key:"getEquation",value:function(t,e,r,n){var i=t.sigmoid.bind(t),a=t.add.bind(t),o=t.multiply.bind(t),u=t.multiplyElement.bind(t),l=t.previousResult.bind(t),d=t.tanh.bind(t),f=t.result.bind(t),c=f(i(a(a(o(n.inputMatrix,e),o(n.inputHidden,l(r))),n.inputBias))),s=f(i(a(a(o(n.forgetMatrix,e),o(n.forgetHidden,l(r))),n.forgetBias))),p=f(i(a(a(o(n.outputMatrix,e),o(n.outputHidden,l(r))),n.outputBias))),_=f(d(a(a(o(n.cellActivationMatrix,e),o(n.cellActivationHidden,l(r))),n.cellActivationBias))),x=u(s,l(r)),m=u(c,_),b=a(x,m);return f(u(p,d(b)))}}]),e}(_rnn2.default);exports.default=LSTM;

},{"../matrix":9,"../matrix/random-matrix":16,"./rnn":30}],30:[function(require,module,exports){
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function t(t,e){for(var n=0;n<e.length;n++){var r=e[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(t,r.key,r)}}return function(e,n,r){return n&&t(e.prototype,n),r&&t(e,r),e}}(),_sampleI2=require("../matrix/sample-i"),_sampleI3=_interopRequireDefault(_sampleI2),_maxI=require("../matrix/max-i"),_maxI2=_interopRequireDefault(_maxI),_matrix=require("../matrix"),_matrix2=_interopRequireDefault(_matrix),_randomMatrix=require("../matrix/random-matrix"),_randomMatrix2=_interopRequireDefault(_randomMatrix),_softmax=require("../matrix/softmax"),_softmax2=_interopRequireDefault(_softmax),_equation=require("../utilities/equation"),_equation2=_interopRequireDefault(_equation),defaults={isBackPropagate:!0,inputSize:20,inputRange:20,hiddenSizes:[20,20],outputSize:20,learningRate:.01,decayRate:.999,smoothEps:1e-8,regc:1e-6,clipval:5,json:null},RNN=function(){function t(e){_classCallCheck(this,t),e=e||{};for(var n in defaults)defaults.hasOwnProperty(n)&&"isBackPropagate"!==n&&(this[n]=e.hasOwnProperty(n)?e[n]:defaults[n]);this.stepCache={},this.runs=0,this.logProbabilities=null,this.totalPerplexity=null,this.totalCost=null,this.model={input:[],inputRows:[],equations:[],hidden:[],output:null,allMatrices:[],hiddenLayers:[]},this.json?this.fromJSON(this.json):(this.createModel(),this.mapModel())}return _createClass(t,[{key:"createModel",value:function(){var t=this.hiddenSizes,e=this.model,n=e.hiddenLayers;n.push(this.getModel(t[0],this.inputSize));for(var r=t[0],i=1;i<t.length;i++){var a=t[i];n.push(this.getModel(a,r)),r=a}}},{key:"getModel",value:function(t,e){return{weight:new _randomMatrix2.default(t,e,.08),transition:new _randomMatrix2.default(t,t,.08),bias:new _matrix2.default(t,1)}}},{key:"getEquation",value:function(t,e,n,r){var i=t.relu.bind(t),a=t.add.bind(t),o=t.multiply.bind(t),u=t.previousResult.bind(t),s=t.result.bind(t);return s(i(a(a(o(r.weight,e),o(r.transition,u(n))),r.bias)))}},{key:"createInputMatrix",value:function(){this.model.input=new _randomMatrix2.default(this.inputRange+1,this.inputSize,.08)}},{key:"createOutputMatrix",value:function(){var t=this.model,e=this.outputSize,n=this.hiddenSizes[this.hiddenSizes.length-1];t.outputConnector=new _randomMatrix2.default(e+1,n,.08),t.output=new _matrix2.default(e+1,1)}},{key:"bindEquations",value:function(){var t=this.model,e=this.hiddenSizes,n=t.hiddenLayers,r=new _equation2.default;t.equations.push(r);for(var i=this.getEquation(r,r.inputMatrixToRow(t.input),e[0],n[0]),a=1,o=e.length;a<o;a++)i=this.getEquation(r,i,e[a],n[a]);r.add(r.multiply(t.outputConnector,i),t.output)}},{key:"mapModel",value:function(){var t=this.model,e=t.hiddenLayers,n=t.allMatrices;if(this.createInputMatrix(),!t.input)throw new Error("net.model.input not set");if(this.createOutputMatrix(),!t.outputConnector)throw new Error("net.model.outputConnector not set");if(!t.output)throw new Error("net.model.output not set");if(this.bindEquations(),!t.equations.length>0)throw new Error("net.equations not set");n.push(t.input);for(var r=0,i=e.length;r<i;r++){var a=e[r];for(var o in a)a.hasOwnProperty(o)&&n.push(a[o])}n.push(t.outputConnector),n.push(t.output)}},{key:"run",value:function(t){this.runs++,t=t||this.model.input;for(var e=this.model.equations,n=t.length,r=0,i=0,a=0,o=e.length;a<o;a++)e[a].resetPreviousResults();for(;e.length<=n;)this.bindEquations();var u=void 0,s=void 0;for(u=-1;u<n;u++){var l=e[u+1],h=u===-1?0:t[u],p=u===n-1?0:t[u+1];s=l.run(h),l.updatePreviousResults(),this.logProbabilities=s;var d=(0,_softmax2.default)(s);r+=-Math.log2(d.weights[p]),i+=-Math.log(d.weights[p]),this.logProbabilities.recurrence=d.weights.slice(0),this.logProbabilities.recurrence[p]-=1}for(;u-- >0;)e[u].runBackpropagate();return this.step(),this.totalPerplexity=Math.pow(2,r/(n-1)),this.totalCost=i,s}},{key:"step",value:function(){for(var t=this.learningRate,e=this.regc,n=this.clipval,r=this.model,i=0,a=0,o=r.allMatrices,u=o.length,s=0;s<u;s++){var l=o[s];s in this.stepCache||(this.stepCache[s]=new _matrix2.default(l.rows,l.columns));for(var h=this.stepCache[s],p=0,d=l.weights.length;p<d;p++){var f=l.recurrence[p];h.weights[p]=h.weights[p]*this.decayRate+(1-this.decayRate)*f*f,f>n&&(f=n,i++),f<-n&&(f=-n,i++),a++,l.weights[p]+=-t*f/Math.sqrt(h.weights[p]+this.smoothEps)-e*l.weights[p],l.recurrence[p]=0}}this.ratioClipped=i/a}},{key:"predict",value:function(t,e,n){"undefined"==typeof t&&(t=!0),"undefined"==typeof e&&(e=1),"undefined"==typeof n&&(n=100);for(var r=[],i=void 0,a=this.model.equations[0];;){i=0===r.length?0:r[r.length-1];var o=a.run(i);if(this.logProbabilities=o,1!==e&&t)for(var u=0,s=this.logProbabilities.weights.length;u<s;u++)this.logProbabilities.weights[u]/=e;var l=(0,_softmax2.default)(this.logProbabilities);if(i=t?(0,_sampleI3.default)(l):(0,_maxI2.default)(l),0===i)break;if(r.length>n)break;r.push(i)}return r}},{key:"runInput",value:function(t){this.outputs[0]=t;for(var e=null,n=1;n<=this.outputLayer;n++){for(var r=0;r<this.sizes[n];r++){for(var i=this.weights[n][r],a=this.biases[n][r],o=0;o<i.length;o++)a+=i[o]*t[o];this.outputs[n][r]=1/(1+Math.exp(-a))}e=t=this.outputs[n]}return e}},{key:"train",value:function(t,e){throw new Error("not yet implemented")}},{key:"trainPattern",value:function(t,e,n){throw new Error("not yet implemented")}},{key:"calculateDeltas",value:function(t){throw new Error("not yet implemented")}},{key:"adjustWeights",value:function(t){throw new Error("not yet implemented")}},{key:"formatData",value:function(t){throw new Error("not yet implemented")}},{key:"test",value:function(t){throw new Error("not yet implemented")}},{key:"toJSON",value:function(){var t=this.model,e={};for(var n in defaults)e[n]=this[n];return{type:this.constructor.name,options:e,input:t.input.toJSON(),hiddenLayers:t.hiddenLayers.map(function(t){var e={};for(var n in t)e[n]=t[n].toJSON();return e}),outputConnector:this.model.outputConnector.toJSON(),output:this.model.output.toJSON()}}},{key:"fromJSON",value:function(t){this.json=t;var e=this.model,n=t.options,r=e.allMatrices;e.input=_matrix2.default.fromJSON(t.input),r.push(e.input),e.hiddenLayers=t.hiddenLayers.map(function(t){var e={};for(var n in t)e[n]=_matrix2.default.fromJSON(t[n]),r.push(e[n]);return e}),e.outputConnector=_matrix2.default.fromJSON(t.outputConnector),e.output=_matrix2.default.fromJSON(t.output),r.push(e.outputConnector,e.output);for(var i in defaults)defaults.hasOwnProperty(i)&&"isBackPropagate"!==i&&(this[i]=n.hasOwnProperty(i)?n[i]:defaults[i]);this.bindEquations()}},{key:"toFunction",value:function(){function t(t,e){for(var n=0,r=o.length;n<r;n++){var i=o[n];if(n===e)switch(t){case i.product:case i.left:case i.right:return"new Matrix("+t.rows+", "+t.columns+")"}if(t===i.product)return"states["+n+"].product";if(t===i.right)return"states["+n+"].right";if(t===i.left)return"states["+n+"].left"}}function e(e,n){if(!e)return"null";for(var r=0,a=i.hiddenLayers.length;r<a;r++){var o=i.hiddenLayers[r];for(var u in o)if(o[u]===e)return"model.hiddenLayers["+r+"]."+u}return e===i.input?"model.input":e===i.outputConnector?"model.outputConnector":e===i.output?"model.output":t(e,n)}function n(t){return t=t.toString().split("{"),t.shift(),t=t.join("{"),t=t.split("}"),t.pop(),t.join("}")}function r(t){return"src/recurrent/matrix/"+t.replace(/[A-Z]/g,function(t){return"-"+t.toLowerCase()})+".js"}for(var i=this.model,a=this.model.equations[0],o=a.states,u=JSON.stringify(this.toJSON()),s=[],l={},h=[],p=0,d=o.length;p<d;p++){var f=o[p];s.push("states["+p+"] = {\n        name: '"+f.forwardFn.name+"',\n        left: "+e(f.left,p)+",\n        right: "+e(f.right,p)+",\n        product: "+e(f.product,p)+"\n      };");var c=f.forwardFn.name;l[c]||(l[c]=!0,h.push("\n        case '"+c+"': //compiled from "+r(c)+"\n          "+n(f.forwardFn.toString())+"\n          break;\n        "))}return new Function("input","\n      var model = "+u+";\n      \n      function Matrix(rows, columns) {\n        this.rows = rows;\n        this.columns = columns;\n        this.weights = zeros(rows * columns);\n        this.recurrence = zeros(rows * columns);\n      }\n      \n      function zeros(size) {\n        if (typeof Float64Array !== 'undefined') return new Float64Array(size);\n        var array = new Array(size);\n        for (var i = 0; i < size; i++) {\n          array[i] = 0;\n        }\n        return array;\n      }\n      \n      for (var inputIndex = 0, inputMax = input.length; inputIndex < inputMax; inputIndex++) {\n        var ixSource = (inputIndex === -1 ? 0 : input[inputIndex]); // first step: start with START token\n        var ixTarget = (inputIndex === inputMax - 1 ? 0 : input[inputIndex + 1]); // last step: end with END token\n        var rowPluckIndex = inputIndex; //connect up to rowPluck\n        var states = {};\n        "+s.join("\n")+"\n        for (var stateIndex = 0, stateMax = "+s.length+"; stateIndex < stateMax; stateIndex++) {\n          var state = states[stateIndex];\n          var product = state.product;\n          var left = state.left;\n          var right = state.right;\n          \n          switch (state.name) {\n            "+h.join("\n")+"\n          }\n        }\n      }\n      \n      return state.product;\n    ")}}]),t}();exports.default=RNN;
...
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}function _inherits(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}function uniques(t){for(var e=[],r=0,o=t.length;r<o;r++)e.indexOf(t[r])===-1&&""!==t[r]&&e.push(t[r]);return e}Object.defineProperty(exports,"__esModule",{value:!0});var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol?"symbol":typeof t},_createClass=function(){function t(t,e){for(var r=0;r<e.length;r++){var o=e[r];o.enumerable=o.enumerable||!1,o.configurable=!0,"value"in o&&(o.writable=!0),Object.defineProperty(t,o.key,o)}}return function(e,r,o){return r&&t(e.prototype,r),o&&t(e,o),e}}(),_stream=require("stream"),_lookup=require("./lookup"),_lookup2=_interopRequireDefault(_lookup),TrainStream=function(t){function e(t){var r;_classCallCheck(this,e);var o=_possibleConstructorReturn(this,(e.__proto__||Object.getPrototypeOf(e)).call(this,{objectMode:!0}));if(t=t||{},!t.neuralNetwork)throw new Error("no neural network specified");return o.neuralNetwork=t.neuralNetwork,o.dataFormatDetermined=!1,o.inputKeys=[],o.outputKeys=[],o.i=0,o.iterations=t.iterations||2e4,o.errorThresh=t.errorThresh||.005,o.log=!!t.log&&("function"==typeof t.log?t.log:console.log),o.logPeriod=t.logPeriod||10,o.callback=t.callback,o.callbackPeriod=t.callbackPeriod||10,o.floodCallback=t.floodCallback,o.doneTrainingCallback=t.doneTrainingCallback,o.size=0,o.count=0,o.sum=0,o.on("finish",o.finishStreamIteration.bind(o)),r=o,_possibleConstructorReturn(o,r)}return _inherits(e,t),_createClass(e,[{key:"_write",value:function(t,e,r){if(!t)return this.emit("finish"),r();if(!this.dataFormatDetermined)return this.size++,this.inputKeys=uniques(this.inputKeys.slice(0).concat(Object.keys(t.input))),this.outputKeys=uniques(this.outputKeys.slice(0).concat(Object.keys(t.output))),this.firstDatum=this.firstDatum||t,r();this.count++;var o=this.neuralNetwork.formatData(t);this.trainDatum(o[0]),r()}},{key:"trainDatum",value:function(t){var e=this.neuralNetwork.trainPattern(t.input,t.output);this.sum+=e}},{key:"finishStreamIteration",value:function(){var t=this;if(this.dataFormatDetermined&&this.size!==this.count&&this.log("This iteration's data length was different from the first."),!this.dataFormatDetermined){var e=function(){t.neuralNetwork.inputLookup=_lookup2.default.lookupFromArray(t.inputKeys),t.firstDatum.output.constructor!==Array&&(t.neuralNetwork.outputLookup=_lookup2.default.lookupFromArray(t.outputKeys));var e=t.neuralNetwork.formatData(t.firstDatum),r=[],o=e[0].input.length,i=e[0].output.length,n=t.hiddenSizes;return n?n.forEach(function(t){r.push(t)}):r.push(Math.max(3,Math.floor(o/2))),r.unshift(o),r.push(i),t.dataFormatDetermined=!0,t.neuralNetwork.initialize(r),"function"==typeof t.floodCallback&&t.floodCallback(),{v:void 0}}();if("object"===("undefined"==typeof e?"undefined":_typeof(e)))return e.v}var r=this.sum/this.size;if(this.log&&this.i%this.logPeriod==0&&this.log("iterations:",this.i,"training error:",r),this.callback&&this.i%this.callbackPeriod==0&&this.callback({error:r,iterations:this.i}),this.sum=0,this.count=0,this.i++,this.i<this.iterations&&r>this.errorThresh){if("function"==typeof this.floodCallback)return this.floodCallback()}else if("function"==typeof this.doneTrainingCallback)return this.doneTrainingCallback({error:r,iterations:this.i})}}]),e}(_stream.Writable);exports.default=TrainStream;

},{"./lookup":3,"stream":67}],32:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var u=t[r];u.enumerable=u.enumerable||!1,u.configurable=!0,"value"in u&&(u.writable=!0),Object.defineProperty(e,u.key,u)}}return function(t,r,u){return r&&e(t.prototype,r),u&&e(t,u),t}}(),_matrix=require("../matrix"),_matrix2=_interopRequireDefault(_matrix),_onesMatrix=require("../matrix/ones-matrix"),_onesMatrix2=_interopRequireDefault(_onesMatrix),_copy2=require("../matrix/copy"),_copy3=_interopRequireDefault(_copy2),_cloneNegative2=require("../matrix/clone-negative"),_cloneNegative3=_interopRequireDefault(_cloneNegative2),_add2=require("../matrix/add"),_add3=_interopRequireDefault(_add2),_addB2=require("../matrix/add-b"),_addB3=_interopRequireDefault(_addB2),_allOnes2=require("../matrix/all-ones"),_allOnes3=_interopRequireDefault(_allOnes2),_multiply2=require("../matrix/multiply"),_multiply3=_interopRequireDefault(_multiply2),_multiplyB2=require("../matrix/multiply-b"),_multiplyB3=_interopRequireDefault(_multiplyB2),_multiplyElement2=require("../matrix/multiply-element"),_multiplyElement3=_interopRequireDefault(_multiplyElement2),_multiplyElementB2=require("../matrix/multiply-element-b"),_multiplyElementB3=_interopRequireDefault(_multiplyElementB2),_relu2=require("../matrix/relu"),_relu3=_interopRequireDefault(_relu2),_reluB2=require("../matrix/relu-b"),_reluB3=_interopRequireDefault(_reluB2),_rowPluck2=require("../matrix/row-pluck"),_rowPluck3=_interopRequireDefault(_rowPluck2),_rowPluckB2=require("../matrix/row-pluck-b"),_rowPluckB3=_interopRequireDefault(_rowPluckB2),_sigmoid2=require("../matrix/sigmoid"),_sigmoid3=_interopRequireDefault(_sigmoid2),_sigmoidB2=require("../matrix/sigmoid-b"),_sigmoidB3=_interopRequireDefault(_sigmoidB2),_tanh2=require("../matrix/tanh"),_tanh3=_interopRequireDefault(_tanh2),_tanhB2=require("../matrix/tanh-b"),_tanhB3=_interopRequireDefault(_tanhB2),Equation=function(){function e(){_classCallCheck(this,e),this.inputRow=0,this.states=[],this.previousResults=[],this.previousResultInputs=[]}return _createClass(e,[{key:"previousResult",value:function(e){var t=new _matrix2.default(e,1);return this.states.push({product:t,left:parseInt(this.previousResultInputs.length),right:this.previousResults,backpropagationFn:function(e,t,r){(0,_copy3.default)(e,r[t])}}),this.previousResultInputs.push(t),t}},{key:"add",value:function(e,t){if(e.weights.length!==t.weights.length)throw new Error("misaligned matrices");var r=new _matrix2.default(e.rows,e.columns);return this.states.push({left:e,right:t,product:r,forwardFn:_add3.default,backpropagationFn:_addB3.default}),r}},{key:"allOnes",value:function(e,t){var r=new _matrix2.default(e,t);return this.states.push({left:r,product:r,forwardFn:_allOnes3.default}),r}},{key:"cloneNegative",value:function(e){var t=new _matrix2.default(e.rows,e.columns);return this.states.push({left:e,product:t,forwardFn:_cloneNegative3.default}),t}},{key:"subtract",value:function(e,t){if(e.weights.length!==t.weights.length)throw new Error("misaligned matrices");return this.add(this.add(this.allOnes(e.rows,e.columns),this.cloneNegative(e)),t)}},{key:"multiply",value:function(e,t){if(e.columns!==t.rows)throw new Error("misaligned matrices");var r=new _matrix2.default(e.rows,t.columns);return this.states.push({left:e,right:t,product:r,forwardFn:_multiply3.default,backpropagationFn:_multiplyB3.default}),r}},{key:"multiplyElement",value:function(e,t){if(e.weights.length!==t.weights.length)throw new Error("misaligned matrices");var r=new _matrix2.default(e.rows,e.columns);return this.states.push({left:e,right:t,product:r,forwardFn:_multiplyElement3.default,backpropagationFn:_multiplyElementB3.default}),r}},{key:"relu",value:function(e){var t=new _matrix2.default(e.rows,e.columns);return this.states.push({left:e,product:t,forwardFn:_relu3.default,backpropagationFn:_reluB3.default}),t}},{key:"inputMatrixToRow",value:function(e){var t=this,r=new _matrix2.default(e.columns,1);return this.states.push({left:e,get right(){return t.inputRow},product:r,forwardFn:_rowPluck3.default,backpropagationFn:_rowPluckB3.default}),r}},{key:"sigmoid",value:function(e){var t=new _matrix2.default(e.rows,e.columns);return this.states.push({left:e,product:t,forwardFn:_sigmoid3.default,backpropagationFn:_sigmoidB3.default}),t}},{key:"tanh",value:function(e){var t=new _matrix2.default(e.rows,e.columns);return this.states.push({left:e,product:t,forwardFn:_tanh3.default,backpropagationFn:_tanhB3.default}),t}},{key:"observe",value:function(e){var t=0,r=0;return this.states.push({forwardFn:function(){t++,console.log(e)},backpropagationFn:function(){r++,console.log(e)}}),e}},{key:"run",value:function(e){this.inputRow=e||0;for(var t=void 0,r=0,u=this.states.length;r<u;r++)t=this.states[r],t.hasOwnProperty("forwardFn")&&t.forwardFn(t.product,t.left,t.right);return t.product}},{key:"runBackpropagate",value:function(){for(var e=this.states.length;e-- >0;){var t=this.states[e];t.hasOwnProperty("backpropagationFn")&&((t.left&&t.left.recurrence&&t.left.recurrence[0]>0||t.right&&t.right.recurrence&&t.right.recurrence[0]>0)&&console.log(Error("recurrence did not copy")),t.backpropagationFn(t.product,t.left,t.right))}}},{key:"updatePreviousResults",value:function(){for(var e=0,t=this.previousResults.length;e<t;e++)(0,_copy3.default)(this.previousResultInputs[e],this.previousResults[e])}},{key:"copyPreviousResultsTo",value:function(e){for(var t=0,r=this.previousResults.length;t<r;t++)(0,_copy3.default)(e.previousResultInputs[t],this.previousResults[t])}},{key:"resetPreviousResults",value:function(){for(var e=0,t=this.previousResults.length;e<t;e++){var r=this.previousResultInputs[e];(0,_copy3.default)(r,new _matrix2.default(r.rows,1))}}},{key:"result",value:function(e){return this.previousResults.push(e),e}}]),e}();exports.default=Equation;
...
"use strict";function randomF(r,n){return Math.random()*(n-r)+r}function randomI(r,n){return Math.floor(Math.random()*(n-r)+r)}function randomN(r,n){return r+gaussRandom()*n}function gaussRandom(){if(returnV)return returnV=!1,vVal;var r=2*Math.random()-1,n=2*Math.random()-1,a=r*r+n*n;if(0==a||a>1)return gaussRandom();var t=Math.sqrt(-2*Math.log(a)/a);return vVal=n*t,returnV=!0,r*t}Object.defineProperty(exports,"__esModule",{value:!0}),exports.randomF=randomF,exports.randomI=randomI,exports.randomN=randomN;var returnV=!1,vVal=0;
...
"use strict";function _classCallCheck(e,r){if(!(e instanceof r))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,r){for(var a=0;a<r.length;a++){var t=r[a];t.enumerable=t.enumerable||!1,t.configurable=!0,"value"in t&&(t.writable=!0),Object.defineProperty(e,t.key,t)}}return function(r,a,t){return a&&e(r.prototype,a),t&&e(r,t),r}}(),Vocab=function(){function e(r,a){_classCallCheck(this,e),a=a||0,this.values=r,this.indexTable={},this.characterTable={},this.characters=[];for(var t={},n=0,c=r.length;n<c;n++)for(var s=r[n].toString(),i=0,l=s.length;i<l;i++){var h=s[i];h in t||(t[h]=!0,this.characters.push(h))}for(var o=this.characters.length,u=0;u<o;u++){var f=this.characters[u];u>=a&&(this.indexTable[f]=u+1,this.characterTable[u+1]=f)}}return _createClass(e,[{key:"toIndexes",value:function(e,r){r=r||0;for(var a=[],t=this.indexTable,n=0,c=e.length;n<c;n++){var s=e[n],i=t[s];i<r||a.push(i)}return a}},{key:"toCharacters",value:function(e,r){r=r||0;for(var a=[],t=this.characterTable,n=0,c=e.length;n<c;n++){var s=e[n];if(!(s<r)){var i=t[s];a.push(i)}}return a}}]),e}();exports.default=Vocab;
...
var crossValidate=require("./dist/cross-validate"),likely=require("./dist/likely"),lookup=require("./dist/lookup"),NeuralNetwork=require("./dist/neural-network"),TrainStream=require("./dist/train-stream"),RNN=require("./dist/recurrent/rnn"),LSTM=require("./dist/recurrent/lstm"),GRU=require("./dist/recurrent/gru"),utilities={max:require("./dist/utilities/max"),mse:require("./dist/utilities/mse"),ones:require("./dist/utilities/ones"),random:require("./dist/utilities/random"),randomWeight:require("./dist/utilities/random-weight"),randos:require("./dist/utilities/randos"),range:require("./dist/utilities/range"),toArray:require("./dist/utilities/to-array"),Vocab:require("./dist/utilities/vocab"),zeros:require("./dist/utilities/zeros")};if(module.exports={crossValidate:crossValidate,likely:likely,lookup:lookup,NeuralNetwork:NeuralNetwork,TrainStream:TrainStream,recurrent:{RNN:RNN,LSTM:LSTM,GRU:GRU},utilities:utilities},"undefined"!=typeof window){var brain=window.brain={},i;for(i in module.exports)brain[i]=module.exports[i].default||module.exports[i];for(i in module.exports.utilities)brain.utilities[i]=module.exports.utilities[i].default||module.exports.utilities[i]}
