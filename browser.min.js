...
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _toConsumableArray(t){if(Array.isArray(t)){for(var i=0,e=Array(t.length);i<t.length;i++)e[i]=t[i];return e}return Array.from(t)}function _classCallCheck(t,i){if(!(t instanceof i))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function t(t,i){for(var e=0;e<i.length;e++){var r=i[e];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(t,r.key,r)}}return function(i,e,r){return e&&t(i.prototype,e),r&&t(i,r),i}}(),_lookup=require("./lookup"),_lookup2=_interopRequireDefault(_lookup),_trainStream=require("./train-stream"),_trainStream2=_interopRequireDefault(_trainStream),_max=require("./utilities/max"),_max2=_interopRequireDefault(_max),_mse=require("./utilities/mse"),_mse2=_interopRequireDefault(_mse),_randos=require("./utilities/randos"),_randos2=_interopRequireDefault(_randos),_range=require("./utilities/range"),_range2=_interopRequireDefault(_range),_toArray=require("./utilities/to-array"),_toArray2=_interopRequireDefault(_toArray),_zeros=require("./utilities/zeros"),_zeros2=_interopRequireDefault(_zeros),_thaw=require("thaw.js"),_thaw2=_interopRequireDefault(_thaw),availableActivations={sigmoid:{activationFn:function(t){return 1/(1+Math.exp(-t))},deltaFn:function(t,i){return i*t*(1-t)}},relu:{activationFn:function(t){return Math.max(0,t)},deltaFn:function(t,i){return t>0?i:0}},"leaky-relu":{activationFn:function(t){return t<0?0:.01*t},deltaFn:function(t,i){return t>0?i:.01*i}},tanh:{activationFn:function(t){return Math.tanh(t)},deltaFn:function(t,i){return(1-t*t)*i}}},NeuralNetwork=function(){function t(){var i=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};_classCallCheck(this,t),Object.assign(this,this.constructor.defaults,i),this.hiddenSizes=i.hiddenLayers,this.trainOpts={},this._updateTrainingOptions(Object.assign({},this.constructor.trainDefaults,i)),this.sizes=null,this.outputLayer=null,this.biases=null,this.weights=null,this.outputs=null,this.deltas=null,this.changes=null,this.errors=null,this.errorCheckInterval=1,this.constructor.prototype.hasOwnProperty("runInput")||(this.runInput=null),this.constructor.prototype.hasOwnProperty("calculateDeltas")||(this.calculateDeltas=null)}return _createClass(t,null,[{key:"_validateTrainingOptions",value:function(i){var e={iterations:function(t){return"number"==typeof t&&t>0},errorThresh:function(t){return"number"==typeof t&&t>0&&t<1},log:function(t){return"function"==typeof t||"boolean"==typeof t},logPeriod:function(t){return"number"==typeof t&&t>0},learningRate:function(t){return"number"==typeof t&&t>0&&t<1},momentum:function(t){return"number"==typeof t&&t>0&&t<1},callback:function(t){return"function"==typeof t||null===t},callbackPeriod:function(t){return"number"==typeof t&&t>0},timeout:function(t){return"number"==typeof t&&t>0}};Object.keys(t.trainDefaults).forEach(function(t){if(e.hasOwnProperty(t)&&!e[t](i[t]))throw new Error("["+t+", "+i[t]+"] is out of normal training range, your network will probably not train.")})}},{key:"trainDefaults",get:function(){return{iterations:2e4,errorThresh:.005,log:!1,logPeriod:10,learningRate:.3,momentum:.1,callback:null,callbackPeriod:10,timeout:1/0}}},{key:"defaults",get:function(){return{binaryThresh:.5,hiddenLayers:[3],activation:"sigmoid"}}}]),_createClass(t,[{key:"_initialize",value:function(){if(!this.sizes)throw new Error("Sizes must be set before initializing");this.outputLayer=this.sizes.length-1,this.biases=[],this.weights=[],this.outputs=[],this.deltas=[],this.changes=[],this.errors=[];for(var t=0;t<=this.outputLayer;t++){var i=this.sizes[t];if(this.deltas[t]=(0,_zeros2.default)(i),this.errors[t]=(0,_zeros2.default)(i),this.outputs[t]=(0,_zeros2.default)(i),t>0){this.biases[t]=(0,_randos2.default)(i),this.weights[t]=new Array(i),this.changes[t]=new Array(i);for(var e=0;e<i;e++){var r=this.sizes[t-1];this.weights[t][e]=(0,_randos2.default)(r),this.changes[t][e]=(0,_zeros2.default)(r)}}}this.setActivation()}},{key:"setActivation",value:function(t){var i=Object.keys(availableActivations);if(this.activation=t||this.activation,!i.includes(this.activation))throw new Error("Unknown activation "+this.activation+", The activation should be one of ['"+i.join("', '")+"']");var e=availableActivations[this.activation],r=e.activationFn,n=e.deltaFn;this.runInput=this.runInput||this._createRunInput(r),this.calculateDeltas=this.calculateDeltas||this._createCalculateDeltas(n)}},{key:"run",value:function(t){if(!this.isRunnable)return null;this.inputLookup&&(t=_lookup2.default.toArray(this.inputLookup,t));var i=[].concat(_toConsumableArray(this.runInput(t)));return this.outputLookup&&(i=_lookup2.default.toHash(this.outputLookup,i)),i}},{key:"_createRunInput",value:function(t){return function(i){this.outputs[0]=i;for(var e=null,r=1;r<=this.outputLayer;r++){for(var n=0;n<this.sizes[r];n++){for(var a=this.weights[r][n],s=this.biases[r][n],u=0;u<a.length;u++)s+=a[u]*i[u];this.outputs[r][n]=t(s)}e=i=this.outputs[r]}return e}}},{key:"_verifyIsInitialized",value:function(t){var i=this;this.sizes||(this.sizes=[],this.sizes.push(t[0].input.length),this.hiddenSizes?this.hiddenSizes.forEach(function(t){i.sizes.push(t)}):this.sizes.push(Math.max(3,Math.floor(t[0].input.length/2))),this.sizes.push(t[0].output.length),this._initialize())}},{key:"_updateTrainingOptions",value:function(i){var e=this;Object.keys(t.trainDefaults).forEach(function(t){return e.trainOpts[t]=i.hasOwnProperty(t)?i[t]:e.trainOpts[t]}),t._validateTrainingOptions(this.trainOpts),this._setLogMethod(i.log||this.trainOpts.log),this.activation=i.activation||this.activation}},{key:"_getTrainOptsJSON",value:function(){var i=this;return Object.keys(t.trainDefaults).reduce(function(t,e){return"timeout"===e&&i.trainOpts[e]===1/0?t:(i.trainOpts[e]&&(t[e]=i.trainOpts[e]),"log"===e&&(t.log="function"==typeof t.log),t)},{})}},{key:"_setLogMethod",value:function(t){this.trainOpts.log="function"==typeof t?t:!!t&&console.log}},{key:"_calculateTrainingError",value:function(t){for(var i=0,e=0;e<t.length;++e)i+=this._trainPattern(t[e].input,t[e].output,!0);return i/t.length}},{key:"_trainPatterns",value:function(t){for(var i=0;i<t.length;++i)this._trainPattern(t[i].input,t[i].output,!1)}},{key:"_trainingTick",value:function(t,i,e){return!(i.iterations>=this.trainOpts.iterations||i.error<=this.trainOpts.errorThresh||Date.now()>=e)&&(i.iterations++,this.trainOpts.log&&i.iterations%this.trainOpts.logPeriod==0?(i.error=this._calculateTrainingError(t),this.trainOpts.log("iterations: "+i.iterations+", training error: "+i.error)):i.iterations%this.errorCheckInterval==0?i.error=this._calculateTrainingError(t):this._trainPatterns(t),this.trainOpts.callback&&i.iterations%this.trainOpts.callbackPeriod==0&&this.trainOpts.callback(Object.assign(i)),!0)}},{key:"_prepTraining",value:function(t,i){this._updateTrainingOptions(i),t=this._formatData(t);var e=Date.now()+this.trainOpts.timeout,r={error:1,iterations:0};return this._verifyIsInitialized(t),{data:t,status:r,endTime:e}}},{key:"train",value:function(t){var i=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},e=void 0,r=void 0,n=this._prepTraining(t,i);for(t=n.data,e=n.status,r=n.endTime;this._trainingTick(t,e,r););return e}},{key:"trainAsync",value:function(t){var i=this,e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},r=void 0,n=void 0,a=this._prepTraining(t,e);return t=a.data,r=a.status,n=a.endTime,new Promise(function(e,a){try{var s=new _thaw2.default(new Array(i.trainOpts.iterations),{delay:!0,each:function(){return i._trainingTick(t,r,n)||s.stop()},done:function(){return e(r)}});s.tick()}catch(t){a({trainError:t,status:r})}})}},{key:"_trainPattern",value:function(t,i,e){return this.runInput(t),this.calculateDeltas(i),this._adjustWeights(),e?(0,_mse2.default)(this.errors[this.outputLayer]):null}},{key:"_createCalculateDeltas",value:function(t){return function(i){for(var e=this.outputLayer;e>=0;e--)for(var r=0;r<this.sizes[e];r++){var n=this.outputs[e][r],a=0;if(e===this.outputLayer)a=i[r]-n;else for(var s=this.deltas[e+1],u=0;u<s.length;u++)a+=s[u]*this.weights[e+1][u][r];this.errors[e][r]=a,this.deltas[e][r]=t(n,a)}}}},{key:"_adjustWeights",value:function(){for(var t=1;t<=this.outputLayer;t++)for(var i=this.outputs[t-1],e=0;e<this.sizes[t];e++){for(var r=this.deltas[t][e],n=0;n<i.length;n++){var a=this.changes[t][e][n];a=this.trainOpts.learningRate*r*i[n]+this.trainOpts.momentum*a,this.changes[t][e][n]=a,this.weights[t][e][n]+=a}this.biases[t][e]+=this.trainOpts.learningRate*r}}},{key:"_formatData",value:function(t){var i=this;if(!Array.isArray(t)){var e=[];e.push(t),t=e}var r=t[0].input;return Array.isArray(r)||r instanceof Float32Array||(this.inputLookup||(this.inputLookup=_lookup2.default.buildLookup(t.map(function(t){return t.input}))),t=t.map(function(t){var e=_lookup2.default.toArray(i.inputLookup,t.input);return Object.assign({},t,{input:e})},this)),Array.isArray(t[0].output)||(this.outputLookup||(this.outputLookup=_lookup2.default.buildLookup(t.map(function(t){return t.output}))),t=t.map(function(t){var e=_lookup2.default.toArray(i.outputLookup,t.output);return Object.assign({},t,{output:e})},this)),t}},{key:"test",value:function(t){var i=this;t=this._formatData(t);for(var e=1===t[0].output.length,r=0,n=0,a=0,s=0,u=[],o=0,l=0;l<t.length;l++)!function(l){var h=i.runInput(t[l].input),c=t[l].output,p=void 0,f=void 0;if(e?(p=h[0]>i.binaryThresh?1:0,f=c[0]):(p=h.indexOf((0,_max2.default)(h)),f=c.indexOf((0,_max2.default)(c))),p!==f){var v=t[l];Object.assign(v,{actual:p,expected:f}),u.push(v)}e&&(0===p&&0===f?s++:1===p&&1===f?a++:0===p&&1===f?n++:1===p&&0===f&&r++);var y=h.map(function(t,i){return c[i]-t});o+=(0,_mse2.default)(y)}(l);var h=o/t.length,c={error:h,misclasses:u};return e&&Object.assign(c,{trueNeg:s,truePos:a,falseNeg:n,falsePos:r,total:t.length,precision:a/(a+r),recall:a/(a+n),accuracy:(s+a)/t.length}),c}},{key:"toJSON",value:function(){for(var t=[],i=0;i<=this.outputLayer;i++){t[i]={};var e=void 0;e=0===i&&this.inputLookup?Object.keys(this.inputLookup):i===this.outputLayer&&this.outputLookup?Object.keys(this.outputLookup):(0,_range2.default)(0,this.sizes[i]);for(var r=0;r<e.length;r++){var n=e[r];if(t[i][n]={},i>0){t[i][n].bias=this.biases[i][r],t[i][n].weights={};for(var a in t[i-1]){var s=a;1===i&&this.inputLookup&&(s=this.inputLookup[a]),t[i][n].weights[a]=this.weights[i][r][s]}}}}return{sizes:this.sizes,layers:t,outputLookup:!!this.outputLookup,inputLookup:!!this.inputLookup,activation:this.activation,trainOpts:this._getTrainOptsJSON()}}},{key:"fromJSON",value:function(t){this.sizes=t.sizes,this._initialize();for(var i=0;i<=this.outputLayer;i++){var e=t.layers[i];if(0!==i||e[0]&&!t.inputLookup?i!==this.outputLayer||e[0]&&!t.outputLookup||(this.outputLookup=_lookup2.default.lookupFromHash(e)):this.inputLookup=_lookup2.default.lookupFromHash(e),i>0){var r=Object.keys(e);this.sizes[i]=r.length;for(var n in r){var a=r[n];this.biases[i][n]=e[a].bias,this.weights[i][n]=(0,_toArray2.default)(e[a].weights)}}}return t.hasOwnProperty("trainOpts")&&this._updateTrainingOptions(t.trainOpts),this.setActivation(this.activation||"sigmoid"),this}},{key:"toFunction",value:function(){function t(e,r,n){if(0===r)return"string"==typeof n?"input['"+n+"']":"input["+n+"]";var a=e[r],s=a[n],u=[s.bias];for(var o in s.weights)u.push((s.weights[o]<0?"":"+")+s.weights[o]+"*("+t(e,r-1,o)+")");return"("+availableActivations[i].activationFn.toString()+")("+u.join("")+")"}var i=this.activation;if(!Object.keys(availableActivations).includes(i))throw new Error("unknown activation type "+i);var e=this.toJSON().layers,r=[],n=void 0;for(var a in e[e.length-1])r.push(t(e,e.length-1,a));return n=this.outputLookup?"{"+Object.keys(this.outputLookup).map(function(t,i){return"'"+t+"':"+r[i]})+"}":"["+r.join(",")+"]",new Function("input","return "+n)}},{key:"createTrainStream",value:function(t){return t=t||{},t.neuralNetwork=this,this.setActivation(),this.trainStream=new _trainStream2.default(t),this.trainStream}},{key:"isRunnable",get:function(){var t=this;if(!this.runInput)return console.error("Activation function has not been initialized, did you run train()?"),!1;var i=["sizes","outputLayer","biases","weights","outputs","deltas","changes","errors"].filter(function(i){return null===t[i]});return!(i.length>0)||(console.error("Some settings have not been initialized correctly, did you run train()? Found issues with: "+i.join(", ")),!1)}}]),t}();exports.default=NeuralNetwork;
