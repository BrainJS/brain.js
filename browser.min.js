...
"use strict";function _classCallCheck(e,r){if(!(e instanceof r))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,r){for(var t=0;t<r.length;t++){var n=r[t];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(r,t,n){return t&&e(r.prototype,t),n&&e(r,n),r}}(),CrossValidate=function(){function e(r){_classCallCheck(this,e),this.Classifier=r,this.json=null}return _createClass(e,[{key:"testPartition",value:function(e,r,t,n){var a=new this.Classifier(e),i=Date.now(),o=a.train(t,r),s=Date.now(),u=a.test(n),l=Date.now();return Object.assign({},u,{trainTime:s-i,testTime:l-s,iterations:o.iterations,trainError:o.error,learningRate:r.learningRate,hidden:a.hiddenSizes,network:a.toJSON()})}},{key:"shuffleArray",value:function(e){for(var r=e.length-1;r>0;r--){var t=Math.floor(Math.random()*(r+1)),n=e[r];e[r]=e[t],e[t]=n}return e}},{key:"train",value:function(e,r,t,n){n=n||4;var a=e.length/n;if(e.constructor===Array)this.shuffleArray(e);else{var i={};this.shuffleArray(Object.keys(e)).forEach(function(r){i[r]=e[r]}),e=i}for(var o={error:0,trainTime:0,testTime:0,iterations:0,trainError:0},s={truePos:0,trueNeg:0,falsePos:0,falseNeg:0,total:0},u=[],l=void 0,f=void 0,c=0;c<n;c++){var h=e.slice(0),v=h.splice(c*a,a),y=h,d=this.testPartition(r,t,y,v);for(l in o)l in o&&(f=o[l],o[l]=f+d[l]);for(l in s)l in s&&(f=s[l],s[l]=f+d[l]);u.push(d)}for(l in o)l in o&&(f=o[l],o[l]=f/n);s.precision=s.truePos/(s.truePos+s.falsePos),s.recall=s.truePos/(s.truePos+s.falseNeg),s.accuracy=(s.trueNeg+s.truePos)/s.total,s.testSize=a,s.trainSize=e.length-a,this.json={avgs:o,stats:s,sets:u}}},{key:"toNetwork",value:function(){return this.fromJSON(this.json)}},{key:"toJSON",value:function(){return this.json}},{key:"fromJSON",value:function(e){var r=this.Classifier,t=e.sets.reduce(function(e,r){return e.error<r.error?e:r},{error:1/0}).network;if(r.fromJSON)return r.fromJSON(t);var n=new r;return n.fromJSON(t),n}}]),e}();exports.default=CrossValidate;
