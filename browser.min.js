...
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _classCallCheck(t,r){if(!(t instanceof r))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(t,r){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!r||"object"!=typeof r&&"function"!=typeof r?t:r}function _inherits(t,r){if("function"!=typeof r&&null!==r)throw new TypeError("Super expression must either be null or a function, not "+typeof r);t.prototype=Object.create(r&&r.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),r&&(Object.setPrototypeOf?Object.setPrototypeOf(t,r):t.__proto__=r)}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function t(t,r){for(var e=0;e<r.length;e++){var n=r[e];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(t,n.key,n)}}return function(r,e,n){return e&&t(r.prototype,e),n&&t(r,n),r}}(),_matrix=require("./matrix"),_matrix2=_interopRequireDefault(_matrix),_randomMatrix=require("./matrix/random-matrix"),_randomMatrix2=_interopRequireDefault(_randomMatrix),_equation=require("./matrix/equation"),_equation2=_interopRequireDefault(_equation),_rnn=require("./rnn"),_rnn2=_interopRequireDefault(_rnn),_zeros=require("../utilities/zeros"),_zeros2=_interopRequireDefault(_zeros),_softmax=require("./matrix/softmax"),_softmax2=_interopRequireDefault(_softmax),_random=require("../utilities/random"),_sampleI=require("./matrix/sample-i"),_sampleI2=_interopRequireDefault(_sampleI),_maxI=require("./matrix/max-i"),_maxI2=_interopRequireDefault(_maxI),_lookup=require("../lookup"),_lookup2=_interopRequireDefault(_lookup),_lookupTable2=require("../utilities/lookup-table"),_lookupTable3=_interopRequireDefault(_lookupTable2),_arrayLookupTable=require("../utilities/array-lookup-table"),_arrayLookupTable2=_interopRequireDefault(_arrayLookupTable),_cast=require("../utilities/cast"),RNNTimeStep=function(t){function r(t){_classCallCheck(this,r);var e=_possibleConstructorReturn(this,(r.__proto__||Object.getPrototypeOf(r)).call(this,t));return e.inputLookup=null,e.inputLookupLength=null,e.outputLookup=null,e.outputLookupLength=null,e}return _inherits(r,t),_createClass(r,[{key:"createOutputMatrix",value:function(){var t=this.model,r=this.outputSize,e=this.hiddenLayers[this.hiddenLayers.length-1];t.outputConnector=new _randomMatrix2.default(r,e,.08),t.output=new _randomMatrix2.default(r,1,.08)}},{key:"bindEquation",value:function(){var t=this.model,r=this.hiddenLayers,e=t.hiddenLayers,n=new _equation2.default,u=[],a=t.equationConnections.length>0?t.equationConnections[t.equationConnections.length-1]:this.initialLayerInputs,o=this.getEquation(n,n.input(new _matrix2.default(this.inputSize,1)),a[0],e[0]);u.push(o);for(var i=1,s=r.length;i<s;i++)o=this.getEquation(n,o,a[i],e[i]),u.push(o);t.equationConnections.push(u),n.add(n.multiply(t.outputConnector,o),t.output),t.equations.push(n)}},{key:"mapModel",value:function(){var t=this.model,r=t.hiddenLayers,e=t.allMatrices;if(this.initialLayerInputs=this.hiddenLayers.map(function(t){return new _matrix2.default(t,1)}),this.createHiddenLayers(),!t.hiddenLayers.length)throw new Error("net.hiddenLayers not set");for(var n=0,u=r.length;n<u;n++){var a=r[n];for(var o in a)a.hasOwnProperty(o)&&e.push(a[o])}if(this.createOutputMatrix(),!t.outputConnector)throw new Error("net.model.outputConnector not set");if(!t.output)throw new Error("net.model.output not set");e.push(t.outputConnector),e.push(t.output)}},{key:"backpropagate",value:function(){for(var t=this.model.equations.length-1;t>-1;t--)this.model.equations[t].backpropagate()}},{key:"run",value:function(t){return 1===this.inputSize?this.outputLookup?(this.run=this.runObject,this.runObject(t)):(this.run=this.runNumbers,this.runNumbers(t)):(this.run=this.runArrays,this.runArrays(t))}},{key:"forecast",value:function(t,r){return 1===this.inputSize?this.outputLookup?(this.forecast=this.runObject,this.runObject(t)):(this.forecast=this.forecastNumbers,this.forecastNumbers(t,r)):this.outputLookup?(this.forecast=this.forecastObjects,this.forecastObjects(t,r)):(this.forecast=this.forecastArrays,this.forecastArrays(t,r))}},{key:"train",value:function(t){var r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};this.trainOpts=r=Object.assign({},this.constructor.trainDefaults,r);var e=r.iterations,n=r.errorThresh,u=!0===r.log?console.log:r.log,a=r.logPeriod,o=r.learningRate||this.learningRate,i=r.callback,s=r.callbackPeriod;1!==this.inputSize&&this.inputSize||this.setSize(t),t=this.formatData(t),t[0].input?this.trainInput=this.trainInputOutput:t[0].length>0&&(t[0][0].length>0?this.trainInput=this.trainArrays:this.inputSize>1?(t=[t],this.trainInput=this.trainArrays):this.trainInput=this.trainNumbers);var p=1/0,l=void 0;for(this.model||this.initialize(),l=0;l<e&&p>n;l++){for(var h=0,f=0;f<t.length;f++){h+=this.trainPattern(t[f],o)}if(p=h/t.length,isNaN(p))throw new Error("network error rate is unexpected NaN, check network configurations and try again");u&&l%a==0&&u("iterations: "+l+", training error: "+p),i&&l%s==0&&i({error:p,iterations:l})}return{error:p,iterations:l}}},{key:"setSize",value:function(t){var r=_lookup2.default.dataShape(t).join(",");switch(r){case"array,array,number":case"array,object,number":case"array,datum,array,number":case"array,datum,object,number":break;case"array,array,array,number":this.inputSize=this.outputSize=t[0][0].length;break;case"array,array,object,number":this.inputSize=this.outputSize=Object.keys(_lookup2.default.toTable2D(t)).length;break;case"array,datum,array,array,number":this.inputSize=this.outputSize=t[0].input[0].length;break;case"array,datum,array,object,number":this.inputSize=Object.keys(_lookup2.default.toInputTable2D(t)).length,this.outputSize=Object.keys(_lookup2.default.toOutputTable2D(t)).length;break;default:throw new Error("unknown data shape "+r)}}},{key:"trainNumbers",value:function(t){for(var r=this.model,e=r.equations;e.length<t.length;)this.bindEquation();for(var n=0,u=0,a=t.length-1;u<a;u++)n+=e[u].predictTarget(t[u],t[u+1]);return this.end(),n/t.length}},{key:"runNumbers",value:function(t){if(!this.isRunnable)return null;var r=this.model,e=r.equations;for(this.inputLookup&&(t=_lookup2.default.toArray(this.inputLookup,t,this.inputLookupLength));e.length<=t.length;)this.bindEquation();for(var n=void 0,u=0;u<t.length;u++)n=e[u].runInput([t[u]]);return this.end(),n.weights[0]}},{key:"forecastNumbers",value:function(t,r){if(!this.isRunnable)return null;for(var e=this.model,n=e.equations,u=t.length+r;n.length<=u;)this.bindEquation();for(var a=void 0,o=0,i=0;i<t.length;i++)a=n[o++].runInput([t[i]]);for(var s=[a.weights[0]],p=0,l=r-1;p<l;p++)a=n[o++].runInput(a.weights),s.push(a.weights[0]);return this.end(),s}},{key:"runObject",value:function(t){if(this.inputLookup===this.outputLookup){var r=_lookup2.default.toArrayShort(this.inputLookup,t);return _lookup2.default.toObjectPartial(this.outputLookup,this.forecastNumbers(r,this.outputLookupLength-r.length),r.length)}return _lookup2.default.toObject(this.outputLookup,this.forecastNumbers(_lookup2.default.toArray(this.inputLookup,t,this.inputLookupLength),this.outputLookupLength))}},{key:"forecastObjects",value:function(t,r){var e=this;return t=t.map(function(t){return _lookup2.default.toArray(e.outputLookup,t,e.outputLookupLength)}),this.forecastArrays(t,r).map(function(t){return _lookup2.default.toObject(e.outputLookup,t)})}},{key:"trainInputOutput",value:function(t){for(var r=this.model,e=t.input,n=t.output,u=e.length+n.length,a=r.equations;a.length<u;)this.bindEquation();for(var o=0,i=0,s=0,p=e.length-1;s<p;s++)o+=a[i++].predictTarget(e[s],e[s+1]);o+=a[i++].predictTarget(e[e.length-1],n[0]);for(var l=0,h=n.length-1;l<h;l++)o+=a[i++].predictTarget(n[l],n[l+1]);return this.end(),o/u}},{key:"trainArrays",value:function(t){for(var r=this.model,e=r.equations;e.length<t.length;)this.bindEquation();for(var n=0,u=0,a=t.length-1;u<a;u++)n+=e[u].predictTarget(t[u],t[u+1]);return this.end(),n/t.length}},{key:"runArrays",value:function(t){if(!this.isRunnable)return null;for(var r=this.model,e=r.equations;e.length<=t.length;)this.bindEquation();this.inputLookup&&(t=_lookup2.default.toArrays(this.inputLookup,t,this.inputLookupLength));for(var n=void 0,u=0;u<t.length;u++){n=e[u].runInput(t[u]).weights}return this.end(),this.outputLookup?_lookup2.default.toObject(this.outputLookup,n):n}},{key:"forecastArrays",value:function(t,r){if(!this.isRunnable)return null;for(var e=this.model,n=e.equations,u=t.length+r;n.length<=u;)this.bindEquation();for(var a=void 0,o=0,i=0;i<t.length;i++)a=n[o++].runInput(t[i]);for(var s=[a.weights],p=0,l=r-1;p<l;p++)a=n[o++].runInput(a.weights),s.push(a.weights.slice(0));return this.end(),s}},{key:"end",value:function(){this.model.equations[this.model.equations.length-1].runInput(new Float32Array(this.outputSize))}},{key:"formatData",value:function(t){var r=_lookup2.default.dataShape(t).join(","),e=[];switch(r){case"array,number":if(1!==this.inputSize)throw new Error("inputSize must be 1 for this data size");for(var n=0;n<t.length;n++)e.push(Float32Array.from([t[n]]));return e;case"array,array,number":if(1===this.inputSize){for(var u=0;u<t.length;u++)e.push((0,_cast.arrayToFloat32Arrays)(t[u]));return e}for(var a=0;a<t.length;a++)e.push(Float32Array.from(t[a]));return e;case"array,object,number":for(var o=new _lookupTable3.default(t),i=0;i<t.length;i++)e.push((0,_cast.objectToFloat32Arrays)(t[i]));return this.inputLookup=o.table,this.inputLookupLength=o.length,this.outputLookup=o.table,this.outputLookupLength=o.length,e;case"array,datum,array,number":if(1!==this.inputSize)throw new Error("inputSize must be 1 for this data size");for(var s=0;s<t.length;s++){var p=t[s];e.push({input:(0,_cast.arrayToFloat32Arrays)(p.input),output:(0,_cast.arrayToFloat32Arrays)(p.output)})}return e;case"array,datum,object,number":if(1===this.inputSize){for(var l=new _lookupTable3.default(t,"input"),h=new _lookupTable3.default(t,"output"),f=0;f<t.length;f++){var c=t[f];e.push({input:(0,_cast.objectToFloat32Arrays)(c.input),output:(0,_cast.objectToFloat32Arrays)(c.output)}),this.inputLookup=l.table,this.inputLookupLength=l.length,this.outputLookup=h.table,this.outputLookupLength=h.length}return e}throw new Error("unknown data shape or configuration");case"array,array,array,number":for(var d=0;d<t.length;d++)e.push((0,_cast.arraysToFloat32Arrays)(t[d]));return e;case"array,array,object,number":for(var g=new _lookupTable3.default(t),v=0;v<t.length;v++){for(var y=[],b=0;b<t[v].length;b++)y.push((0,_cast.objectToFloat32Array)(t[v][b],g));e.push(y)}return this.inputLookup=g.table,this.inputLookupLength=g.length,this.outputLookup=g.table,this.outputLookupLength=g.length,e;case"array,datum,array,array,number":if(this.inputSize>1)for(var m=0;m<t.length;m++){var k=t[m];e.push({input:(0,_cast.arraysToFloat32Arrays)(k.input),output:(0,_cast.arraysToFloat32Arrays)(k.output)})}else for(var _=0;_<t.length;_++){var w=t[_];e.push({input:Float32Array.from(w.input),output:Float32Array.from(w.output)})}return e;case"array,datum,array,object,number":for(var L=new _arrayLookupTable2.default(t,"input"),S=new _arrayLookupTable2.default(t,"output"),O=0;O<t.length;O++){var j=t[O];e.push({input:(0,_cast.objectsToFloat32Arrays)(j.input,L),output:(0,_cast.objectsToFloat32Arrays)(j.output,S)})}return this.inputLookup=L.table,this.inputLookupLength=L.length,this.outputLookup=S.table,this.outputLookupLength=S.length,e;default:throw new Error("unknown data shape or configuration")}}},{key:"test",value:function(t){var r=this.formatData(t),e=[],n=0;switch(_lookup2.default.dataShape(t).join(",")){case"array,array,number":if(1===this.inputSize){for(var u=0;u<r.length;u++){var a=r[u],o=this.run(a.splice(0,a.length-1)),i=a[a.length-1][0],s=i-o,p=s*s;if(n+=p,Math.abs(p)>this.trainOpts.errorThresh){var l=t[u];Object.assign(l,{value:a,actual:o}),e.push(l)}}break}case"array,array,array,number":for(var h=0;h<r.length;h++){for(var f=r[h],c=this.run(f.splice(0,f.length-1)),d=f[f.length-1],g=0,v=0;v<c.length;v++){var y=d[v]-c[v];g+=y*y}if(n+=g,Math.abs(g)>this.trainOpts.errorThresh){var b=t[h];e.push({value:b,actual:c})}}break;case"array,object,number":if(this.inputSize>1)throw new Error("TODO: too big");for(var m=0;m<r.length;m++){var k=r[m],_=this.run(_lookup2.default.toObjectPartial(this.outputLookup,k,0,k.length-1)),w=k[k.length-1],L=0,S=void 0;for(S in _);var O=w[m]-_[S];if(L+=O*O,n+=L,Math.abs(L)>this.trainOpts.errorThresh){var j=t[m];e.push({value:j,actual:_})}}break;case"array,array,object,number":for(var q=0;q<r.length;q++){var x=r[q],T=this.run(x.slice(0,x.length-1)),z=t[q][x.length-1],I=0;for(var N in T){var A=z[N]-T[N];I+=A*A}if(n+=I,Math.abs(I)>this.trainOpts.errorThresh){var E=t[q];e.push({value:E,actual:T})}}break;case"array,datum,array,number":case"array,datum,object,number":for(var C=0;C<r.length;C++){for(var F=r[C],R=this.forecast(F.input,F.output.length),M=0,D=0;D<R.length;D++){var P=F.output[D][0]-R[D];M+=P*P}if(n+=M,Math.abs(M)>this.trainOpts.errorThresh){var J=t[C];Object.assign(J,{actual:this.outputLookup?_lookup2.default.toObject(this.outputLookup,R):R}),e.push(J)}}break;case"array,datum,array,array,number":for(var H=0;H<r.length;H++){for(var V=r[H],Z=this.forecast(V.input,V.output.length),B=0,G=0;G<Z.length;G++)for(var K=0;K<Z[G].length;K++){var Q=V.output[G][K]-Z[G][K];B+=Q*Q}if(n+=B,Math.abs(B)>this.trainOpts.errorThresh){var U=t[H];e.push({input:U.input,output:U.output,actual:Z})}}break;case"array,datum,array,object,number":for(var W=0;W<r.length;W++){for(var X=r[W],Y=this.forecast(X.input,X.output.length),$=0,tt=0;tt<Y.length;tt++)for(var rt in Y[tt]){var et=t[W].output[tt][rt]-Y[tt][rt];$+=et*et}if(n+=$,Math.abs($)>this.trainOpts.errorThresh){var nt=t[W];e.push({input:nt.input,output:nt.output,actual:Y})}}break;default:throw new Error("unimplemented")}return{error:n/t.length,misclasses:e}}},{key:"toJSON",value:function(){var t=this.constructor.defaults;this.model||this.initialize();var r=this.model,e={};for(var n in t)t.hasOwnProperty(n)&&(e[n]=this[n]);return{type:this.constructor.name,options:e,hiddenLayers:r.hiddenLayers.map(function(t){var r={};for(var e in t)r[e]=t[e].toJSON();return r}),outputConnector:this.model.outputConnector.toJSON(),output:this.model.output.toJSON()}}},{key:"fromJSON",value:function(t){var r=this.constructor.defaults,e=t.options;this.model=null,this.hiddenLayers=null;var n=[],u=[];(t.hiddenLayers||t.hiddenSizes).forEach(function(t){var r={};for(var e in t)r[e]=_matrix2.default.fromJSON(t[e]),n.push(r[e]);u.push(r)});var a=_matrix2.default.fromJSON(t.outputConnector);n.push(a);var o=_matrix2.default.fromJSON(t.output);n.push(o),Object.assign(this,r,e),e.hiddenSizes&&(this.hiddenLayers=e.hiddenSizes),this.model={hiddenLayers:u,output:o,allMatrices:n,outputConnector:a,equations:[],equationConnections:[]},this.initialLayerInputs=this.hiddenLayers.map(function(t){return new _matrix2.default(t,1)}),this.bindEquation()}},{key:"toFunction",value:function(){function t(t,e){for(var n=0,u=h.length;n<u;n++){var a=h[n];if(n===e){var o=r(t);switch(t){case a.left:if(o>-1)return"typeof prevStates["+o+"] === 'object' ? prevStates["+o+"].product : new Matrix("+t.rows+", "+t.columns+")";case a.right:if(o>-1)return"typeof prevStates["+o+"] === 'object' ? prevStates["+o+"].product : new Matrix("+t.rows+", "+t.columns+")";case a.product:return"new Matrix("+t.rows+", "+t.columns+")";default:throw Error("unknown state")}}if(t===a.product)return"states["+n+"].product";if(t===a.right)return"states["+n+"].right";if(t===a.left)return"states["+n+"].left"}}function r(t){for(var r=n.equationConnections[0],e=u[0].states,a=0,o=e.length;a<o;a++)if(e[a].product===t)return a;return r.indexOf(t)}function e(r,e){if(!r||!r.rows||!r.columns)return"null";if(r===n.outputConnector)return"json.outputConnector";if(r===n.output)return"json.output";for(var u=0,a=n.hiddenLayers.length;u<a;u++){var o=n.hiddenLayers[u];for(var i in o)if(o.hasOwnProperty(i)&&o[i]===r)return"json.hiddenLayers["+u+"]."+i}return t(r,e)}for(var n=this.model,u=this.model.equations,a=this.inputSize,o=this.inputLookup,i=this.inputLookupLength,s=this.outputLookup,p=this.outputLookupLength,l=u[1],h=l.states,f=JSON.stringify(this.toJSON()),c=[],d={},g=[],v=0,y=h.length;v<y;v++){var b=h[v];c.push("states["+v+"] = {\n      name: '"+b.forwardFn.name+"',\n      left: "+e(b.left,v)+",\n      right: "+e(b.right,v)+",\n      product: "+e(b.product,v)+"\n    }");var m=b.forwardFn.name;d[m]||(d[m]=!0,g.push("        case '"+m+"':"+("forwardFn"!==m?" //compiled from "+function(t){return"src/recurrent/matrix/"+t.replace(/[A-Z]/g,function(t){return"-"+t.toLowerCase()})+".js"}(m):"")+"\n          "+function(t){return t=t.toString().split("{"),t.shift(),t=t.join("{"),t=t.split("}"),t.pop(),t.join("}").split("\n").join("\n        ").replace("product.weights = _input.weights = _this.inputValue;",o&&1===a?"product.weights = _i < input.length ? input[_i]: prevStates[prevStates.length - 1].product.weights;":1===a?"product.weights = [input[_i]];":"product.weights = input[_i];").replace("product.deltas[i] = 0;","").replace("product.deltas[column] = 0;","").replace("left.deltas[leftIndex] = 0;","").replace("right.deltas[rightIndex] = 0;","").replace("product.deltas = left.deltas.slice(0);","")}(b.forwardFn.toString())+"\n          break;"))}var k=1===this.inputSize&&this.outputLookup,_="\n  var input = "+(this.inputLookup?"lookupInput(rawInput)":"rawInput")+";\n  var json = "+f+";\n  var output = [];\n  var states = [];\n  var prevStates;\n  var state;\n  var max = "+(k?o===s?i:"input.length + "+(p-1):"input.length")+";\n  for (var _i = 0; _i < max; _i++) {\n    prevStates = states;\n    states = [];\n    "+c.join(";\n    ")+";\n    for (var stateIndex = 0, stateMax = "+c.length+"; stateIndex < stateMax; stateIndex++) {\n      state = states[stateIndex];\n      var product = state.product;\n      var left = state.left;\n      var right = state.right;\n      \n      switch (state.name) {\n"+g.join("\n")+"\n      }\n    }\n    "+(1===a&&o?"if (_i >= input.length - 1) { output.push(state.product.weights); }":"output = state.product.weights;")+"\n  }\n  "+(s?s===o?"return lookupOutputPartial(output, input)":"return lookupOutput(output)":1===a?"return output[0]":"return output")+";\n  "+function(){return o?1===a?o===s?"function lookupInput(input) {\n            var table = "+JSON.stringify(o)+";\n            var result = [];\n            for (var p in table) {\n              if (!input.hasOwnProperty(p)) break;\n              result.push(Float32Array.from([input[p]]));\n            }\n            return result;\n          }":"function lookupInput(input) {\n          var table = "+JSON.stringify(o)+";\n          var result = [];\n          for (var p in table) {\n            result.push(Float32Array.from([input[p]]));\n          }\n          return result;\n        }":"function lookupInput(rawInputs) {\n        var table = "+JSON.stringify(o)+";\n        var result = [];\n        for (var i = 0; i < rawInputs.length; i++) {\n          var rawInput = rawInputs[i];\n          var input = new Float32Array("+i+");\n          for (var p in table) {\n            input[table[p]] = rawInput.hasOwnProperty(p) ? rawInput[p] : 0;\n          }\n          result.push(input);\n        }\n        return result;\n      }":""}()+"\n  "+function(){return s?1===a?o===s?"function lookupOutputPartial(output, input) {\n            var table = "+JSON.stringify(s)+";\n            var offset = input.length;\n            var result = {};\n            var i = 0;\n            for (var p in table) {\n              if (i++ < offset) continue;\n              result[p] = output[table[p] - offset][0];\n            }\n            return result;\n          }":"function lookupOutput(output) {\n          var table = "+JSON.stringify(s)+";\n          var result = {};\n          for (var p in table) {\n            result[p] = output[table[p]][0];\n          }\n          return result;\n        }":"function lookupOutput(output) {\n        var table = "+JSON.stringify(s)+";\n        var result = {};\n        for (var p in table) {\n          result[p] = output[table[p]];\n        }\n        return result;\n      }":""}()+"\n  \n  function Matrix(rows, columns) {\n    this.rows = rows;\n    this.columns = columns;\n    this.weights = zeros(rows * columns);\n  }\n  "+_zeros2.default.toString()+"\n  "+_softmax2.default.toString().replace("_2.default","Matrix")+"\n  "+_random.randomF.toString()+"\n  "+_sampleI2.default.toString()+"\n  "+_maxI2.default.toString();return new Function("rawInput",_)}}]),r}(_rnn2.default);exports.default=RNNTimeStep,RNNTimeStep.defaults={inputSize:1,hiddenLayers:[20],outputSize:1,learningRate:.01,decayRate:.999,smoothEps:1e-8,regc:1e-6,clipval:5},RNNTimeStep.trainDefaults=_rnn2.default.trainDefaults;
...
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}function _inherits(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function t(t,e){for(var r=0;r<e.length;r++){var i=e[r];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}return function(e,r,i){return r&&t(e.prototype,r),i&&t(e,i),e}}(),_stream=require("stream"),_lookup=require("./lookup"),_lookup2=_interopRequireDefault(_lookup),TrainStream=function(t){function e(t){_classCallCheck(this,e);var r=_possibleConstructorReturn(this,(e.__proto__||Object.getPrototypeOf(e)).call(this,{objectMode:!0}));if(t=t||{},!t.neuralNetwork)throw new Error("no neural network specified");return r.neuralNetwork=t.neuralNetwork,r.dataFormatDetermined=!1,r.inputKeys=[],r.outputKeys=[],r.i=0,r.iterations=t.iterations||2e4,r.errorThresh=t.errorThresh||.005,r.log=!!t.log&&("function"==typeof t.log?t.log:console.log),r.logPeriod=t.logPeriod||10,r.callback=t.callback,r.callbackPeriod=t.callbackPeriod||10,r.floodCallback=t.floodCallback,r.doneTrainingCallback=t.doneTrainingCallback,r.size=0,r.count=0,r.sum=0,r.on("finish",r.finishStreamIteration.bind(r)),r}return _inherits(e,t),_createClass(e,[{key:"endInputs",value:function(){this.write(!1)}},{key:"_write",value:function(t,e,r){if(!t)return this.emit("finish"),r();if(!this.dataFormatDetermined)return this.size++,this.inputKeys=Array.from(new Set(this.inputKeys.concat(Object.keys(t.input)))),this.outputKeys=Array.from(new Set(this.outputKeys.concat(Object.keys(t.output)))),this.firstDatum=this.firstDatum||t,r();this.count++;var i=this.neuralNetwork.formatData(t);this.trainDatum(i[0]),r()}},{key:"trainDatum",value:function(t){this.sum+=this.neuralNetwork.trainPattern(t.input,t.output,!0)}},{key:"finishStreamIteration",value:function(){if(this.dataFormatDetermined&&this.size!==this.count&&this.log("This iteration's data length was different from the first."),!this.dataFormatDetermined){Array.isArray(this.firstDatum.input)||(this.neuralNetwork.inputLookup=_lookup2.default.lookupFromArray(this.inputKeys)),Array.isArray(this.firstDatum.output)||(this.neuralNetwork.outputLookup=_lookup2.default.lookupFromArray(this.outputKeys));var t=this.neuralNetwork.formatData(this.firstDatum);return this.neuralNetwork.verifyIsInitialized(t),this.dataFormatDetermined=!0,void("function"==typeof this.floodCallback&&this.floodCallback())}var e=this.sum/this.size;if(this.log&&this.i%this.logPeriod==0&&this.log("iterations:",this.i,"training error:",e),this.callback&&this.i%this.callbackPeriod==0&&this.callback({error:e,iterations:this.i}),this.sum=0,this.count=0,++this.i<this.iterations&&e>this.errorThresh){if("function"==typeof this.floodCallback)return this.floodCallback()}else if("function"==typeof this.doneTrainingCallback)return this.doneTrainingCallback({error:e,iterations:this.i})}}]),e}(_stream.Writable);exports.default=TrainStream;
