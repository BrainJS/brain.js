...
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _toConsumableArray(t){if(Array.isArray(t)){for(var e=0,i=Array(t.length);e<t.length;e++)i[e]=t[e];return i}return Array.from(t)}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function t(t,e){for(var i=0;i<e.length;i++){var r=e[i];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(t,r.key,r)}}return function(e,i,r){return i&&t(e.prototype,i),r&&t(e,r),e}}(),_lookup=require("./lookup"),_lookup2=_interopRequireDefault(_lookup),_trainStream=require("./train-stream"),_trainStream2=_interopRequireDefault(_trainStream),_max=require("./utilities/max"),_max2=_interopRequireDefault(_max),_mse=require("./utilities/mse"),_mse2=_interopRequireDefault(_mse),_randos=require("./utilities/randos"),_randos2=_interopRequireDefault(_randos),_range=require("./utilities/range"),_range2=_interopRequireDefault(_range),_toArray=require("./utilities/to-array"),_toArray2=_interopRequireDefault(_toArray),_zeros=require("./utilities/zeros"),_zeros2=_interopRequireDefault(_zeros),_thaw=require("thaw.js"),_thaw2=_interopRequireDefault(_thaw),NeuralNetwork=function(){function t(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};_classCallCheck(this,t),Object.assign(this,this.constructor.defaults,e),this.hiddenSizes=e.hiddenLayers,this.sizes=null,this.outputLayer=null,this.biases=null,this.weights=null,this.outputs=null,this.deltas=null,this.changes=null,this.errors=null,this.constructor.prototype.hasOwnProperty("runInput")||(this.runInput=null),this.constructor.prototype.hasOwnProperty("calculateDeltas")||(this.calculateDeltas=null)}return _createClass(t,null,[{key:"trainDefaults",get:function(){return{iterations:2e4,errorThresh:.005,log:!1,logPeriod:10,learningRate:.3,callback:null,callbackPeriod:10,trainTimeMs:-1/0}}},{key:"defaults",get:function(){return{learningRate:.3,momentum:.1,binaryThresh:.5,hiddenLayers:null,activation:"sigmoid"}}}]),_createClass(t,[{key:"initialize",value:function(t){var e=[],i=t[0].input.length,r=t[0].output.length,s=this.hiddenSizes;s?s.forEach(function(t){e.push(t)}):e.push(Math.max(3,Math.floor(i/2))),e.unshift(i),e.push(r),this.sizes=e,this.outputLayer=this.sizes.length-1,this.biases=[],this.weights=[],this.outputs=[],this.deltas=[],this.changes=[],this.errors=[];for(var a=0;a<=this.outputLayer;a++){var u=this.sizes[a];if(this.deltas[a]=(0,_zeros2.default)(u),this.errors[a]=(0,_zeros2.default)(u),this.outputs[a]=(0,_zeros2.default)(u),a>0){this.biases[a]=(0,_randos2.default)(u),this.weights[a]=new Array(u),this.changes[a]=new Array(u);for(var n=0;n<u;n++){var o=this.sizes[a-1];this.weights[a][n]=(0,_randos2.default)(o),this.changes[a][n]=(0,_zeros2.default)(o)}}}this.setActivation()}},{key:"setActivation",value:function(){switch(this.activation){case"sigmoid":this.runInput=this.runInput||this.runInputSigmoid,this.calculateDeltas=this.calculateDeltas||this.calculateDeltasSigmoid;break;case"relu":this.runInput=this.runInput||this.runInputRelu,this.calculateDeltas=this.calculateDeltas||this.calculateDeltasRelu;break;case"leaky-relu":this.runInput=this.runInput||this.runInputLeakyRelu,this.calculateDeltas=this.calculateDeltas||this.calculateDeltasLeakyRelu;break;case"tanh":this.runInput=this.runInput||this.runInputTanh,this.calculateDeltas=this.calculateDeltas||this.calculateDeltasTanh;break;default:throw new Error("unknown activation "+this.activation)}}},{key:"run",value:function(t){this.inputLookup&&(t=_lookup2.default.toArray(this.inputLookup,t));var e=[].concat(_toConsumableArray(this.runInput(t)));return this.outputLookup&&(e=_lookup2.default.toHash(this.outputLookup,e)),e}},{key:"runInputSigmoid",value:function(t){this.outputs[0]=t;for(var e=null,i=1;i<=this.outputLayer;i++){for(var r=0;r<this.sizes[i];r++){for(var s=this.weights[i][r],a=this.biases[i][r],u=0;u<s.length;u++)a+=s[u]*t[u];this.outputs[i][r]=1/(1+Math.exp(-a))}e=t=this.outputs[i]}return e}},{key:"runInputRelu",value:function(t){this.outputs[0]=t;for(var e=null,i=1;i<=this.outputLayer;i++){for(var r=0;r<this.sizes[i];r++){for(var s=this.weights[i][r],a=this.biases[i][r],u=0;u<s.length;u++)a+=s[u]*t[u];this.outputs[i][r]=a<0?0:a}e=t=this.outputs[i]}return e}},{key:"runInputLeakyRelu",value:function(t){this.outputs[0]=t;for(var e=null,i=1;i<=this.outputLayer;i++){for(var r=0;r<this.sizes[i];r++){for(var s=this.weights[i][r],a=this.biases[i][r],u=0;u<s.length;u++)a+=s[u]*t[u];this.outputs[i][r]=a<0?0:.01*a}e=t=this.outputs[i]}return e}},{key:"runInputTanh",value:function(t){this.outputs[0]=t;for(var e=null,i=1;i<=this.outputLayer;i++){for(var r=0;r<this.sizes[i];r++){for(var s=this.weights[i][r],a=this.biases[i][r],u=0;u<s.length;u++)a+=s[u]*t[u];this.outputs[i][r]=Math.tanh(a)}e=t=this.outputs[i]}return e}},{key:"train",value:function(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},i=Object.assign({},this.constructor.trainDefaults,e);t=this.formatData(t);var r=i.iterations,s=i.errorThresh,a=!0===i.log?console.log:i.log,u=i.logPeriod,n=e.learningRate||this.learningRate||i.learningRate,o=i.callback,h=i.callbackPeriod,l=Date.now()+i.trainTimeMs,p={error:1,iterations:0};for(null===this.sizes&&this.initialize(t);p.iterations<r&&p.error>s&&Date.now()>l;){p.iterations++;for(var c=0,f=0;f<t.length;++f)c+=this.trainPattern(t[f].input,t[f].output,n);p.error=c/t.length,a&&p.iterations%u==0&&a("iterations:",p.iterations,"training error:",p.error),o&&p.iterations%h==0&&o(JSON.parse(JSON.stringify(p)))}return p}},{key:"trainAsync",value:function(t){var e=this,i=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:function(){};"function"==typeof i&&(r=i,i={});var s=Object.assign({},this.constructor.trainDefaults,i);t=this.formatData(t);var a=s.iterations,u=s.errorThresh,n=!0===s.log?console.log:s.log,o=s.logPeriod,h=i.learningRate||this.learningRate||s.learningRate,l=s.callback,p=s.callbackPeriod,c=Date.now()+s.trainTimeMs,f={error:1,iterations:0};null===this.sizes&&this.initialize(t);var v=new Array(a),g=new _thaw2.default(v,{delay:!0,each:function(){f.iterations++;for(var i=0,r=0;r<t.length;++r)i+=e.trainPattern(t[r].input,t[r].output,h);f.error=i/t.length,n&&f.iterations%o==0&&n("iterations: "+f.iterations+" training error: "+f.error),l&&f.iterations%p==0&&l(JSON.parse(JSON.stringify(f))),(f.error<u||c>0&&Date.now()>c)&&g.stop()},done:function(){r&&"function"==typeof r&&r(f)}});g.tick()}},{key:"trainPattern",value:function(t,e,i){return i=i||this.learningRate,this.runInput(t),this.calculateDeltas(e),this.adjustWeights(i),(0,_mse2.default)(this.errors[this.outputLayer])}},{key:"calculateDeltasSigmoid",value:function(t){for(var e=this.outputLayer;e>=0;e--)for(var i=0;i<this.sizes[e];i++){var r=this.outputs[e][i],s=0;if(e===this.outputLayer)s=t[i]-r;else for(var a=this.deltas[e+1],u=0;u<a.length;u++)s+=a[u]*this.weights[e+1][u][i];this.errors[e][i]=s,this.deltas[e][i]=s*r*(1-r)}}},{key:"calculateDeltasRelu",value:function(t){for(var e=this.outputLayer;e>=0;e--)for(var i=0;i<this.sizes[e];i++){var r=this.outputs[e][i],s=0;if(e===this.outputLayer)s=t[i]-r;else for(var a=this.deltas[e+1],u=0;u<a.length;u++)s+=a[u]*this.weights[e+1][u][i];this.errors[e][i]=s,this.deltas[e][i]=r>0?s:0}}},{key:"calculateDeltasLeakyRelu",value:function(t){for(var e=this.outputLayer;e>=0;e--)for(var i=0;i<this.sizes[e];i++){var r=this.outputs[e][i],s=0;if(e===this.outputLayer)s=t[i]-r;else for(var a=this.deltas[e+1],u=0;u<a.length;u++)s+=a[u]*this.weights[e+1][u][i];this.errors[e][i]=s,this.deltas[e][i]=r>0?s:.01*s}}},{key:"calculateDeltasTanh",value:function(t){for(var e=this.outputLayer;e>=0;e--)for(var i=0;i<this.sizes[e];i++){var r=this.outputs[e][i],s=0;if(e===this.outputLayer)s=t[i]-r;else for(var a=this.deltas[e+1],u=0;u<a.length;u++)s+=a[u]*this.weights[e+1][u][i];this.errors[e][i]=s,this.deltas[e][i]=(1-r*r)*s}}},{key:"adjustWeights",value:function(t){for(var e=1;e<=this.outputLayer;e++)for(var i=this.outputs[e-1],r=0;r<this.sizes[e];r++){for(var s=this.deltas[e][r],a=0;a<i.length;a++){var u=this.changes[e][r][a];u=t*s*i[a]+this.momentum*u,this.changes[e][r][a]=u,this.weights[e][r][a]+=u}this.biases[e][r]+=t*s}}},{key:"formatData",value:function(t){var e=this;if(!Array.isArray(t)){var i=[];i.push(t),t=i}var r=t[0].input;return Array.isArray(r)||r instanceof Float32Array||(this.inputLookup||(this.inputLookup=_lookup2.default.buildLookup(t.map(function(t){return t.input}))),t=t.map(function(t){var i=_lookup2.default.toArray(e.inputLookup,t.input);return Object.assign({},t,{input:i})},this)),Array.isArray(t[0].output)||(this.outputLookup||(this.outputLookup=_lookup2.default.buildLookup(t.map(function(t){return t.output}))),t=t.map(function(t){var i=_lookup2.default.toArray(e.outputLookup,t.output);return Object.assign({},t,{output:i})},this)),t}},{key:"test",value:function(t){var e=this;t=this.formatData(t);for(var i=1===t[0].output.length,r=0,s=0,a=0,u=0,n=[],o=0,h=0;h<t.length;h++)!function(h){var l=e.runInput(t[h].input),p=t[h].output,c=void 0,f=void 0;if(i?(c=l[0]>e.binaryThresh?1:0,f=p[0]):(c=l.indexOf((0,_max2.default)(l)),f=p.indexOf((0,_max2.default)(p))),c!==f){var v=t[h];Object.assign(v,{actual:c,expected:f}),n.push(v)}i&&(0===c&&0===f?u++:1===c&&1===f?a++:0===c&&1===f?s++:1===c&&0===f&&r++);var g=l.map(function(t,e){return p[e]-t});o+=(0,_mse2.default)(g)}(h);var l=o/t.length,p={error:l,misclasses:n};return i&&Object.assign(p,{trueNeg:u,truePos:a,falseNeg:s,falsePos:r,total:t.length,precision:a/(a+r),recall:a/(a+s),accuracy:(u+a)/t.length}),p}},{key:"toJSON",value:function(){for(var t=[],e=0;e<=this.outputLayer;e++){t[e]={};var i=void 0;i=0===e&&this.inputLookup?Object.keys(this.inputLookup):e===this.outputLayer&&this.outputLookup?Object.keys(this.outputLookup):(0,_range2.default)(0,this.sizes[e]);for(var r=0;r<i.length;r++){var s=i[r];if(t[e][s]={},e>0){t[e][s].bias=this.biases[e][r],t[e][s].weights={};for(var a in t[e-1]){var u=a;1===e&&this.inputLookup&&(u=this.inputLookup[a]),t[e][s].weights[a]=this.weights[e][r][u]}}}}return{sizes:this.sizes,layers:t,outputLookup:!!this.outputLookup,inputLookup:!!this.inputLookup,activation:this.activation}}},{key:"fromJSON",value:function(t){this.initialize(t.sizes);for(var e=0;e<=this.outputLayer;e++){var i=t.layers[e];if(0!==e||i[0]&&!t.inputLookup?e!==this.outputLayer||i[0]&&!t.outputLookup||(this.outputLookup=_lookup2.default.lookupFromHash(i)):this.inputLookup=_lookup2.default.lookupFromHash(i),i>0){var r=Object.keys(i);this.sizes[e]=r.length;for(var s in r){var a=r[s];this.biases[e]=i[a].bias,this.weights[e][s]=(0,_toArray2.default)(i[a].weights)}}}return this.setActivation(),this}},{key:"toFunction",value:function(){function t(i,r,s){if(0===r)return"string"==typeof s?"input['"+s+"']":"input["+s+"]";var a=i[r],u=a[s],n=[u.bias];for(var o in u.weights)u.weights[o]<0?n.push(u.weights[o]+"*("+t(i,r-1,o)+")"):n.push("+"+u.weights[o]+"*("+t(i,r-1,o)+")");switch(e){case"sigmoid":return"1/(1+1/Math.exp("+n.join("")+"))";case"relu":return"var sum = "+n.join("")+";(sum < 0 ? 0 : sum);";case"leaky-relu":return"var sum = "+n.join("")+";(sum < 0 ? 0 : 0.01 * sum);";case"tanh":return"Math.tanh("+n.join("")+");";default:throw new Error("unknown activation type "+e)}}var e=this.activation,i=this.toJSON().layers,r=[],s=void 0;for(var a in i[i.length-1])r.push(t(i,i.length-1,a));return s=this.outputLookup?"{"+Object.keys(this.outputLookup).map(function(t,e){return"'"+t+"':"+r[e]})+"}":"["+r.join(",")+"]",new Function("input","return "+s)}},{key:"createTrainStream",value:function(t){return t=t||{},t.neuralNetwork=this,this.setActivation(),this.trainStream=new _trainStream2.default(t),this.trainStream}}]),t}();exports.default=NeuralNetwork;
