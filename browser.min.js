...
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function t(t,e){for(var r=0;r<e.length;r++){var i=e[r];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}return function(e,r,i){return r&&t(e.prototype,r),i&&t(e,i),e}}(),_lookup=require("./lookup"),_lookup2=_interopRequireDefault(_lookup),_trainStream=require("./train-stream"),_trainStream2=_interopRequireDefault(_trainStream),_max=require("./utilities/max"),_max2=_interopRequireDefault(_max),_mse=require("./utilities/mse"),_mse2=_interopRequireDefault(_mse),_randos=require("./utilities/randos"),_randos2=_interopRequireDefault(_randos),_range=require("./utilities/range"),_range2=_interopRequireDefault(_range),_toArray=require("./utilities/to-array"),_toArray2=_interopRequireDefault(_toArray),_zeros=require("./utilities/zeros"),_zeros2=_interopRequireDefault(_zeros),NeuralNetwork=function(){function t(e){_classCallCheck(this,t),e=e||{},this.learningRate=e.learningRate||.3,this.momentum=e.momentum||.1,this.hiddenSizes=e.hiddenLayers,this.binaryThresh=e.binaryThresh||.5,this.sizes=null,this.outputLayer=null,this.biases=null,this.weights=null,this.outputs=null,this.deltas=null,this.changes=null,this.errors=null}return _createClass(t,[{key:"initialize",value:function(t,e){this.sizes=t,this.outputLayer=this.sizes.length-1,e||(this.biases=[],this.weights=[],this.outputs=[]),this.deltas=[],this.changes=[],this.errors=[];for(var r=0;r<=this.outputLayer;r++){var i=this.sizes[r];if(this.deltas[r]=(0,_zeros2.default)(i),this.errors[r]=(0,_zeros2.default)(i),e||(this.outputs[r]=(0,_zeros2.default)(i)),r>0){this.biases[r]=(0,_randos2.default)(i),e||(this.weights[r]=new Array(i)),this.changes[r]=new Array(i);for(var u=0;u<i;u++){var a=this.sizes[r-1];e||(this.weights[r][u]=(0,_randos2.default)(a)),this.changes[r][u]=(0,_zeros2.default)(a)}}}}},{key:"run",value:function(t){this.inputLookup&&(t=_lookup2.default.toArray(this.inputLookup,t));var e=this.runInput(t);return this.outputLookup&&(e=_lookup2.default.toHash(this.outputLookup,e)),e}},{key:"runInput",value:function(t){this.outputs[0]=t;for(var e=null,r=1;r<=this.outputLayer;r++){for(var i=0;i<this.sizes[r];i++){for(var u=this.weights[r][i],a=this.biases[r][i],s=0;s<u.length;s++)a+=u[s]*t[s];this.outputs[r][i]=1/(1+Math.exp(-a))}e=t=this.outputs[r]}return e}},{key:"train",value:function(e){var r=arguments.length<=1||void 0===arguments[1]?{}:arguments[1],i=Object.assign({},t.trainDefaults,r);e=this.formatData(e);var u=i.iterations,a=i.errorThresh,s=i.log===!0?console.log:i.log,o=i.logPeriod,n=r.learningRate||this.learningRate||i.learningRate,h=i.callback,l=i.callbackPeriod,p=[],f=e[0].input.length,c=e[0].output.length,v=this.hiddenSizes;v?v.forEach(function(t){p.push(t)}):p.push(Math.max(3,Math.floor(f/2))),p.unshift(f),p.push(c),this.initialize(p,i.keepNetworkIntact);var d=1,g=void 0;for(g=0;g<u&&d>a;g++){for(var k=0,y=0;y<e.length;y++){var _=this.trainPattern(e[y].input,e[y].output,n);k+=_}d=k/e.length,s&&g%o==0&&s("iterations:",g,"training error:",d),h&&g%l==0&&h({error:d,iterations:g})}return{error:d,iterations:g}}},{key:"trainPattern",value:function(t,e,r){r=r||this.learningRate,this.runInput(t),this.calculateDeltas(e),this.adjustWeights(r);var i=(0,_mse2.default)(this.errors[this.outputLayer]);return i}},{key:"calculateDeltas",value:function(t){for(var e=this.outputLayer;e>=0;e--)for(var r=0;r<this.sizes[e];r++){var i=this.outputs[e][r],u=0;if(e==this.outputLayer)u=t[r]-i;else for(var a=this.deltas[e+1],s=0;s<a.length;s++)u+=a[s]*this.weights[e+1][s][r];this.errors[e][r]=u,this.deltas[e][r]=u*i*(1-i)}}},{key:"adjustWeights",value:function(t){for(var e=1;e<=this.outputLayer;e++)for(var r=this.outputs[e-1],i=0;i<this.sizes[e];i++){for(var u=this.deltas[e][i],a=0;a<r.length;a++){var s=this.changes[e][i][a];s=t*u*r[a]+this.momentum*s,this.changes[e][i][a]=s,this.weights[e][i][a]+=s}this.biases[e][i]+=t*u}}},{key:"formatData",value:function(t){var e=this;if(t.constructor!==Array){var r=[];r.push(t),t=r}var i=t[0].input;return i.constructor===Array||i instanceof Float64Array||(this.inputLookup||(this.inputLookup=_lookup2.default.buildLookup(t.map(function(t){return t.input}))),t=t.map(function(t){var r=_lookup2.default.toArray(e.inputLookup,t.input);return Object.assign({},t,{input:r})},this)),t[0].output.constructor!==Array&&(this.outputLookup||(this.outputLookup=_lookup2.default.buildLookup(t.map(function(t){return t.output}))),t=t.map(function(t){var r=_lookup2.default.toArray(e.outputLookup,t.output);return Object.assign({},t,{output:r})},this)),t}},{key:"test",value:function(t){var e=this;t=this.formatData(t);for(var r=1==t[0].output.length,i=0,u=0,a=0,s=0,o=[],n=0,h=function(h){var l=e.runInput(t[h].input),p=t[h].output,f=void 0,c=void 0;if(r?(f=l[0]>e.binaryThresh?1:0,c=p[0]):(f=l.indexOf((0,_max2.default)(l)),c=p.indexOf((0,_max2.default)(p))),f!=c){var v=t[h];Object.assign(v,{actual:f,expected:c}),o.push(v)}r&&(0==f&&0==c?s++:1==f&&1==c?a++:0==f&&1==c?u++:1==f&&0==c&&i++);var d=l.map(function(t,e){return p[e]-t});n+=(0,_mse2.default)(d)},l=0;l<t.length;l++)h(l);var p=n/t.length,f={error:p,misclasses:o};return r&&Object.assign(f,{trueNeg:s,truePos:a,falseNeg:u,falsePos:i,total:t.length,precision:a/(a+i),recall:a/(a+u),accuracy:(s+a)/t.length}),f}},{key:"toJSON",value:function(){for(var t=[],e=0;e<=this.outputLayer;e++){t[e]={};var r=void 0;r=0==e&&this.inputLookup?Object.keys(this.inputLookup):e==this.outputLayer&&this.outputLookup?Object.keys(this.outputLookup):(0,_range2.default)(0,this.sizes[e]);for(var i=0;i<r.length;i++){var u=r[i];if(t[e][u]={},e>0){t[e][u].bias=this.biases[e][i],t[e][u].weights={};for(var a in t[e-1]){var s=a;1==e&&this.inputLookup&&(s=this.inputLookup[a]),t[e][u].weights[a]=this.weights[e][i][s]}}}}return{layers:t,outputLookup:!!this.outputLookup,inputLookup:!!this.inputLookup}}},{key:"fromJSON",value:function(t){var e=t.layers.length;this.outputLayer=e-1,this.sizes=new Array(e),this.weights=new Array(e),this.biases=new Array(e),this.outputs=new Array(e);for(var r=0;r<=this.outputLayer;r++){var i=t.layers[r];0!=r||i[0]&&!t.inputLookup?r!=this.outputLayer||i[0]&&!t.outputLookup||(this.outputLookup=_lookup2.default.lookupFromHash(i)):this.inputLookup=_lookup2.default.lookupFromHash(i);var u=Object.keys(i);this.sizes[r]=u.length,this.weights[r]=[],this.biases[r]=[],this.outputs[r]=[];for(var a in u){var s=u[a];this.biases[r][a]=i[s].bias,this.weights[r][a]=(0,_toArray2.default)(i[s].weights)}}return this}},{key:"toFunction",value:function(){var t=this.toJSON(),e=JSON.stringify(t);return new Function("input","\n      var net = "+e+";\n      for (var i = 1; i < net.layers.length; i++) {\n        var layer = net.layers[i];\n        var output = {};\n        \n        for (var id in layer) {\n          var node = layer[id];\n          var sum = node.bias;\n          \n          for (var iid in node.weights) {\n            sum += node.weights[iid] * input[iid];\n          }\n          output[id] = (1 / (1 + Math.exp(-sum)));\n        }\n        input = output;\n      }\n      return output;\n    ")}},{key:"createTrainStream",value:function(t){return t=t||{},t.neuralNetwork=this,this.trainStream=new _trainStream2.default(t),this.trainStream}}]),t}();exports.default=NeuralNetwork,NeuralNetwork.trainDefaults={iterations:2e4,errorThresh:.005,log:!1,logPeriod:10,learningRate:.3,callback:null,callbackPeriod:10,keepNetworkIntact:!1};
...
"use strict";function addB(e,r,c){for(var u=0,n=e.recurrence.length;u<n;u++)r.recurrence[u]+=e.recurrence[u],c.recurrence[u]+=e.recurrence[u]}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=addB;

},{}],8:[function(require,module,exports){
"use strict";function add(e,t,s){for(var d=0,i=t.weights.length;d<i;d++)e.weights[d]=t.weights[d]+s.weights[d]}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=add;
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var u=t[r];u.enumerable=u.enumerable||!1,u.configurable=!0,"value"in u&&(u.writable=!0),Object.defineProperty(e,u.key,u)}}return function(t,r,u){return r&&e(t.prototype,r),u&&e(t,u),t}}(),_=require("./"),_2=_interopRequireDefault(_),_onesMatrix=require("./ones-matrix"),_onesMatrix2=_interopRequireDefault(_onesMatrix),_copy=require("./copy"),_copy2=_interopRequireDefault(_copy),_cloneNegative2=require("./clone-negative"),_cloneNegative3=_interopRequireDefault(_cloneNegative2),_add2=require("./add"),_add3=_interopRequireDefault(_add2),_addB=require("./add-b"),_addB2=_interopRequireDefault(_addB),_allOnes2=require("./all-ones"),_allOnes3=_interopRequireDefault(_allOnes2),_multiply2=require("./multiply"),_multiply3=_interopRequireDefault(_multiply2),_multiplyB=require("./multiply-b"),_multiplyB2=_interopRequireDefault(_multiplyB),_multiplyElement2=require("./multiply-element"),_multiplyElement3=_interopRequireDefault(_multiplyElement2),_multiplyElementB=require("./multiply-element-b"),_multiplyElementB2=_interopRequireDefault(_multiplyElementB),_relu2=require("./relu"),_relu3=_interopRequireDefault(_relu2),_reluB=require("./relu-b"),_reluB2=_interopRequireDefault(_reluB),_rowPluck=require("./row-pluck"),_rowPluck2=_interopRequireDefault(_rowPluck),_rowPluckB=require("./row-pluck-b"),_rowPluckB2=_interopRequireDefault(_rowPluckB),_sigmoid2=require("./sigmoid"),_sigmoid3=_interopRequireDefault(_sigmoid2),_sigmoidB=require("./sigmoid-b"),_sigmoidB2=_interopRequireDefault(_sigmoidB),_tanh2=require("./tanh"),_tanh3=_interopRequireDefault(_tanh2),_tanhB=require("./tanh-b"),_tanhB2=_interopRequireDefault(_tanhB),Equation=function(){function e(){_classCallCheck(this,e),this.inputRow=0,this.states=[],this.previousResults=[],this.previousResultInputs=[],this.allMatrices=[]}return _createClass(e,[{key:"add",value:function(e,t){if(e.weights.length!==t.weights.length)throw new Error("misaligned matrices");var r=new _2.default(e.rows,e.columns);return this.allMatrices.push(r),this.states.push({left:e,right:t,product:r,forwardFn:_add3.default,backpropagationFn:_addB2.default}),r}},{key:"allOnes",value:function(e,t){var r=new _2.default(e,t);return this.allMatrices.push(r),this.states.push({left:r,product:r,forwardFn:_allOnes3.default}),r}},{key:"cloneNegative",value:function(e){var t=new _2.default(e.rows,e.columns);return this.allMatrices.push(t),this.states.push({left:e,product:t,forwardFn:_cloneNegative3.default}),t}},{key:"subtract",value:function(e,t){if(e.weights.length!==t.weights.length)throw new Error("misaligned matrices");return this.add(this.add(this.allOnes(e.rows,e.columns),this.cloneNegative(e)),t)}},{key:"multiply",value:function(e,t){if(e.columns!==t.rows)throw new Error("misaligned matrices");var r=new _2.default(e.rows,t.columns);return this.allMatrices.push(r),this.states.push({left:e,right:t,product:r,forwardFn:_multiply3.default,backpropagationFn:_multiplyB2.default}),r}},{key:"multiplyElement",value:function(e,t){if(e.weights.length!==t.weights.length)throw new Error("misaligned matrices");var r=new _2.default(e.rows,e.columns);return this.allMatrices.push(r),this.states.push({left:e,right:t,product:r,forwardFn:_multiplyElement3.default,backpropagationFn:_multiplyElementB2.default}),r}},{key:"relu",value:function(e){var t=new _2.default(e.rows,e.columns);return this.allMatrices.push(t),this.states.push({left:e,product:t,forwardFn:_relu3.default,backpropagationFn:_reluB2.default}),t}},{key:"inputMatrixToRow",value:function(e){var t=this,r=new _2.default(e.columns,1);return this.allMatrices.push(r),this.states.push({left:e,get right(){return t.inputRow},product:r,forwardFn:_rowPluck2.default,backpropagationFn:_rowPluckB2.default}),r}},{key:"sigmoid",value:function(e){var t=new _2.default(e.rows,e.columns);return this.allMatrices.push(t),this.states.push({left:e,product:t,forwardFn:_sigmoid3.default,backpropagationFn:_sigmoidB2.default}),t}},{key:"tanh",value:function(e){var t=new _2.default(e.rows,e.columns);return this.allMatrices.push(t),this.states.push({left:e,product:t,forwardFn:_tanh3.default,backpropagationFn:_tanhB2.default}),t}},{key:"observe",value:function(e){var t=0,r=0;return this.states.push({forwardFn:function(){t++},backpropagationFn:function(){r++}}),e}},{key:"run",value:function(){var e=arguments.length<=0||void 0===arguments[0]?0:arguments[0];this.inputRow=e;for(var t=void 0,r=0,u=this.states.length;r<u;r++)t=this.states[r],t.hasOwnProperty("forwardFn")&&t.forwardFn(t.product,t.left,t.right);return t.product}},{key:"runBackpropagate",value:function(){var e=arguments.length<=0||void 0===arguments[0]?0:arguments[0];this.inputRow=e;for(var t=this.states.length,r=void 0;t-- >0;)r=this.states[t],r.hasOwnProperty("backpropagationFn")&&r.backpropagationFn(r.product,r.left,r.right);return r.product}}]),e}();exports.default=Equation;
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var s=t[r];s.enumerable=s.enumerable||!1,s.configurable=!0,"value"in s&&(s.writable=!0),Object.defineProperty(e,s.key,s)}}return function(t,r,s){return r&&e(t.prototype,r),s&&e(t,s),t}}(),_zeros=require("../../utilities/zeros"),_zeros2=_interopRequireDefault(_zeros),Matrix=function(){function e(t,r){_classCallCheck(this,e),void 0!==t&&void 0!==r&&(this.rows=t,this.columns=r,this.weights=(0,_zeros2.default)(t*r),this.recurrence=(0,_zeros2.default)(t*r))}return _createClass(e,[{key:"getWeights",value:function(e,t){var r=this.columns*e+t;if(r<0&&r>=this.weights.length)throw new Error("get accessor is skewed");return this.weights[r]}},{key:"setWeight",value:function(e,t,r){var s=this.columns*e+t;if(s<0&&s>=this.weights.length)throw new Error("set accessor is skewed");this.weights[s]=r}},{key:"setRecurrence",value:function(e,t,r){var s=this.columns*e+t;if(s<0&&s>=this.weights.length)throw new Error("set accessor is skewed");this.recurrence[s]=r}},{key:"toJSON",value:function(){return{rows:this.rows,columns:this.columns,weights:this.weights.slice(0)}}}],[{key:"fromJSON",value:function(t){for(var r=new e(t.rows,t.columns),s=0,n=t.rows*t.columns;s<n;s++)r.weights[s]=t.weights[s];return r}},{key:"fromArray",value:function(t,r){var s=t.length,n=t[0].length,i=new e(s,n);r=r||t;for(var o=0;o<s;o++)for(var u=t[o],c=r[o],a=0;a<n;a++)i.setWeight(o,a,u[a]),i.setRecurrence(o,a,c[a]);return i}}]),e}();exports.default=Matrix;
...
"use strict";function multiplyElement(e,t,l){for(var i=0,s=t.weights.length;i<s;i++)e.weights[i]=t.weights[i]*l.weights[i]}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=multiplyElement;

},{}],18:[function(require,module,exports){
"use strict";function multiply(e,r,t){for(var o=r.rows,s=r.columns,l=t.columns,u=0;u<o;u++)for(var i=0;i<l;i++){for(var a=0,f=0;f<s;f++)a+=r.weights[s*u+f]*t.weights[l*f+i];var c=l*u+i;e.weights[c]=a}}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=multiply;
...
"use strict";function reluB(e,r){for(var t=0,u=e.recurrence.length;t<u;t++)r.recurrence[t]+=r.weights[t]>0?e.recurrence[t]:0}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=reluB;

},{}],22:[function(require,module,exports){
"use strict";function relu(e,t){for(var r=0,s=t.weights.length;r<s;r++)e.weights[r]=Math.max(0,t.weights[r])}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=relu;
...
"use strict";function rowPluck(e,t,o){for(var r=0,s=t.columns;r<s;r++)e.weights[r]=t.weights[s*o+r]}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=rowPluck;

},{}],25:[function(require,module,exports){
"use strict";function sampleI(r){var e=randomF(0,1),a=0,o=0,t=r.weights;if(isNaN(t[0]))throw new Error("NaN");for(;;){if(a+=t[o],a>e)return o;o++}}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=sampleI;var _random=require("../../utilities/random"),randomF=_random.randomF;

},{"../../utilities/random":37}],26:[function(require,module,exports){
"use strict";function sigmoidB(e,r){for(var t=0,c=e.recurrence.length;t<c;t++){var i=e.weights[t];r.recurrence[t]+=i*(1-i)*e.recurrence[t]}}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=sigmoidB;

},{}],27:[function(require,module,exports){
"use strict";function sigmoid(e,t){for(var i=0,s=t.weights.length;i<s;i++)e.weights[i]=1/(1+Math.exp(-t.weights[i]))}function sig(e){return 1/(1+Math.exp(-e))}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=sigmoid;

},{}],28:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function softmax(e){var t=new _2.default(e.rows,e.columns),r=-999999,i=void 0,o=e.weights.length;for(i=0;i<o;i++)e.weights[i]>r&&(r=e.weights[i]);var s=0;for(i=0;i<o;i++)t.weights[i]=Math.exp(e.weights[i]-r),s+=t.weights[i];for(i=0;i<o;i++)t.weights[i]/=s;return t}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=softmax;var _=require("./"),_2=_interopRequireDefault(_);

},{"./":13}],29:[function(require,module,exports){
"use strict";function tanhB(e,r){for(var t=0,c=e.recurrence.length;t<c;t++){var n=e.weights[t];r.recurrence[t]+=(1-n*n)*e.recurrence[t]}}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=tanhB;

},{}],30:[function(require,module,exports){
"use strict";function tanh(t,e){for(var h=0,s=e.weights.length;h<s;h++)t.weights[h]=Math.tanh(e.weights[h])}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=tanh;

},{}],31:[function(require,module,exports){
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function t(t,e){for(var n=0;n<e.length;n++){var r=e[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(t,r.key,r)}}return function(e,n,r){return n&&t(e.prototype,n),r&&t(e,r),e}}(),_lookup=require("../lookup"),_lookup2=_interopRequireDefault(_lookup),_matrix=require("./matrix"),_matrix2=_interopRequireDefault(_matrix),_randomMatrix=require("./matrix/random-matrix"),_randomMatrix2=_interopRequireDefault(_randomMatrix),_equation=require("./matrix/equation"),_equation2=_interopRequireDefault(_equation),_sampleI=require("./matrix/sample-i"),_sampleI2=_interopRequireDefault(_sampleI),_maxI=require("./matrix/max-i"),_maxI2=_interopRequireDefault(_maxI),_softmax=require("./matrix/softmax"),_softmax2=_interopRequireDefault(_softmax),_copy=require("./matrix/copy"),_copy2=_interopRequireDefault(_copy),_random=require("../utilities/random"),_zeros=require("../utilities/zeros"),_zeros2=_interopRequireDefault(_zeros),_vocab=require("../utilities/vocab"),_vocab2=_interopRequireDefault(_vocab),RNN=function(){function t(){var e=arguments.length<=0||void 0===arguments[0]?{}:arguments[0];_classCallCheck(this,t);var n=t.defaults;for(var r in n)n.hasOwnProperty(r)&&(this[r]=e.hasOwnProperty(r)?e[r]:n[r]);this.stepCache={},this.runs=0,this.totalPerplexity=null,this.totalCost=null,this.ratioClipped=null,this.model=null,this.inputLookup=null,this.outputLookup=null,this.initialize()}return _createClass(t,[{key:"initialize",value:function(){this.model={input:null,hiddenLayers:[],output:null,equations:[],allMatrices:[],equationConnections:[],outputMatrixIndex:-1},null!==this.vocab&&(this.inputSize=this.inputRange=this.outputSize=this.vocab.characters.length),this.json?this.fromJSON(this.json):this.mapModel()}},{key:"createHiddenLayers",value:function(){var t=this.hiddenSizes,e=this.model,n=e.hiddenLayers;n.push(this.getModel(t[0],this.inputSize));for(var r=t[0],i=1;i<t.length;i++){var a=t[i];n.push(this.getModel(a,r)),r=a}}},{key:"getModel",value:function(t,e){return{weight:new _randomMatrix2.default(t,e,.08),transition:new _randomMatrix2.default(t,t,.08),bias:new _matrix2.default(t,1)}}},{key:"getEquation",value:function(t,e,n,r){var i=t.relu.bind(t),a=t.add.bind(t),o=t.multiply.bind(t);return i(a(a(o(r.weight,e),o(r.transition,n)),r.bias))}},{key:"createInputMatrix",value:function(){this.model.input=new _randomMatrix2.default(this.inputRange+1,this.inputSize,.08)}},{key:"createOutputMatrix",value:function(){var t=this.model,e=this.outputSize,n=this.hiddenSizes[this.hiddenSizes.length-1];t.outputConnector=new _randomMatrix2.default(e+1,n,.08),t.output=new _matrix2.default(e+1,1)}},{key:"bindEquation",value:function(){var t=this.model,e=this.hiddenSizes,n=t.hiddenLayers,r=new _equation2.default,i=[],a=t.equationConnections.length>0?t.equationConnections[t.equationConnections.length-1]:e.map(function(t){return new _matrix2.default(e[0],1)}),o=this.getEquation(r,r.inputMatrixToRow(t.input),a[0],n[0]);i.push(o);for(var u=1,s=e.length;u<s;u++)o=this.getEquation(r,o,a[u],n[u]),i.push(o);t.equationConnections.push(i),r.add(r.multiply(t.outputConnector,o),t.output),t.allMatrices=t.allMatrices.concat(r.allMatrices),t.equations.push(r)}},{key:"mapModel",value:function(){var t=this.model,e=t.hiddenLayers,n=t.allMatrices;if(this.createInputMatrix(),!t.input)throw new Error("net.model.input not set");if(n.push(t.input),this.createHiddenLayers(),!t.hiddenLayers.length)throw new Error("net.hiddenLayers not set");for(var r=0,i=e.length;r<i;r++){var a=e[r];for(var o in a)a.hasOwnProperty(o)&&n.push(a[o])}if(this.createOutputMatrix(),!t.outputConnector)throw new Error("net.model.outputConnector not set");if(!t.output)throw new Error("net.model.output not set");n.push(t.outputConnector),t.outputMatrixIndex=n.length,n.push(t.output)}},{key:"trainPattern",value:function(t){var e=arguments.length<=1||void 0===arguments[1]?null:arguments[1],n=this.runInput(t);return this.runBackpropagate(t),this.step(e),n}},{key:"runInput",value:function(t){this.runs++;for(var e=this.model,n=t.length,r=0,i=0,a=void 0;e.equations.length<=t.length+1;)this.bindEquation();for(var o=-1,u=t.length;o<u;o++){a=e.equations[o+1];var s=o===-1?0:t[o]+1,l=o===n-1?0:t[o+1]+1,h=a.run(s),p=h,c=(0,_softmax2.default)(h);r+=-Math.log2(c.weights[l]),i+=-Math.log(c.weights[l]),p.recurrence=c.weights,p.recurrence[l]-=1}return this.totalCost=i,this.totalPerplexity=Math.pow(2,r/(n-1))}},{key:"runBackpropagate",value:function(t){for(var e=t.length,n=this.model,r=n.equations;e>0;)r[e].runBackpropagate(t[e-1]+1),e--;r[0].runBackpropagate(0)}},{key:"step",value:function(){for(var t=(arguments.length<=0||void 0===arguments[0]?null:arguments[0],this.learningRate),e=this.regc,n=this.clipval,r=this.model,i=0,a=0,o=r.allMatrices,u=r.outputMatrixIndex,s=o.length,l=0;l<s;l++){var h=o[l];l in this.stepCache||(this.stepCache[l]=new _matrix2.default(h.rows,h.columns));var p=this.stepCache[l];if(l>u)for(var c=0,f=h.weights.length;c<f;c++)h.weights[c]=0,h.recurrence[c]=0;else for(var d=0,v=h.weights.length;d<v;d++){var m=h.recurrence[d];p.weights[d]=p.weights[d]*this.decayRate+(1-this.decayRate)*m*m,m>n&&(m=n,i++),m<-n&&(m=-n,i++),a++,h.weights[d]=h.weights[d]+-t*m/Math.sqrt(p.weights[d]+this.smoothEps)-e*h.weights[d],h.recurrence[d]=0}}this.ratioClipped=i/a}},{key:"run",value:function(){for(var t=arguments.length<=0||void 0===arguments[0]?[]:arguments[0],e=arguments.length<=1||void 0===arguments[1]?100:arguments[1],n=!(arguments.length<=2||void 0===arguments[2])&&arguments[2],r=arguments.length<=3||void 0===arguments[3]?1:arguments[3],i=this.formatDataIn(t),a=this.model,o=[],u=0;a.equations.length<e;)this.bindEquation();for(;;){var s=0===u?0:u<i.length?i[u-1]+1:o[u-1],l=a.equations[u],h=l.run(s),p=new _matrix2.default(a.output.rows,a.output.columns);if((0,_copy2.default)(p,h),1!==r&&n)for(var c=0,f=p.weights.length;c<f;c++)p.weights[c]/=r;var d=(0,_softmax2.default)(p),v=n?(0,_sampleI2.default)(d):(0,_maxI2.default)(d);if(u++,0===v)break;if(u>=e)break;o.push(v)}return this.formatDataOut(i,o.slice(i.length).map(function(t){return t-1}))}},{key:"train",value:function(e){var n=arguments.length<=1||void 0===arguments[1]?{}:arguments[1];n=Object.assign({},t.trainDefaults,n);var r=n.iterations,i=n.errorThresh,a=n.log===!0?console.log:n.log,o=n.logPeriod,u=n.learningRate||this.learningRate,s=n.callback,l=n.callbackPeriod,h=1,p=void 0;for(this.hasOwnProperty("setupData")&&(e=this.setupData(e)),n.keepNetworkIntact||this.initialize(),p=0;p<r&&h>i;p++){for(var c=0,f=0;f<e.length;f++){var d=this.trainPattern(e[f],u);c+=d}if(h=c/e.length,isNaN(h))throw new Error("network error rate is unexpected NaN, check network configurations and try again");a&&p%o==0&&a("iterations:",p,"training error:",h),s&&p%l==0&&s({error:h,iterations:p})}return{error:h,iterations:p}}},{key:"test",value:function(t){throw new Error("not yet implemented")}},{key:"toJSON",value:function(){var e=t.defaults,n=this.model,r={};for(var i in e)r[i]=this[i];return{type:this.constructor.name,options:r,input:n.input.toJSON(),hiddenLayers:n.hiddenLayers.map(function(t){var e={};for(var n in t)e[n]=t[n].toJSON();return e}),outputConnector:this.model.outputConnector.toJSON(),output:this.model.output.toJSON()}}},{key:"toJSONString",value:function(){return JSON.stringify(this.toJSON())}},{key:"fromJSON",value:function(e){this.json=e;var n=t.defaults,r=this.model,i=e.options,a=r.allMatrices;r.input=_matrix2.default.fromJSON(e.input),a.push(r.input),r.hiddenLayers=e.hiddenLayers.map(function(t){var e={};for(var n in t)e[n]=_matrix2.default.fromJSON(t[n]),a.push(e[n]);return e}),r.outputConnector=_matrix2.default.fromJSON(e.outputConnector),r.output=_matrix2.default.fromJSON(e.output),a.push(r.outputConnector),r.outputMatrixIndex=a.length,a.push(r.output);for(var o in n)n.hasOwnProperty(o)&&(this[o]=i.hasOwnProperty(o)?i[o]:n[o]);i.hasOwnProperty("vocab")&&null!==i.vocab&&(this.vocab=_vocab2.default.fromJSON(i.vocab),delete i.vocab),this.bindEquation()}},{key:"fromJSONString",value:function(t){return this.fromJSON(JSON.parse(t))}},{key:"toFunction",value:function(){function t(t,n){for(var r=0,i=s.length;r<i;r++){var a=s[r];if(r===n){var o=e(t);switch(t){case a.left:if(o>-1)return"typeof prevStates["+o+"] === 'object' ? prevStates["+o+"].product : new Matrix("+t.rows+", "+t.columns+")";case a.right:if(o>-1)return"typeof prevStates["+o+"] === 'object' ? prevStates["+o+"].product : new Matrix("+t.rows+", "+t.columns+")";case a.product:return"new Matrix("+t.rows+", "+t.columns+")";default:throw Error("unknown state")}}if(t===a.product)return"states["+r+"].product";if(t===a.right)return"states["+r+"].right";if(t===a.left)return"states["+r+"].left"}}function e(t){for(var e=a.equationConnections[0],n=o[0].states,r=0,i=n.length;r<i;r++)if(n[r].product===t)return r;return e.indexOf(t)}function n(e,n){if(!e||!e.rows||!e.columns)return"null";if(e===a.input)return"json.input";if(e===a.outputConnector)return"json.outputConnector";if(e===a.output)return"json.output";for(var r=0,i=a.hiddenLayers.length;r<i;r++){var o=a.hiddenLayers[r];for(var u in o)if(o.hasOwnProperty(u)&&o[u]===e)return"json.hiddenLayers["+r+"]."+u}return t(e,n)}function r(t){return t=t.toString().split("{"),t.shift(),t=t.join("{"),t=t.split("}"),t.pop(),t.join("}").split("\n").join("\n        ")}function i(t){return"src/recurrent/matrix/"+t.replace(/[A-Z]/g,function(t){return"-"+t.toLowerCase()})+".js"}for(var a=this.model,o=this.model.equations,u=o[1],s=u.states,l=JSON.stringify(this.toJSON()),h=[],p={},c=[],f=0,d=s.length;f<d;f++){var v=s[f];h.push("states["+f+"] = {\n      name: '"+v.forwardFn.name+"',\n      left: "+n(v.left,f)+",\n      right: "+n(v.right,f)+",\n      product: "+n(v.product,f)+"\n    }");var m=v.forwardFn.name;p[m]||(p[m]=!0,c.push("        case '"+m+"': //compiled from "+i(m)+"\n          "+r(v.forwardFn.toString())+"\n          break;"))}return new Function("input","maxPredictionLength","isSampleI","temperature","\n  if (typeof input === 'undefined') input = [];\n  if (typeof maxPredictionLength === 'undefined') maxPredictionLength = 100;\n  if (typeof isSampleI === 'undefined') isSampleI = false;\n  if (typeof temperature === 'undefined') temperature = 1;\n  \n  "+(null!==this.vocab&&"function"==typeof this.formatDataIn?"input = formatDataIn(input);":"")+"\n        \n  var json = "+l+";\n  var _i = 0;\n  var output = [];\n  var states = [];\n  var prevStates;\n  while (true) {\n    var previousIndex = (_i === 0\n        ? 0\n        : _i < input.length\n          ? input[_i - 1] + 1\n          : output[_i - 1])\n          ;\n    var rowPluckIndex = previousIndex;\n    prevStates = states;\n    states = [];\n    "+h.join(";\n    ")+";\n    for (var stateIndex = 0, stateMax = "+h.length+"; stateIndex < stateMax; stateIndex++) {\n      var state = states[stateIndex];\n      var product = state.product;\n      var left = state.left;\n      var right = state.right;\n      \n      switch (state.name) {\n"+c.join("\n")+"\n      }\n    }\n    \n    var logProbabilities = state.product;\n    if (temperature !== 1 && isSampleI) {\n      for (var q = 0, nq = logProbabilities.weights.length; q < nq; q++) {\n        logProbabilities.weights[q] /= temperature;\n      }\n    }\n\n    var probs = softmax(logProbabilities);\n    var nextIndex = isSampleI ? sampleI(probs) : maxI(probs);\n    \n    _i++;\n    if (nextIndex === 0) {\n      break;\n    }\n    if (_i >= maxPredictionLength) {\n      break;\n    }\n\n    output.push(nextIndex);\n  }\n  "+(null!==this.vocab&&"function"==typeof this.formatDataOut?"return formatDataOut(output.slice(input.length).map(function(value) { return value - 1; }))":"return output.slice(input.length).map(function(value) { return value - 1; })")+";\n  \n  function Matrix(rows, columns) {\n    this.rows = rows;\n    this.columns = columns;\n    this.weights = zeros(rows * columns);\n    this.recurrence = zeros(rows * columns);\n  }\n  "+(null!==this.vocab&&"function"==typeof this.formatDataIn?"function formatDataIn(input, output) { "+r(this.formatDataIn.toString()).replace("this.vocab","json.options.vocab")+" }":"")+"\n  "+(null!==this.vocab&&"function"==typeof this.formatDataOut?"function formatDataOut(output) { "+r(this.formatDataIn.toString()).replace("this.vocab","json.options.vocab")+" }":"")+"\n  "+(null!==this.vocab?this.vocab.toFunctionString("json.options.vocab"):"")+"\n  "+_zeros2.default.toString()+"\n  "+_softmax2.default.toString().replace("_2.default","Matrix")+"\n  "+_random.randomF.toString()+"\n  "+_sampleI2.default.toString()+"\n  "+_maxI2.default.toString())}}]),t}();exports.default=RNN,RNN.defaults={inputSize:20,inputRange:20,hiddenSizes:[20,20],outputSize:20,learningRate:.01,decayRate:.999,smoothEps:1e-8,regc:1e-6,clipval:5,json:null,setupData:function(t){if(!t[0].hasOwnProperty("input")||!t[0].hasOwnProperty("output"))return t;for(var e=[],n=0;n<t.length;n++)e=e.concat(t[n].input,t[n].output);this.vocab=_vocab2.default.fromArrayInputOutput(e);for(var r=[],i=0,a=t.length;i<a;i++)r.push(this.formatDataIn(t[i].input,t[i].output));return r},formatDataIn:function(t){var e=arguments.length<=1||void 0===arguments[1]?null:arguments[1];return null!==this.vocab?this.vocab.indexTable.hasOwnProperty("stop-input")?this.vocab.toIndexesInputOutput(t,e):this.vocab.toIndexes(t):t},formatDataOut:function(t,e){return null!==this.vocab?this.vocab.toCharacters(e).join(""):e},vocab:null},RNN.trainDefaults={iterations:2e4,errorThresh:.005,log:!1,logPeriod:10,learningRate:.3,callback:null,callbackPeriod:10,keepNetworkIntact:!1};
...
"use strict";function _toConsumableArray(t){if(Array.isArray(t)){for(var e=0,r=Array(t.length);e<t.length;e++)r[e]=t[e];return r}return Array.from(t)}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function t(t,e){for(var r=0;r<e.length;r++){var a=e[r];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(t,a.key,a)}}return function(e,r,a){return r&&t(e.prototype,r),a&&t(e,a),e}}(),Vocab=function(){function t(e){var r=arguments.length<=1||void 0===arguments[1]?0:arguments[1];_classCallCheck(this,t),void 0!==e&&(this.values=e,this.indexTable={},this.characterTable={},this.characters=[],this.buildCharactersFromIterable(e),this.buildTables(r))}return _createClass(t,[{key:"buildCharactersFromIterable",value:function(t){for(var e={},r=0,a=t.length;r<a;r++){var n=t[r];if(n.hasOwnProperty("length"))for(var i=0,o=n.length;i<o;i++){var u=n[i];e.hasOwnProperty(u)||(e[u]=!0,this.characters.push(u))}else{var l=t[r];if(e.hasOwnProperty(l))continue;e[r]=!0,this.characters.push(l)}}}},{key:"buildTables",value:function(t){for(var e=this.characters.length,r=0;r<e;r++){var a=this.characters[r];r>=t&&(this.indexTable[a]=r,this.characterTable[r]=a)}}},{key:"toIndexes",value:function(t){for(var e=arguments.length<=1||void 0===arguments[1]?0:arguments[1],r=[],a=this.indexTable,n=0,i=t.length;n<i;n++){var o=t[n],u=a[o];if(void 0===u)throw new Error('unrecognized character "'+o+'"');u<e||r.push(u)}return r}},{key:"toIndexesInputOutput",value:function(t){var e=arguments.length<=1||void 0===arguments[1]?null:arguments[1],r=arguments.length<=2||void 0===arguments[2]?0:arguments[2],a=void 0;return a="string"==typeof t?this.toIndexes(t.split("").concat(["stop-input","start-output"]),r):this.toIndexes(t.concat(["stop-input","start-output"]),r),null===e?a:"string"==typeof e?a.concat(this.toIndexes(e.split(""),r)):a.concat(this.toIndexes(e,r))}},{key:"toCharacters",value:function(t){for(var e=arguments.length<=1||void 0===arguments[1]?0:arguments[1],r=[],a=this.characterTable,n=0,i=t.length;n<i;n++){var o=t[n];if(!(o<e)){var u=a[o];if(void 0===u)throw new Error('unrecognized index "'+o+'"');r.push(u)}}return r}},{key:"toString",value:function(t,e){return this.toCharacters(t,e).join("")}},{key:"addSpecial",value:function(t){var e=this.indexTable[t]=this.characters.length;this.characterTable[e]=t,this.characters.push(t)}},{key:"toFunctionString",value:function(t){return"\n"+this.toIndexes.toString().replace("this",t)+"\n"+this.toIndexesInputOutput.toString().replace("this",t)+"\n"+this.toCharacters.toString().replace("this",t)+"\n"}}],[{key:"allPrintable",value:function(e){for(var r=arguments.length<=1||void 0===arguments[1]?["\n"]:arguments[1],a=32;a<=126;a++)r.push(String.fromCharCode(a));return new t(r,e)}},{key:"allPrintableInputOutput",value:function(e){var r=arguments.length<=1||void 0===arguments[1]?["\n"]:arguments[1],a=t.allPrintable(e,r);return a.addSpecial("stop-input"),a.addSpecial("start-output"),a}},{key:"fromStringInputOutput",value:function(e,r){var a,n=(a=String.prototype).concat.apply(a,_toConsumableArray(new Set(e))),i=new t(n,r);return i.addSpecial("stop-input"),i.addSpecial("start-output"),i}},{key:"fromArrayInputOutput",value:function(e,r){var a=new t(e.filter(function(t,e,r){return r.indexOf(t)===e}).sort(),r);return a.addSpecial("stop-input"),a.addSpecial("start-output"),a}},{key:"fromString",value:function(e,r){var a,n=(a=String.prototype).concat.apply(a,_toConsumableArray(new Set(e)));return new t(n,r)}},{key:"fromJSON",value:function(e){var r=new t;return r.indexTable=e.indexTable,r.characterTable=e.characterTable,r.values=e.values,r.characters=e.characters,r}}]),t}();exports.default=Vocab;
