...
"use strict";function _classCallCheck(r,t){if(!(r instanceof t))throw new TypeError("Cannot call a class as a function")}function getTypedArrayFn(r,t){if(r.buffer instanceof ArrayBuffer)return null;if(Array.isArray(r))return function(r){return Float32Array.from(r)};var n=Object.keys(t).length;return function(r){var e=new Float32Array(n);for(var u in t)e[t[u]]=r[u]||0;return e}}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function r(r,t){for(var n=0;n<t.length;n++){var e=t[n];e.enumerable=e.enumerable||!1,e.configurable=!0,"value"in e&&(e.writable=!0),Object.defineProperty(r,e.key,e)}}return function(t,n,e){return n&&r(t.prototype,n),e&&r(t,e),t}}(),lookup=function(){function r(){_classCallCheck(this,r)}return _createClass(r,null,[{key:"toTable",value:function(t){var n=t.reduce(function(r,t){return Object.assign(r,t)},{});return r.toHash(n)}},{key:"toInputTable",value:function(r){for(var t={},n=0,e=0;e<r.length;e++)for(var u in r[e].input)t.hasOwnProperty(u)||(t[u]=n++);return t}},{key:"toOutputTable",value:function(r){for(var t={},n=0,e=0;e<r.length;e++)for(var u in r[e].output)t.hasOwnProperty(u)||(t[u]=n++);return t}},{key:"toHash",value:function(r){var t={},n=0;for(var e in r)t[e]=n++;return t}},{key:"toArray",value:function(r,t,n){var e=new Float32Array(n);for(var u in r)e[r[u]]=t[u]||0;return e}},{key:"toObject",value:function(r,t){var n={};for(var e in r)n[e]=t[r[e]];return n}},{key:"lookupFromArray",value:function(r){for(var t={},n=0,e=r.length;e-- >0;)t[r[e]]=n++;return t}},{key:"toTrainingData",value:function(r,t,n){var e=getTypedArrayFn(r[0].input,t),u=getTypedArrayFn(r[0].output,n);return e&&u?r=r.map(function(r){return{input:e(r.input),output:u(r.output)}}):e?r=r.map(function(r){return{input:e(r.input),output:r.output}}):u&&(r=r.map(function(r){return{input:r.input,output:u(r.output)}})),r}}]),r}();exports.default=lookup;
...
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}function _inherits(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function t(t,e){for(var r=0;r<e.length;r++){var n=e[r];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(t,n.key,n)}}return function(e,r,n){return r&&t(e.prototype,r),n&&t(e,n),e}}(),_matrix=require("./matrix"),_matrix2=_interopRequireDefault(_matrix),_randomMatrix=require("./matrix/random-matrix"),_randomMatrix2=_interopRequireDefault(_randomMatrix),_equation=require("./matrix/equation"),_equation2=_interopRequireDefault(_equation),_rnn=require("./rnn"),_rnn2=_interopRequireDefault(_rnn),_zeros=require("../utilities/zeros"),_zeros2=_interopRequireDefault(_zeros),_softmax=require("./matrix/softmax"),_softmax2=_interopRequireDefault(_softmax),_random=require("../utilities/random"),_sampleI=require("./matrix/sample-i"),_sampleI2=_interopRequireDefault(_sampleI),_maxI=require("./matrix/max-i"),_maxI2=_interopRequireDefault(_maxI),_lookup=require("../lookup"),_lookup2=_interopRequireDefault(_lookup),RNNTimeStep=function(t){function e(t){_classCallCheck(this,e);var r=_possibleConstructorReturn(this,(e.__proto__||Object.getPrototypeOf(e)).call(this,t));return r.inputLookup=null,r.inputLookupLength=null,r.outputLookup=null,r.outputLookupLength=null,r}return _inherits(e,t),_createClass(e,[{key:"createOutputMatrix",value:function(){var t=this.model,e=this.outputSize,r=this.hiddenLayers[this.hiddenLayers.length-1];t.outputConnector=new _randomMatrix2.default(e,r,.08),t.output=new _randomMatrix2.default(e,1,.08)}},{key:"bindEquation",value:function(){var t=this.model,e=this.hiddenLayers,r=t.hiddenLayers,n=new _equation2.default,i=[],a=t.equationConnections.length>0?t.equationConnections[t.equationConnections.length-1]:this.initialLayerInputs,o=this.getEquation(n,n.input(new _matrix2.default(this.inputSize,1)),a[0],r[0]);i.push(o);for(var u=1,s=e.length;u<s;u++)o=this.getEquation(n,o,a[u],r[u]),i.push(o);t.equationConnections.push(i),n.add(n.multiply(t.outputConnector,o),t.output),t.equations.push(n)}},{key:"mapModel",value:function(){var t=this.model,e=t.hiddenLayers,r=t.allMatrices;if(this.initialLayerInputs=this.hiddenLayers.map(function(t){return new _matrix2.default(t,1)}),this.createHiddenLayers(),!t.hiddenLayers.length)throw new Error("net.hiddenLayers not set");for(var n=0,i=e.length;n<i;n++){var a=e[n];for(var o in a)a.hasOwnProperty(o)&&r.push(a[o])}if(this.createOutputMatrix(),!t.outputConnector)throw new Error("net.model.outputConnector not set");if(!t.output)throw new Error("net.model.output not set");r.push(t.outputConnector),r.push(t.output)}},{key:"backpropagate",value:function(){for(var t=this.model.equations.length-1;t>-1;t--)this.model.equations[t].backpropagate()}},{key:"run",value:function(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:[];return 1===this.inputSize?this.outputLookup?(this.run=this.runObject,this.runObject(t)):(this.run=this.runNumbers,this.runNumbers(t)):(this.run=this.runArrays,this.runArrays(t))}},{key:"forecast",value:function(t,e){return 1===this.inputSize?(this.run=this.forecastNumbers,this.forecastNumbers(t,e)):(this.run=this.forecastArrays,this.forecastArrays(t,e))}},{key:"train",value:function(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};t[0].input?Array.isArray(t[0].input[0])?this.trainInput=this.trainInputOutputArray:Array.isArray(t[0].input)?this.trainInput=this.trainInputOutput:(this.inputLookup=_lookup2.default.toInputTable(t),this.inputLookupLength=Object.keys(this.inputLookup).length,this.outputLookup=_lookup2.default.toOutputTable(t),this.outputLookupLength=Object.keys(this.outputLookup).length,t=_lookup2.default.toTrainingData(t,this.inputLookup,this.outputLookup),this.trainInput=this.trainInputOutput):Array.isArray(t[0])&&(Array.isArray(t[0][0])?this.trainInput=this.trainArrays:this.inputSize>1?(t=[t],this.trainInput=this.trainArrays):this.trainInput=this.trainNumbers),e=Object.assign({},this.constructor.trainDefaults,e);var r=e.iterations,n=e.errorThresh,i=!0===e.log?console.log:e.log,a=e.logPeriod,o=e.learningRate||this.learningRate,u=e.callback,s=e.callbackPeriod,l=1/0,h=void 0;for(this.hasOwnProperty("setupData")&&(t=this.setupData(t)),this.model||this.initialize(),h=0;h<r&&l>n;h++){for(var p=0,f=0;f<t.length;f++){p+=this.trainPattern(t[f],o)}if(l=p/t.length,isNaN(l))throw new Error("network error rate is unexpected NaN, check network configurations and try again");i&&h%a==0&&i("iterations: "+h+", training error: "+l),u&&h%s==0&&u({error:l,iterations:h})}return{error:l,iterations:h}}},{key:"trainNumbers",value:function(t){for(var e=this.model,r=e.equations;r.length<t.length;)this.bindEquation();for(var n=0,i=0,a=t.length-1;i<a;i++)n+=r[i].predictTarget([t[i]],[t[i+1]]);return this.end(),n/t.length}},{key:"runNumbers",value:function(t){if(!this.isRunnable)return null;for(var e=this.model,r=e.equations;r.length<=t.length;)this.bindEquation();for(var n=void 0,i=0;i<t.length;i++)n=r[i].runInput([t[i]]);return this.end(),n.weights.slice(0)}},{key:"forecastNumbers",value:function(t,e){if(!this.isRunnable)return null;for(var r=this.model,n=r.equations,i=t.length+e;n.length<=i;)this.bindEquation();for(var a=void 0,o=0,u=0;u<t.length;u++)a=n[o++].runInput([t[u]]);for(var s=[a.weights[0]],l=0,h=e-1;l<h;l++)a=n[o++].runInput(a.weights),s.push(a.weights[0]);return this.end(),s}},{key:"runObject",value:function(t){return _lookup2.default.toObject(this.outputLookup,this.forecastNumbers(_lookup2.default.toArray(this.inputLookup,t,this.inputLookupLength),this.outputLookupLength))}},{key:"trainInputOutput",value:function(t){for(var e=this.model,r=t.input,n=t.output,i=r.length+n.length,a=e.equations;a.length<i;)this.bindEquation();for(var o=0,u=0,s=0,l=r.length-1;s<l;s++)o+=a[u++].predictTarget([r[s]],[r[s+1]]);o+=a[u++].predictTarget([r[r.length-1]],[n[0]]);for(var h=0,p=n.length-1;h<p;h++)o+=a[u++].predictTarget([n[h]],[n[h+1]]);return this.end(),o/i}},{key:"trainInputOutputArray",value:function(t){for(var e=this.model,r=t.input,n=t.output,i=r.length+n.length,a=e.equations;a.length<i;)this.bindEquation();for(var o=0,u=0,s=0,l=r.length-1;s<l;s++)o+=a[u++].predictTarget(r[s],r[s+1]);o+=a[u++].predictTarget(r[r.length-1],n[0]);for(var h=0,p=n.length-1;h<p;h++)o+=a[u++].predictTarget(n[h],n[h+1]);return this.end(),o/i}},{key:"trainArrays",value:function(t){for(var e=this.model,r=e.equations;r.length<t.length;)this.bindEquation();for(var n=0,i=0,a=t.length-1;i<a;i++)n+=r[i].predictTarget(t[i],t[i+1]);return this.end(),n/t.length}},{key:"runArrays",value:function(t){if(!this.isRunnable)return null;for(var e=this.model,r=e.equations;r.length<t.length;)this.bindEquation();for(var n=void 0,i=0;i<t.length;i++){n=r[i].runInput(t[i]).weights}return this.end(),n}},{key:"forecastArrays",value:function(t,e){if(!this.isRunnable)return null;for(var r=this.model,n=r.equations,i=t.length+e;n.length<=i;)this.bindEquation();for(var a=void 0,o=0,u=0;u<t.length;u++)a=n[o++].runInput(t[u]);for(var s=[a.weights],l=0,h=e-1;l<h;l++)a=n[o++].runInput(a.weights),s.push(a.weights);return this.end(),s}},{key:"end",value:function(){this.model.equations[this.model.equations.length-1].runInput(new Float32Array(this.outputSize))}},{key:"toJSON",value:function(){var t=this.constructor.defaults;this.model||this.initialize();var e=this.model,r={};for(var n in t)t.hasOwnProperty(n)&&(r[n]=this[n]);return{type:this.constructor.name,options:r,hiddenLayers:e.hiddenLayers.map(function(t){var e={};for(var r in t)e[r]=t[r].toJSON();return e}),outputConnector:this.model.outputConnector.toJSON(),output:this.model.output.toJSON()}}},{key:"fromJSON",value:function(t){var e=this.constructor.defaults,r=t.options;this.model=null,this.hiddenLayers=null;var n=[],i=[];(t.hiddenLayers||t.hiddenSizes).forEach(function(t){var e={};for(var r in t)e[r]=_matrix2.default.fromJSON(t[r]),n.push(e[r]);i.push(e)});var a=_matrix2.default.fromJSON(t.outputConnector);n.push(a);var o=_matrix2.default.fromJSON(t.output);n.push(o),Object.assign(this,e,r),r.hiddenSizes&&(this.hiddenLayers=r.hiddenSizes),r.hasOwnProperty("dataFormatter")&&null!==r.dataFormatter&&(this.dataFormatter=DataFormatter.fromJSON(r.dataFormatter)),this.model={hiddenLayers:i,output:o,allMatrices:n,outputConnector:a,equations:[],equationConnections:[]},this.initialLayerInputs=this.hiddenLayers.map(function(t){return new _matrix2.default(t,1)}),this.bindEquation()}},{key:"toFunction",value:function(){function t(t,r){for(var n=0,i=s.length;n<i;n++){var a=s[n];if(n===r){var o=e(t);switch(t){case a.left:if(o>-1)return"typeof prevStates["+o+"] === 'object' ? prevStates["+o+"].product : new Matrix("+t.rows+", "+t.columns+")";case a.right:if(o>-1)return"typeof prevStates["+o+"] === 'object' ? prevStates["+o+"].product : new Matrix("+t.rows+", "+t.columns+")";case a.product:return"new Matrix("+t.rows+", "+t.columns+")";default:throw Error("unknown state")}}if(t===a.product)return"states["+n+"].product";if(t===a.right)return"states["+n+"].right";if(t===a.left)return"states["+n+"].left"}}function e(t){for(var e=i.equationConnections[0],r=a[0].states,n=0,o=r.length;n<o;n++)if(r[n].product===t)return n;return e.indexOf(t)}function r(e,r){if(!e||!e.rows||!e.columns)return"null";if(e===i.outputConnector)return"json.outputConnector";if(e===i.output)return"json.output";for(var n=0,a=i.hiddenLayers.length;n<a;n++){var o=i.hiddenLayers[n];for(var u in o)if(o.hasOwnProperty(u)&&o[u]===e)return"json.hiddenLayers["+n+"]."+u}return t(e,r)}function n(t){return t=t.toString().split("{"),t.shift(),t=t.join("{"),t=t.split("}"),t.pop(),t.join("}").split("\n").join("\n        ").replace("product.weights = _input.weights = _this.inputValue;",1===o?"product.weights = [input[_i]];":"product.weights = input[_i];").replace("product.deltas[i] = 0;","").replace("product.deltas[column] = 0;","").replace("left.deltas[leftIndex] = 0;","").replace("right.deltas[rightIndex] = 0;","").replace("product.deltas = left.deltas.slice(0);","")}for(var i=this.model,a=this.model.equations,o=this.inputSize,u=a[1],s=u.states,l=JSON.stringify(this.toJSON()),h=[],p={},f=[],d=0,c=s.length;d<c;d++){var m=s[d];h.push("states["+d+"] = {\n      name: '"+m.forwardFn.name+"',\n      left: "+r(m.left,d)+",\n      right: "+r(m.right,d)+",\n      product: "+r(m.product,d)+"\n    }");var g=m.forwardFn.name;p[g]||(p[g]=!0,f.push("        case '"+g+"':"+("forwardFn"!==g?" //compiled from "+function(t){return"src/recurrent/matrix/"+t.replace(/[A-Z]/g,function(t){return"-"+t.toLowerCase()})+".js"}(g):"")+"\n          "+n(m.forwardFn.toString())+"\n          break;"))}var v="\n  if (typeof rawInput === 'undefined') rawInput = [];\n  "+(null!==this.dataFormatter?this.dataFormatter.toFunctionString():"")+"\n  \n  var input = "+(null!==this.dataFormatter&&"function"==typeof this.formatDataIn?"formatDataIn(rawInput)":"rawInput")+";\n  var json = "+l+";\n  var output = [];\n  var states = [];\n  var prevStates;\n  var state;\n  for (let _i = 0; _i < input.length; _i++) {\n    prevStates = states;\n    states = [];\n    "+h.join(";\n    ")+";\n    for (var stateIndex = 0, stateMax = "+h.length+"; stateIndex < stateMax; stateIndex++) {\n      state = states[stateIndex];\n      var product = state.product;\n      var left = state.left;\n      var right = state.right;\n      \n      switch (state.name) {\n"+f.join("\n")+"\n      }\n    }\n  }\n  "+(null!==this.dataFormatter&&"function"==typeof this.formatDataOut?"return formatDataOut(input, "+(1===this.outputSize?"state.product.weights[0]":"state.product.weights")+")":"return "+(1===this.outputSize?"state.product.weights[0]":"state.product.weights"))+";\n  function Matrix(rows, columns) {\n    this.rows = rows;\n    this.columns = columns;\n    this.weights = zeros(rows * columns);\n  }\n  "+(null!==this.dataFormatter&&"function"==typeof this.formatDataIn?"function formatDataIn(input, output) { "+n(this.formatDataIn.toString()).replace(/this[.]dataFormatter[\n\s]+[.]/g,"").replace(/this[.]dataFormatter[.]/g,"").replace(/this[.]dataFormatter/g,"true")+" }":"")+"\n  "+(null!==this.dataFormatter&&"function"==typeof this.formatDataOut?"function formatDataOut(input, output) { "+n(this.formatDataOut.toString()).replace(/this[.]dataFormatter[\n\s]+[.]/g,"").replace(/this[.]dataFormatter[.]/g,"").replace(/this[.]dataFormatter/g,"true")+" }":"")+"\n  "+_zeros2.default.toString()+"\n  "+_softmax2.default.toString().replace("_2.default","Matrix")+"\n  "+_random.randomF.toString()+"\n  "+_sampleI2.default.toString()+"\n  "+_maxI2.default.toString();return new Function("rawInput",v)}}]),e}(_rnn2.default);exports.default=RNNTimeStep,RNNTimeStep.defaults={inputSize:1,hiddenLayers:[20],outputSize:1,learningRate:.01,decayRate:.999,smoothEps:1e-8,regc:1e-6,clipval:5,dataFormatter:null},RNNTimeStep.trainDefaults=_rnn2.default.trainDefaults;
