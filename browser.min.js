...
"use strict";function _classCallCheck(e,r){if(!(e instanceof r))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,r){for(var t=0;t<r.length;t++){var n=r[t];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(r,t,n){return t&&e(r.prototype,t),n&&e(r,n),r}}(),CrossValidate=function(){function e(r,t){_classCallCheck(this,e),this.Classifier=r,this.options=t,this.json=null}return _createClass(e,[{key:"testPartition",value:function(e,r,t){var n=new this.Classifier(this.options),i=Date.now(),o=n.train(r,e),s=Date.now(),a=n.test(t),u=Date.now();return Object.assign({},a,{trainTime:s-i,testTime:u-s,iterations:o.iterations,trainError:o.error,learningRate:e.learningRate,hidden:n.hiddenSizes,network:n.toJSON()})}},{key:"shuffleArray",value:function(e){for(var r=e.length-1;r>0;r--){var t=Math.floor(Math.random()*(r+1)),n=e[r];e[r]=e[t],e[t]=n}return e}},{key:"train",value:function(e,r,t){t=t||4;var n=e.length/t;if(e.constructor===Array)this.shuffleArray(e);else{var i={};this.shuffleArray(Object.keys(e)).forEach(function(r){i[r]=e[r]}),e=i}for(var o={error:0,trainTime:0,testTime:0,iterations:0,trainError:0},s={truePos:0,trueNeg:0,falsePos:0,falseNeg:0,total:0},a=[],u=void 0,l=void 0,f=0;f<t;f++){var c=e.slice(0),h=c.splice(f*n,n),v=c,y=this.testPartition(options,r,v,h);for(u in o)u in o&&(l=o[u],o[u]=l+y[u]);for(u in s)u in s&&(l=s[u],s[u]=l+y[u]);a.push(y)}for(u in o)u in o&&(l=o[u],o[u]=l/t);s.precision=s.truePos/(s.truePos+s.falsePos),s.recall=s.truePos/(s.truePos+s.falseNeg),s.accuracy=(s.trueNeg+s.truePos)/s.total,s.testSize=n,s.trainSize=e.length-n,this.json={avgs:o,stats:s,sets:a}}},{key:"toNeuralNetwork",value:function(){return this.fromJSON(this.json)}},{key:"toJSON",value:function(){return this.json}},{key:"fromJSON",value:function(e){var r=this.Classifier,t=e.sets.reduce(function(e,r){return e.error<r.error?e:r},{error:1/0}).network;if(r.fromJSON)return r.fromJSON(t);var n=new r;return n.fromJSON(t),n}}]),e}();exports.default=CrossValidate;
