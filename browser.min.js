...
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}function _inherits(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function t(t,e){for(var r=0;r<e.length;r++){var u=e[r];u.enumerable=u.enumerable||!1,u.configurable=!0,"value"in u&&(u.writable=!0),Object.defineProperty(t,u.key,u)}}return function(e,r,u){return r&&t(e.prototype,r),u&&t(e,u),e}}(),_matrix=require("./matrix"),_matrix2=_interopRequireDefault(_matrix),_randomMatrix=require("./matrix/random-matrix"),_randomMatrix2=_interopRequireDefault(_randomMatrix),_equation=require("./matrix/equation"),_equation2=_interopRequireDefault(_equation),_rnn=require("./rnn"),_rnn2=_interopRequireDefault(_rnn),_zeros=require("../utilities/zeros"),_zeros2=_interopRequireDefault(_zeros),_softmax=require("./matrix/softmax"),_softmax2=_interopRequireDefault(_softmax),_random=require("../utilities/random"),_sampleI=require("./matrix/sample-i"),_sampleI2=_interopRequireDefault(_sampleI),_maxI=require("./matrix/max-i"),_maxI2=_interopRequireDefault(_maxI),_lookup=require("../lookup"),_lookup2=_interopRequireDefault(_lookup),_lookupTable2=require("../utilities/lookup-table"),_lookupTable3=_interopRequireDefault(_lookupTable2),_arrayLookupTable=require("../utilities/array-lookup-table"),_arrayLookupTable2=_interopRequireDefault(_arrayLookupTable),_cast=require("../utilities/cast"),RNNTimeStep=function(t){function e(){return _classCallCheck(this,e),_possibleConstructorReturn(this,(e.__proto__||Object.getPrototypeOf(e)).apply(this,arguments))}return _inherits(e,t),_createClass(e,[{key:"createOutputMatrix",value:function(){var t=this.model,e=this.outputSize,r=this.hiddenLayers[this.hiddenLayers.length-1];t.outputConnector=new _randomMatrix2.default(e,r,.08),t.output=new _randomMatrix2.default(e,1,.08)}},{key:"bindEquation",value:function(){var t=this.model,e=this.hiddenLayers,r=t.hiddenLayers,u=new _equation2.default,n=[],o=t.equationConnections.length>0?t.equationConnections[t.equationConnections.length-1]:this.initialLayerInputs,a=this.getEquation(u,u.input(new _matrix2.default(this.inputSize,1)),o[0],r[0]);n.push(a);for(var i=1,s=e.length;i<s;i++)a=this.getEquation(u,a,o[i],r[i]),n.push(a);t.equationConnections.push(n),u.add(u.multiply(t.outputConnector,a),t.output),t.equations.push(u)}},{key:"mapModel",value:function(){var t=this.model,e=t.hiddenLayers,r=t.allMatrices;if(this.initialLayerInputs=this.hiddenLayers.map(function(t){return new _matrix2.default(t,1)}),this.createHiddenLayers(),!t.hiddenLayers.length)throw new Error("net.hiddenLayers not set");for(var u=0,n=e.length;u<n;u++){var o=e[u];for(var a in o)o.hasOwnProperty(a)&&r.push(o[a])}if(this.createOutputMatrix(),!t.outputConnector)throw new Error("net.model.outputConnector not set");if(!t.output)throw new Error("net.model.output not set");r.push(t.outputConnector),r.push(t.output)}},{key:"backpropagate",value:function(){for(var t=this.model.equations.length-1;t>-1;t--)this.model.equations[t].backpropagate()}},{key:"run",value:function(t){return 1===this.inputSize?this.outputLookup?(this.run=this.runObject,this.runObject(t)):(this.run=this.runNumbers,this.runNumbers(t)):(this.run=this.runArrays,this.runArrays(t))}},{key:"forecast",value:function(t,e){return 1===this.inputSize?this.outputLookup?(this.forecast=this.runObject,this.runObject(t)):(this.forecast=this.forecastNumbers,this.forecastNumbers(t,e)):this.outputLookup?(this.forecast=this.forecastObjects,this.forecastObjects(t,e)):(this.forecast=this.forecastArrays,this.forecastArrays(t,e))}},{key:"train",value:function(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};this.trainOpts=e=Object.assign({},this.constructor.trainDefaults,e);var r=e.iterations,u=e.errorThresh,n=!0===e.log?console.log:e.log,o=e.logPeriod,a=e.callback,i=e.callbackPeriod;1!==this.inputSize&&this.inputSize||this.setSize(t),t=this.formatData(t);var s=1/0,p=void 0;for(this.verifyIsInitialized(t),p=0;p<r&&s>u;p++){for(var h=0,l=0;l<t.length;l++){h+=this.trainPattern(t[l],!0)}if(s=h/t.length,isNaN(s))throw new Error("network error rate is unexpected NaN, check network configurations and try again");n&&p%o==0&&n("iterations: "+p+", training error: "+s),a&&p%i==0&&a({error:s,iterations:p})}return{error:s,iterations:p}}},{key:"verifyIsInitialized",value:function(t){t[0].input?this.trainInput=this.trainInputOutput:t[0].length>0&&(t[0][0].length>0?this.trainInput=this.trainArrays:this.inputSize>1?this.trainInput=this.trainArrays:this.trainInput=this.trainNumbers),this.model||this.initialize()}},{key:"setSize",value:function(t){var e=_lookup2.default.dataShape(t).join(",");switch(e){case"array,array,number":case"array,object,number":case"array,datum,array,number":case"array,datum,object,number":break;case"array,array,array,number":this.inputSize=this.outputSize=t[0][0].length;break;case"array,array,object,number":this.inputSize=this.outputSize=Object.keys(_lookup2.default.toTable2D(t)).length;break;case"array,datum,array,array,number":this.inputSize=this.outputSize=t[0].input[0].length;break;case"array,datum,array,object,number":this.inputSize=Object.keys(_lookup2.default.toInputTable2D(t)).length,this.outputSize=Object.keys(_lookup2.default.toOutputTable2D(t)).length;break;default:throw new Error("unknown data shape "+e)}}},{key:"trainNumbers",value:function(t){for(var e=this.model,r=e.equations;r.length<t.length;)this.bindEquation();for(var u=0,n=0,o=t.length-1;n<o;n++)u+=r[n].predictTarget(t[n],t[n+1]);return this.end(),u/t.length}},{key:"runNumbers",value:function(t){if(!this.isRunnable)return null;var e=this.model,r=e.equations;for(this.inputLookup&&(t=_lookup2.default.toArray(this.inputLookup,t,this.inputLookupLength));r.length<=t.length;)this.bindEquation();for(var u=void 0,n=0;n<t.length;n++)u=r[n].runInput([t[n]]);return this.end(),u.weights[0]}},{key:"forecastNumbers",value:function(t,e){if(!this.isRunnable)return null;for(var r=this.model,u=r.equations,n=t.length+e;u.length<=n;)this.bindEquation();for(var o=void 0,a=0,i=0;i<t.length;i++)o=u[a++].runInput([t[i]]);for(var s=[o.weights[0]],p=0,h=e-1;p<h;p++)o=u[a++].runInput(o.weights),s.push(o.weights[0]);return this.end(),s}},{key:"runObject",value:function(t){if(this.inputLookup===this.outputLookup){var e=_lookup2.default.toArrayShort(this.inputLookup,t);return _lookup2.default.toObjectPartial(this.outputLookup,this.forecastNumbers(e,this.outputLookupLength-e.length),e.length)}return _lookup2.default.toObject(this.outputLookup,this.forecastNumbers(_lookup2.default.toArray(this.inputLookup,t,this.inputLookupLength),this.outputLookupLength))}},{key:"forecastObjects",value:function(t,e){var r=this;return t=t.map(function(t){return _lookup2.default.toArray(r.outputLookup,t,r.outputLookupLength)}),this.forecastArrays(t,e).map(function(t){return _lookup2.default.toObject(r.outputLookup,t)})}},{key:"trainInputOutput",value:function(t){for(var e=this.model,r=t.input,u=t.output,n=r.length+u.length,o=e.equations;o.length<n;)this.bindEquation();for(var a=0,i=0,s=0,p=r.length-1;s<p;s++)a+=o[i++].predictTarget(r[s],r[s+1]);a+=o[i++].predictTarget(r[r.length-1],u[0]);for(var h=0,l=u.length-1;h<l;h++)a+=o[i++].predictTarget(u[h],u[h+1]);return this.end(),a/n}},{key:"trainArrays",value:function(t){for(var e=this.model,r=e.equations;r.length<t.length;)this.bindEquation();for(var u=0,n=0,o=t.length-1;n<o;n++)u+=r[n].predictTarget(t[n],t[n+1]);return this.end(),u/t.length}},{key:"runArrays",value:function(t){if(!this.isRunnable)return null;for(var e=this.model,r=e.equations;r.length<=t.length;)this.bindEquation();this.inputLookup&&(t=_lookup2.default.toArrays(this.inputLookup,t,this.inputLookupLength));for(var u=void 0,n=0;n<t.length;n++){u=r[n].runInput(t[n]).weights}return this.end(),this.outputLookup?_lookup2.default.toObject(this.outputLookup,u):u}},{key:"forecastArrays",value:function(t,e){if(!this.isRunnable)return null;for(var r=this.model,u=r.equations,n=t.length+e;u.length<=n;)this.bindEquation();for(var o=void 0,a=0,i=0;i<t.length;i++)o=u[a++].runInput(t[i]);for(var s=[o.weights],p=0,h=e-1;p<h;p++)o=u[a++].runInput(o.weights),s.push(o.weights.slice(0));return this.end(),s}},{key:"end",value:function(){this.model.equations[this.model.equations.length-1].runInput(new Float32Array(this.outputSize))}},{key:"formatData",value:function(t){var e=_lookup2.default.dataShape(t).join(","),r=[];switch(e){case"array,number":if(1!==this.inputSize)throw new Error("inputSize must be 1 for this data size");if(1!==this.outputSize)throw new Error("outputSize must be 1 for this data size");for(var u=0;u<t.length;u++)r.push(Float32Array.from([t[u]]));return[r];case"array,array,number":if(1===this.inputSize&&1===this.outputSize){for(var n=0;n<t.length;n++)r.push((0,_cast.arrayToFloat32Arrays)(t[n]));return r}if(this.inputSize!==t[0].length)throw new Error("inputSize must match data input size");if(this.outputSize!==t[0].length)throw new Error("outputSize must match data input size");for(var o=0;o<t.length;o++)r.push(Float32Array.from(t[o]));return[r];case"array,object,number":if(1!==this.inputSize)throw new Error("inputSize must be 1 for this data size");if(1!==this.outputSize)throw new Error("outputSize must be 1 for this data size");if(!this.inputLookup){var a=new _lookupTable3.default(t);this.inputLookup=this.outputLookup=a.table,this.inputLookupLength=this.outputLookupLength=a.length}for(var i=0;i<t.length;i++)r.push((0,_cast.objectToFloat32Arrays)(t[i]));return r;case"array,datum,array,number":if(1!==this.inputSize)throw new Error("inputSize must be 1 for this data size");if(1!==this.outputSize)throw new Error("outputSize must be 1 for this data size");for(var s=0;s<t.length;s++){var p=t[s];r.push({input:(0,_cast.arrayToFloat32Arrays)(p.input),output:(0,_cast.arrayToFloat32Arrays)(p.output)})}return r;case"array,datum,object,number":if(1!==this.inputSize)throw new Error("inputSize must be 1 for this data size");if(1!==this.outputSize)throw new Error("outputSize must be 1 for this data size");if(!this.inputLookup){var h=new _lookupTable3.default(t,"input");this.inputLookup=h.table,this.inputLookupLength=h.length}if(!this.outputLookup){var l=new _lookupTable3.default(t,"output");this.outputLookup=l.table,this.outputLookupLength=l.length}for(var f=0;f<t.length;f++){var c=t[f];r.push({input:(0,_cast.objectToFloat32Arrays)(c.input),output:(0,_cast.objectToFloat32Arrays)(c.output)})}return r;case"array,array,array,number":for(var d=0;d<t.length;d++)r.push((0,_cast.arraysToFloat32Arrays)(t[d]));return r;case"array,array,object,number":if(!this.inputLookup){var k=new _lookupTable3.default(t);this.inputLookup=this.outputLookup=k.table,this.inputLookupLength=this.outputLookupLength=k.length}for(var g=0;g<t.length;g++){for(var y=[],b=0;b<t[g].length;b++)y.push((0,_cast.objectToFloat32Array)(t[g][b],this.inputLookup,this.inputLookupLength));r.push(y)}return r;case"array,datum,array,array,number":if(1===this.inputSize&&1===this.outputSize)for(var v=0;v<t.length;v++){var m=t[v];r.push({input:Float32Array.from(m.input),output:Float32Array.from(m.output)})}else{if(this.inputSize!==t[0].input[0].length)throw new Error("inputSize must match data input size");if(this.outputSize!==t[0].output[0].length)throw new Error("outputSize must match data output size");for(var L=0;L<t.length;L++){var _=t[L];r.push({input:(0,_cast.arraysToFloat32Arrays)(_.input),output:(0,_cast.arraysToFloat32Arrays)(_.output)})}}return r;case"array,datum,array,object,number":if(!this.inputLookup){var w=new _arrayLookupTable2.default(t,"input");this.inputLookup=w.table,this.inputLookupLength=w.length}if(!this.outputLookup){var S=new _arrayLookupTable2.default(t,"output");this.outputLookup=S.table,this.outputLookupLength=S.length}for(var z=0;z<t.length;z++){var O=t[z];r.push({input:(0,_cast.objectsToFloat32Arrays)(O.input,this.inputLookup,this.inputLookupLength),output:(0,_cast.objectsToFloat32Arrays)(O.output,this.outputLookup,this.outputLookupLength)})}return r;default:throw new Error("unknown data shape or configuration")}}},{key:"test",value:function(t){var e=this.formatData(t),r=[],u=0;switch(_lookup2.default.dataShape(t).join(",")){case"array,array,number":if(1===this.inputSize){for(var n=0;n<e.length;n++){var o=e[n],a=this.run(o.splice(0,o.length-1)),i=o[o.length-1][0],s=i-a,p=s*s;if(u+=p,Math.abs(p)>this.trainOpts.errorThresh){var h=t[n];Object.assign(h,{value:o,actual:a}),r.push(h)}}break}case"array,array,array,number":for(var l=0;l<e.length;l++){for(var f=e[l],c=this.run(f.splice(0,f.length-1)),d=f[f.length-1],k=0,g=0,y=0;y<c.length;y++){g++;var b=d[y]-c[y];k+=b*b}if(u+=k/g,Math.abs(k)>this.trainOpts.errorThresh){var v=t[l];r.push({value:v,actual:c})}}break;case"array,object,number":for(var m=0;m<e.length;m++){var L=e[m],_=this.run(_lookup2.default.toObjectPartial(this.outputLookup,L,0,L.length-1)),w=L[L.length-1],S=0,z=void 0;for(z in _);var O=w[m]-_[z];if(S+=O*O,u+=S,Math.abs(S)>this.trainOpts.errorThresh){var j=t[m];r.push({value:j,actual:_})}}break;case"array,array,object,number":for(var q=0;q<e.length;q++){var x=e[q],I=this.run(x.slice(0,x.length-1)),T=t[q][x.length-1],E=0,N=0;for(var A in I){var F=T[A]-I[A];E+=F*F,N++}if(u+=E/N,Math.abs(E)>this.trainOpts.errorThresh){var C=t[q];r.push({value:C,actual:I})}}break;case"array,datum,array,number":case"array,datum,object,number":for(var R=0;R<e.length;R++){for(var M=e[R],D=this.forecast(M.input,M.output.length),P=0,J=0,K=0;K<D.length;K++){var H=M.output[K][0]-D[K];P+=H*H,J++}if(u+=P/J,Math.abs(P)>this.trainOpts.errorThresh){var V=t[R];Object.assign(V,{actual:this.outputLookup?_lookup2.default.toObject(this.outputLookup,D):D}),r.push(V)}}break;case"array,datum,array,array,number":for(var Z=0;Z<e.length;Z++){for(var B=e[Z],G=this.forecast(B.input,B.output.length),Q=0,U=0;U<G.length;U++)for(var W=0;W<G[U].length;W++){var X=B.output[U][W]-G[U][W];Q+=X*X}if(u+=Q,Math.abs(Q)>this.trainOpts.errorThresh){var Y=t[Z];r.push({input:Y.input,output:Y.output,actual:G})}}break;case"array,datum,array,object,number":for(var $=0;$<e.length;$++){for(var tt=e[$],et=this.forecast(tt.input,tt.output.length),rt=0,ut=0;ut<et.length;ut++)for(var nt in et[ut]){var ot=t[$].output[ut][nt]-et[ut][nt];rt+=ot*ot}if(u+=rt,Math.abs(rt)>this.trainOpts.errorThresh){var at=t[$];r.push({input:at.input,output:at.output,actual:et})}}break;default:throw new Error("unimplemented")}return{error:u/t.length,misclasses:r}}},{key:"addFormat",value:function(t){var e=_lookup2.default.dataShape(t).join(",");switch(e){case"array,array,number":case"datum,array,array,number":case"array,number":case"datum,array,number":return;case"datum,object,number":this.inputLookup=_lookup2.default.addKeys(t.input,this.inputLookup),this.inputLookup&&(this.inputLookupLength=Object.keys(this.inputLookup).length),this.outputLookup=_lookup2.default.addKeys(t.output,this.outputLookup),this.outputLookup&&(this.outputLookupLength=Object.keys(this.outputLookup).length);break;case"object,number":this.inputLookup=this.outputLookup=_lookup2.default.addKeys(t,this.inputLookup),this.inputLookup&&(this.inputLookupLength=this.outputLookupLength=Object.keys(this.inputLookup).length);break;case"array,object,number":for(var r=0;r<t.length;r++)this.inputLookup=this.outputLookup=_lookup2.default.addKeys(t[r],this.inputLookup),this.inputLookup&&(this.inputLookupLength=this.outputLookupLength=Object.keys(this.inputLookup).length);break;case"datum,array,object,number":for(var u=0;u<t.input.length;u++)this.inputLookup=_lookup2.default.addKeys(t.input[u],this.inputLookup),this.inputLookup&&(this.inputLookupLength=Object.keys(this.inputLookup).length);for(var n=0;n<t.output.length;n++)this.outputLookup=_lookup2.default.addKeys(t.output[n],this.outputLookup),this.outputLookup&&(this.outputLookupLength=Object.keys(this.outputLookup).length);break;default:throw new Error("unknown data shape "+e)}}},{key:"toJSON",value:function(){var t=this.constructor.defaults;this.model||this.initialize();var e=this.model,r={};for(var u in t)t.hasOwnProperty(u)&&(r[u]=this[u]);return{type:this.constructor.name,options:r,hiddenLayers:e.hiddenLayers.map(function(t){var e={};for(var r in t)e[r]=t[r].toJSON();return e}),outputConnector:this.model.outputConnector.toJSON(),output:this.model.output.toJSON()}}},{key:"fromJSON",value:function(t){var e=this.constructor.defaults,r=t.options;this.model=null,this.hiddenLayers=null;var u=[],n=[];(t.hiddenLayers||t.hiddenSizes).forEach(function(t){var e={};for(var r in t)e[r]=_matrix2.default.fromJSON(t[r]),u.push(e[r]);n.push(e)});var o=_matrix2.default.fromJSON(t.outputConnector);u.push(o);var a=_matrix2.default.fromJSON(t.output);u.push(a),Object.assign(this,e,r),r.hiddenSizes&&(this.hiddenLayers=r.hiddenSizes),this.model={hiddenLayers:n,output:a,allMatrices:u,outputConnector:o,equations:[],equationConnections:[]},this.initialLayerInputs=this.hiddenLayers.map(function(t){return new _matrix2.default(t,1)}),this.bindEquation()}},{key:"toFunction",value:function(){function t(t,r){for(var u=0,n=l.length;u<n;u++){var o=l[u];if(u===r){var a=e(t);switch(t){case o.left:if(a>-1)return"typeof prevStates["+a+"] === 'object' ? prevStates["+a+"].product : new Matrix("+t.rows+", "+t.columns+")";case o.right:if(a>-1)return"typeof prevStates["+a+"] === 'object' ? prevStates["+a+"].product : new Matrix("+t.rows+", "+t.columns+")";case o.product:return"new Matrix("+t.rows+", "+t.columns+")";default:throw Error("unknown state")}}if(t===o.product)return"states["+u+"].product";if(t===o.right)return"states["+u+"].right";if(t===o.left)return"states["+u+"].left"}}function e(t){for(var e=u.equationConnections[0],r=n[0].states,o=0,a=r.length;o<a;o++)if(r[o].product===t)return o;return e.indexOf(t)}function r(e,r){if(!e||!e.rows||!e.columns)return"null";if(e===u.outputConnector)return"json.outputConnector";if(e===u.output)return"json.output";for(var n=0,o=u.hiddenLayers.length;n<o;n++){var a=u.hiddenLayers[n];for(var i in a)if(a.hasOwnProperty(i)&&a[i]===e)return"json.hiddenLayers["+n+"]."+i}return t(e,r)}for(var u=this.model,n=this.model.equations,o=this.inputSize,a=this.inputLookup,i=this.inputLookupLength,s=this.outputLookup,p=this.outputLookupLength,h=n[1],l=h.states,f=JSON.stringify(this.toJSON()),c=[],d={},k=[],g=0,y=l.length;g<y;g++){var b=l[g];c.push("states["+g+"] = {\n      name: '"+b.forwardFn.name+"',\n      left: "+r(b.left,g)+",\n      right: "+r(b.right,g)+",\n      product: "+r(b.product,g)+"\n    }");var v=b.forwardFn.name;d[v]||(d[v]=!0,k.push("        case '"+v+"':"+("forwardFn"!==v?" //compiled from "+function(t){return"src/recurrent/matrix/"+t.replace(/[A-Z]/g,function(t){return"-"+t.toLowerCase()})+".js"}(v):"")+"\n          "+function(t){return t=t.toString().split("{"),t.shift(),t=t.join("{"),t=t.split("}"),t.pop(),t.join("}").split("\n").join("\n        ").replace("product.weights = _input.weights = _this.inputValue;",a&&1===o?"product.weights = _i < input.length ? input[_i]: prevStates[prevStates.length - 1].product.weights;":1===o?"product.weights = [input[_i]];":"product.weights = input[_i];").replace("product.deltas[i] = 0;","").replace("product.deltas[column] = 0;","").replace("left.deltas[leftIndex] = 0;","").replace("right.deltas[rightIndex] = 0;","").replace("product.deltas = left.deltas.slice(0);","")}(b.forwardFn.toString())+"\n          break;"))}var m=1===this.inputSize&&this.outputLookup,L="\n  var input = "+(this.inputLookup?"lookupInput(rawInput)":"rawInput")+";\n  var json = "+f+";\n  var output = [];\n  var states = [];\n  var prevStates;\n  var state;\n  var max = "+(m?a===s?i:"input.length + "+(p-1):"input.length")+";\n  for (var _i = 0; _i < max; _i++) {\n    prevStates = states;\n    states = [];\n    "+c.join(";\n    ")+";\n    for (var stateIndex = 0, stateMax = "+c.length+"; stateIndex < stateMax; stateIndex++) {\n      state = states[stateIndex];\n      var product = state.product;\n      var left = state.left;\n      var right = state.right;\n      \n      switch (state.name) {\n"+k.join("\n")+"\n      }\n    }\n    "+(1===o&&a?"if (_i >= input.length - 1) { output.push(state.product.weights); }":"output = state.product.weights;")+"\n  }\n  "+(s?s===a?"return lookupOutputPartial(output, input)":"return lookupOutput(output)":1===o?"return output[0]":"return output")+";\n  "+function(){return a?1===o?a===s?"function lookupInput(input) {\n            var table = "+JSON.stringify(a)+";\n            var result = [];\n            for (var p in table) {\n              if (!input.hasOwnProperty(p)) break;\n              result.push(Float32Array.from([input[p]]));\n            }\n            return result;\n          }":"function lookupInput(input) {\n          var table = "+JSON.stringify(a)+";\n          var result = [];\n          for (var p in table) {\n            result.push(Float32Array.from([input[p]]));\n          }\n          return result;\n        }":"function lookupInput(rawInputs) {\n        var table = "+JSON.stringify(a)+";\n        var result = [];\n        for (var i = 0; i < rawInputs.length; i++) {\n          var rawInput = rawInputs[i];\n          var input = new Float32Array("+i+");\n          for (var p in table) {\n            input[table[p]] = rawInput.hasOwnProperty(p) ? rawInput[p] : 0;\n          }\n          result.push(input);\n        }\n        return result;\n      }":""}()+"\n  "+function(){return s?1===o?a===s?"function lookupOutputPartial(output, input) {\n            var table = "+JSON.stringify(s)+";\n            var offset = input.length;\n            var result = {};\n            var i = 0;\n            for (var p in table) {\n              if (i++ < offset) continue;\n              result[p] = output[table[p] - offset][0];\n            }\n            return result;\n          }":"function lookupOutput(output) {\n          var table = "+JSON.stringify(s)+";\n          var result = {};\n          for (var p in table) {\n            result[p] = output[table[p]][0];\n          }\n          return result;\n        }":"function lookupOutput(output) {\n        var table = "+JSON.stringify(s)+";\n        var result = {};\n        for (var p in table) {\n          result[p] = output[table[p]];\n        }\n        return result;\n      }":""}()+"\n  \n  function Matrix(rows, columns) {\n    this.rows = rows;\n    this.columns = columns;\n    this.weights = zeros(rows * columns);\n  }\n  "+_zeros2.default.toString()+"\n  "+_softmax2.default.toString().replace("_2.default","Matrix")+"\n  "+_random.randomF.toString()+"\n  "+_sampleI2.default.toString()+"\n  "+_maxI2.default.toString();return new Function("rawInput",L)}}]),e}(_rnn2.default);exports.default=RNNTimeStep,RNNTimeStep.defaults={inputSize:1,hiddenLayers:[20],outputSize:1,learningRate:_rnn2.default.defaults.learningRate,decayRate:_rnn2.default.defaults.decayRate,smoothEps:_rnn2.default.defaults.smoothEps,regc:_rnn2.default.defaults.regc,clipval:_rnn2.default.defaults.clipval},RNNTimeStep.trainDefaults=_rnn2.default.trainDefaults;
