...
export default class NeuralNetwork {
   ...
   */
  train(data, options = {}) {
    const _options = Object.assign({}, NeuralNetwork.trainDefaults, options);
    data = this.formatData(data);
    let iterations = _options.iterations;
    let errorThresh = _options.errorThresh;
    let log = _options.log === true ? console.log : options.log;
    let logPeriod = _options.logPeriod;
    let learningRate = _options.learningRate || this.learningRate || _options.learningRate;
    let callback = _options.callback;
    let callbackPeriod = _options.callbackPeriod;
    let sizes = [];
    ...
    this.initialize(sizes, _options.keepNetworkIntact);
